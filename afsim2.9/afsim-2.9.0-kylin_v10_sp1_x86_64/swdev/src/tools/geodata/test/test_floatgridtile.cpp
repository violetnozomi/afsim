...
//    FloatGridTile::LoadTile
//    FloatGridTile::GetLatIndex
//    FloatGridTile::GetLonIndex
//    FloatGridTile::GetElev
//    FloatGridTile::GetElevApprox
//    FloatGridTile::GetElevInterp
TEST(FloatGridTile, ReadCell)
{
   ...
   std::string   filepath    = dataService.getResource("n37_w120_3arc_v2").GetNormalizedPath();
