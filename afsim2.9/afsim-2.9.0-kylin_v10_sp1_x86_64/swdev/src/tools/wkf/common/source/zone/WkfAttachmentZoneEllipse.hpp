...
#ifndef WkfAttachmentZoneEllipse_hpp
#define WkfAttachmentZoneEllipse_hpp
...
namespace wkf
{
class WKF_COMMON_EXPORT AttachmentZoneEllipse : public AttachmentZone
{
public:
   AttachmentZoneEllipse(vespa::VaEntity& aParent, vespa::VaViewer* aViewerPtr);
   ~AttachmentZoneEllipse() override;

   AttachmentZoneEllipse*       Ref() override { return this; }
   const AttachmentZoneEllipse* Ref() const override { return this; }
...
VA_DECLARE_OBJECT_TYPE(wkf::AttachmentZoneEllipse)
#endif
