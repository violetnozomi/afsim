...
namespace wkf
{
AttachmentZone::AttachmentZone(vespa::VaEntity& aParent, vespa::VaViewer* aViewerPtr, const std::string& aName)
   : AttachmentZoneBase(aParent, aViewerPtr, aName)
   , mColorChanged(false)
...
{
   SetType<AttachmentZone>();
}

AttachmentZone::~AttachmentZone() {}

bool AttachmentZone::BoxPick(vespa::VaViewer* aViewerPtr, const vespa::VaSelectionBox& aBox, bool aInside)
{
...
void AttachmentZone::PreApplyOptions(bool aForceUpdate)
{
...
void AttachmentZone::BuildContextMenu(QMenu& aMenu, unsigned int aSubPartId)
{
