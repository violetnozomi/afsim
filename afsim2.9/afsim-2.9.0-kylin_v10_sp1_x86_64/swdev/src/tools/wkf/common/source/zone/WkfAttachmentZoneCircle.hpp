...
#ifndef WkfAttachmentZoneCircle_hpp
#define WkfAttachmentZoneCircle_hpp
...
namespace wkf
{
class WKF_COMMON_EXPORT AttachmentZoneCircle : public AttachmentZone
{
public:
   AttachmentZoneCircle(vespa::VaEntity& aParent, vespa::VaViewer* aViewerPtr);
   ~AttachmentZoneCircle() override;

   AttachmentZoneCircle*       Ref() override { return this; }
   const AttachmentZoneCircle* Ref() const override { return this; }
...
VA_DECLARE_OBJECT_TYPE(wkf::AttachmentZoneCircle)
#endif
