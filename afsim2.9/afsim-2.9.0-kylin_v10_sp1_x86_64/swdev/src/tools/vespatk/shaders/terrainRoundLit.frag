...
void main( void )
{
   ...
   vColor.rgb *= LightIntensity;
   vColor.rgb += (1 - vColor.a) * vColor.rgb;
   ...
   vec4 vBrightColor = vec4(vSatColor.rgb + (1.0 - vSatColor.rgb) * fBrightener + (-vSatColor.rgb) * fDarkener, vSatColor.a) + LightIntensity * hazeColor;
