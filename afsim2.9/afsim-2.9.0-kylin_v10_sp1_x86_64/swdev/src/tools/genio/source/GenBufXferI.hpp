...
#ifndef GEN_BUF_XFER_I_HPP
#define GEN_BUF_XFER_I_HPP
...
class GENIO_EXPORT GenBufXferI : virtual public GenBuf
{
public:
   ~GenBufXferI() override;

   // Get offset from beginning or end of the data.  Offset from current
   ...
   // providing enough space when calling this Get method.
   ...
   // Function to Get raw data from buffer. No byte swapping is performed.
