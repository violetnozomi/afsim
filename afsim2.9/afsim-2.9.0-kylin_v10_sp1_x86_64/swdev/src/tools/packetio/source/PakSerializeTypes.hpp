...
#ifndef PAKSERIALIZETYPES_HPP
#define PAKSERIALIZETYPES_HPP
...
template<>
inline void PACKETIO_EXPORT Load(PakI& aAr, bool& aValue)
{
   char val(0);
   aAr.Serialize(val);
   aValue = (val != 0);
...
template<>
inline void PACKETIO_EXPORT Save(PakO& aAr, bool& aValue)
{
   char val = aValue ? 1 : 0;
   aAr.Serialize(val);
}
...
// std::string
void PACKETIO_EXPORT Save(PakO& aAr, std::string& aValue);
void PACKETIO_EXPORT Load(PakI& aAr, std::string& aValue);
...
// GenMemIO
void PACKETIO_EXPORT Load(PakI& aAr, GenBuffer& aMemIO);
void PACKETIO_EXPORT Save(PakO& aAr, GenBuffer& aMemIO);


// ut::log::Message serialization in PakProcessor
void PACKETIO_EXPORT Save(PakO& aAr, ut::log::Message& aValue);
void PACKETIO_EXPORT Load(PakI& aAr, ut::log::Message& aValue);
