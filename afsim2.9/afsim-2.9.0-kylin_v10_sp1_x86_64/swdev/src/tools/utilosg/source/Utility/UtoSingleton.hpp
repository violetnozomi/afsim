...
#ifndef UTOSINGLETON_INC_
#define UTOSINGLETON_INC_
...
public:
   ...
   ~ConcreteLifetimeTracker() override { destroyer_(pTracked_); }
...
private:
   static ThreadingModel<T> s_ThreadingModelData;
   ...
   {
      typename ThreadingModel<T>::Lock guard(s_ThreadingModelData);
   ...
   // Data
   static PtrInstanceType& pInstance_() { return s_pInstance; }

   static bool& destroyed_() { return s_destroyed; }
};

// static member definitions
template<typename T, template<class> class CreationPolicy, template<class> class LifetimePolicy, template<class> class ThreadingModel>
ThreadingModel<T> SingletonHolder<T, CreationPolicy, LifetimePolicy, ThreadingModel>::s_ThreadingModelData;
template<typename T, template<class> class CreationPolicy, template<class> class LifetimePolicy, template<class> class ThreadingModel>
typename ThreadingModel<T*>::VolatileType SingletonHolder<T, CreationPolicy, LifetimePolicy, ThreadingModel>::s_pInstance;
template<typename T, template<class> class CreationPolicy, template<class> class LifetimePolicy, template<class> class ThreadingModel>
bool SingletonHolder<T, CreationPolicy, LifetimePolicy, ThreadingModel>::s_destroyed;
