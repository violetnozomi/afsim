...
SPLAT::SphericalMapOptionsDialog::SphericalMapOptionsDialog(QWidget* aParent)
   : PlotOptionsDialog(aParent)
{
   setWindowTitle("Spherical Map Options");
   Build();
}

void SPLAT::SphericalMapOptionsDialog::Build()
{
   ...
   AddWidget("TargetRegion", new SphericalMapTargetRegionWidget(this));
   ...
   OutputFilesWidget* outputFilesWidget = new OutputFilesWidget(PlotOptionsWidget::PlotType::cSPHERICAL_MAP, this);
   ...
   PlatformOptionsWidget* platformOptionsWidget =
      new PlatformOptionsWidget(PlotOptionsWidget::PlotType::cSPHERICAL_MAP, this);
   ...
   connect(this, &SphericalMapOptionsDialog::UpdateModes, platformOptionsWidget, &PlatformOptionsWidget::UpdateModes);
   connect(this,
           &SphericalMapOptionsDialog::UpdatePlatformTypes,
           platformOptionsWidget,
           &PlatformOptionsWidget::UpdatePlatformTypes);
   connect(this, &SphericalMapOptionsDialog::CheckValidity, platformOptionsWidget, &PlatformOptionsWidget::CheckValidity);
   ...
   connect(this, &SphericalMapOptionsDialog::SetSensorId, outputFilesWidget, &OutputFilesWidget::SetSensorId);
}

void SPLAT::SphericalMapOptionsDialog::WriteData(std::ostream& aStream)
{
   if (aStream.good())
   {
      aStream << "\nspherical_map\n";
