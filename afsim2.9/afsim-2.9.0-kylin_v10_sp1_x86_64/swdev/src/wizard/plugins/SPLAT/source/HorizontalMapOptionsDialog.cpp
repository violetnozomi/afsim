...
SPLAT::HorizontalMapOptionsDialog::HorizontalMapOptionsDialog(QWidget* aParent)
   : PlotOptionsDialog(aParent)
{
   setWindowTitle("Horizontal Map Options");
   Build();
}

void SPLAT::HorizontalMapOptionsDialog::Build()
{
   ...
   AddWidget("TargetRegion", new HorizontalMapTargetRegionWidget(this));
   ...
   OutputFilesWidget* outputFilesWidget = new OutputFilesWidget(PlotOptionsWidget::PlotType::cHORIZONTAL_MAP, this);
   ...
   PlatformOptionsWidget* platformOptionsWidget =
      new PlatformOptionsWidget(PlotOptionsWidget::PlotType::cHORIZONTAL_MAP, this);
   ...
   connect(this, &HorizontalMapOptionsDialog::UpdateModes, platformOptionsWidget, &PlatformOptionsWidget::UpdateModes);
   connect(this,
           &HorizontalMapOptionsDialog::UpdatePlatformTypes,
           platformOptionsWidget,
           &PlatformOptionsWidget::UpdatePlatformTypes);
   connect(this, &HorizontalMapOptionsDialog::CheckValidity, platformOptionsWidget, &PlatformOptionsWidget::CheckValidity);
   ...
   connect(this, &HorizontalMapOptionsDialog::SetSensorId, outputFilesWidget, &OutputFilesWidget::SetSensorId);
}

void SPLAT::HorizontalMapOptionsDialog::WriteData(std::ostream& aStream)
{
   if (aStream.good())
   {
      aStream << "\nhorizontal_map\n";
      ...
      if (!mTargetPlatformType.isEmpty())
      {
         ...
         aStream << "   exclude platform_type " << mTargetPlatformType.toStdString() << "\n";
      }
