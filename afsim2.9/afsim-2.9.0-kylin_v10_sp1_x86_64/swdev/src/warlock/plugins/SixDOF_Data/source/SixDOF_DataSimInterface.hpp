...
#ifndef SIXDOFDATAINTERFACE_HPP
#define SIXDOFDATAINTERFACE_HPP

#include <QObject>

#include "SixDOF_DataSimEvents.hpp"
...
class SimInterface : public warlock::SimInterfaceT<SixDOF_DataEvent>
{
public:
