...
WkSixDOF_Tuner::PrefWidget::PrefWidget()
...
double WkSixDOF_Tuner::PrefWidget::GetPopSize(wsf::six_dof::Pid::Type aPid) const
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
   return pidMap.at(aPid).mPopulationSize;
}

double WkSixDOF_Tuner::PrefWidget::GetMaxGenerations(wsf::six_dof::Pid::Type aPid) const
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
   return pidMap.at(aPid).mMaxGenerations;
}

double WkSixDOF_Tuner::PrefWidget::GetCarryOverFrac(wsf::six_dof::Pid::Type aPid) const
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
   return pidMap.at(aPid).mCarryOverFrac;
}

double WkSixDOF_Tuner::PrefWidget::GetCrossoverProb(wsf::six_dof::Pid::Type aPid) const
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
   return pidMap.at(aPid).mCrossoverProb;
}

double WkSixDOF_Tuner::PrefWidget::GetMutationProb(wsf::six_dof::Pid::Type aPid) const
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
   return pidMap.at(aPid).mMutationProb;
}

void WkSixDOF_Tuner::PrefWidget::GetKpRange(wsf::six_dof::Pid::Type aPid, double& aMin, double& aMax)
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
...
void WkSixDOF_Tuner::PrefWidget::GetKiRange(wsf::six_dof::Pid::Type aPid, double& aMin, double& aMax)
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
...
void WkSixDOF_Tuner::PrefWidget::GetKdRange(wsf::six_dof::Pid::Type aPid, double& aMin, double& aMax)
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
...
double WkSixDOF_Tuner::PrefWidget::GetRunTime(wsf::six_dof::Pid::Type aPid)
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
   return pidMap.at(aPid).runTime;
}

double WkSixDOF_Tuner::PrefWidget::GetErrorWeight(wsf::six_dof::Pid::Type aPid)
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
   return pidMap.at(aPid).errorWeight;
}

double WkSixDOF_Tuner::PrefWidget::GetOvershootWeight(wsf::six_dof::Pid::Type aPid)
{
   const auto& pidMap = mPrefObjectPtr->GetPreferences().mPidPrefMap;
   return pidMap.at(aPid).overshootWeight;
}

void WkSixDOF_Tuner::PrefWidget::ReadPreferenceData(const PrefData& aPrefData)
{
   mUi.populationSizeLineEdit->setText(QString::number(
      aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).mPopulationSize));
   mUi.maxGenerationsLineEdit->setText(QString::number(
      aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).mMaxGenerations));
   mUi.carryoverFracLineEdit->setText(QString::number(
      aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).mCarryOverFrac));
   mUi.crossOverProbLineEdit->setText(QString::number(
      aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).mCrossoverProb));
   mUi.mutationProbLineEdit->setText(QString::number(
      aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).mMutationProb));

   mUi.minKpLineEdit->setText(
      QString::number(aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).minKp));
   mUi.maxKpLineEdit->setText(
      QString::number(aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).maxKp));
   mUi.minKiLineEdit->setText(
      QString::number(aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).minKi));
   mUi.maxKiLineEdit->setText(
      QString::number(aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).maxKi));
   mUi.minKdLineEdit->setText(
      QString::number(aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).minKd));
   mUi.maxKdLineEdit->setText(
      QString::number(aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).maxKd));
   mUi.runtimeLineEdit->setText(
      QString::number(aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).runTime));
   mUi.errorWeightLineEdit->setText(QString::number(
      aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).errorWeight));
   mUi.overshootWeightLineEdit->setText(QString::number(
      aPrefData.mPidPrefMap.at((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt()).overshootWeight));
}

void WkSixDOF_Tuner::PrefWidget::RestoreGADefaults()
{
   if (mPrefObjectPtr)
   {
      mPrefObjectPtr->RestoreGADefaults((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt());
   }
   ReadPreferenceData(mPrefObjectPtr->GetPreferences());
}

void WkSixDOF_Tuner::PrefWidget::RestorePIDDefaults()
{
   if (mPrefObjectPtr)
   {
      mPrefObjectPtr->RestorePIDDefaults((wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt());
   }
   ReadPreferenceData(mPrefObjectPtr->GetPreferences());
}

void WkSixDOF_Tuner::PrefWidget::CheckPopSize()
{
...
void WkSixDOF_Tuner::PrefWidget::CheckMaxGenerations()
{
...
void WkSixDOF_Tuner::PrefWidget::CheckCarryOverFrac()
{
...
void WkSixDOF_Tuner::PrefWidget::CheckCrossoverProb()
{
...
void WkSixDOF_Tuner::PrefWidget::CheckMutationProb()
{
...
void WkSixDOF_Tuner::PrefWidget::CheckRunTime()
{
...
void WkSixDOF_Tuner::PrefWidget::WritePreferenceData(PrefData& aPrefData)
{
   aPrefData.mPidPrefMap.clear();
   auto       pid          = (wsf::six_dof::Pid::Type)mUi.pidComboBox->currentData().toInt();
