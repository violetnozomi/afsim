...
struct PrefData
{
   ...
   std::map<wsf::six_dof::Pid::Type, PID_Prefs> mPidPrefMap;
...
private:
   ...
   void RestoreGADefaults(wsf::six_dof::Pid::Type aPid);
   void RestorePIDDefaults(wsf::six_dof::Pid::Type aPid);
};
} // namespace WkSixDOF_Tuner

Q_DECLARE_METATYPE(WkSixDOF_Tuner::PrefData)
