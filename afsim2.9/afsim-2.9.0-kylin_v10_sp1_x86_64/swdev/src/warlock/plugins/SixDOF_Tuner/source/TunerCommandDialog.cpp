...
WkSixDOF_Tuner::CommandDialog::CommandDialog(SimInterface* aSimInterface, QWidget* parent, Qt::WindowFlags f)
   : QDialog(parent, f)
   , mSimInterface(aSimInterface)
{
   ...
   // Page 1
   connect(mUi.altitude1PushButton, &QPushButton::clicked, this, &CommandDialog::AltitudeSendButton1Pressed);
   connect(mUi.altitude2PushButton, &QPushButton::clicked, this, &CommandDialog::AltitudeSendButton2Pressed);
   connect(mUi.verticalSpeed1PushButton, &QPushButton::clicked, this, &CommandDialog::VerticalSpeedSendButton1Pressed);
   connect(mUi.verticalSpeed2PushButton, &QPushButton::clicked, this, &CommandDialog::VerticalSpeedSendButton2Pressed);
   connect(mUi.alpha1PushButton, &QPushButton::clicked, this, &CommandDialog::AlphaSendButton1Pressed);
   connect(mUi.alpha2PushButton, &QPushButton::clicked, this, &CommandDialog::AlphaSendButton2Pressed);
   connect(mUi.pitchAngle1PushButton, &QPushButton::clicked, this, &CommandDialog::PitchAngleSendButton1Pressed);
   connect(mUi.pitchAngle2PushButton, &QPushButton::clicked, this, &CommandDialog::PitchAngleSendButton2Pressed);
   connect(mUi.pitchRate1PushButton, &QPushButton::clicked, this, &CommandDialog::PitchRateSendButton1Pressed);
   connect(mUi.pitchRate2PushButton, &QPushButton::clicked, this, &CommandDialog::PitchRateSendButton2Pressed);
   connect(mUi.flightPathAngle1PushButton, &QPushButton::clicked, this, &CommandDialog::FlightPathAngleSendButton1Pressed);
   connect(mUi.flightPathAngle2PushButton, &QPushButton::clicked, this, &CommandDialog::FlightPathAngleSendButton2Pressed);
   connect(mUi.deltaPitchAngle1PushButton, &QPushButton::clicked, this, &CommandDialog::DeltaPitchAngleSendButton1Pressed);
   connect(mUi.deltaPitchAngle2PushButton, &QPushButton::clicked, this, &CommandDialog::DeltaPitchAngleSendButton2Pressed);
   connect(mUi.pitchG1PushButton, &QPushButton::clicked, this, &CommandDialog::PitchGSendButton1Pressed);
   connect(mUi.pitchG2PushButton, &QPushButton::clicked, this, &CommandDialog::PitchGSendButton2Pressed);

   // Page 2
   connect(mUi.rollHeading1PushButton, &QPushButton::clicked, this, &CommandDialog::RollHeadingSendButton1Pressed);
   connect(mUi.rollHeading2PushButton, &QPushButton::clicked, this, &CommandDialog::RollHeadingSendButton2Pressed);
   connect(mUi.bankAngle1PushButton, &QPushButton::clicked, this, &CommandDialog::BankAngleSendButton1Pressed);
   connect(mUi.bankAngle2PushButton, &QPushButton::clicked, this, &CommandDialog::BankAngleSendButton2Pressed);
   connect(mUi.rollRate1PushButton, &QPushButton::clicked, this, &CommandDialog::RollRateSendButton1Pressed);
   connect(mUi.rollRate2PushButton, &QPushButton::clicked, this, &CommandDialog::RollRateSendButton2Pressed);
   connect(mUi.deltaRoll1PushButton, &QPushButton::clicked, this, &CommandDialog::DeltaRollSendButton1Pressed);
   connect(mUi.deltaRoll2PushButton, &QPushButton::clicked, this, &CommandDialog::DeltaRollSendButton2Pressed);

   // Page 3
   connect(mUi.yawHeading1PushButton, &QPushButton::clicked, this, &CommandDialog::YawHeadingSendButton1Pressed);
   connect(mUi.yawHeading2Pushbutton, &QPushButton::clicked, this, &CommandDialog::YawHeadingSendButton2Pressed);
   connect(mUi.yawRate1PushButton, &QPushButton::clicked, this, &CommandDialog::YawRateSendButton1Pressed);
   connect(mUi.yawRate2PushButton, &QPushButton::clicked, this, &CommandDialog::YawRateSendButton2Pressed);
   connect(mUi.beta1PushButton, &QPushButton::clicked, this, &CommandDialog::BetaSendButton1Pressed);
   connect(mUi.beta2PushButton, &QPushButton::clicked, this, &CommandDialog::BetaSendButton2Pressed);
   connect(mUi.yawG1PushButton, &QPushButton::clicked, this, &CommandDialog::YawGSendButton1Pressed);
   connect(mUi.yawG2PushButton, &QPushButton::clicked, this, &CommandDialog::YawGSendButton2Pressed);

   // Page 4
   connect(mUi.CAS1PushButton, &QPushButton::clicked, this, &CommandDialog::CASSendButton1Pressed);
   connect(mUi.CAS2PushButton, &QPushButton::clicked, this, &CommandDialog::CASSendButton2Pressed);
   connect(mUi.TAS1PushButton, &QPushButton::clicked, this, &CommandDialog::TASSendButton1Pressed);
   connect(mUi.TAS2PushButton, &QPushButton::clicked, this, &CommandDialog::TASSendButton2Pressed);
   connect(mUi.mach1PushButton, &QPushButton::clicked, this, &CommandDialog::MachSendButton1Pressed);
   connect(mUi.mach2PushButton, &QPushButton::clicked, this, &CommandDialog::MachSendButton2Pressed);

   // Page 5
   connect(mUi.taxiSpeed1PushButton, &QPushButton::clicked, this, &CommandDialog::TaxiSpeedSendButton1Pressed);
   connect(mUi.taxiSpeed2PushButton, &QPushButton::clicked, this, &CommandDialog::TaxiSpeedSendButton2Pressed);
   connect(mUi.taxiHeading1PushButton, &QPushButton::clicked, this, &CommandDialog::TaxiHeadingSendButton1Pressed);
   connect(mUi.taxiHeading2PushButton, &QPushButton::clicked, this, &CommandDialog::TaxiHeadingSendButton2Pressed);
   connect(mUi.taxiYawRate1PushButton, &QPushButton::clicked, this, &CommandDialog::TaxiYawRateSendButton1Pressed);
   connect(mUi.taxiYawRate2PushButton, &QPushButton::clicked, this, &CommandDialog::TaxiYawRateSendButton2Pressed);

   connect(&wkfEnv, &wkf::Environment::PlatformOfInterestChanged, this, &CommandDialog::PlatformOfInterestChanged);

   connect(mSimInterface, &SimInterface::NewPlatform, this, &CommandDialog::HandleNewVehicle);
   connect(mSimInterface, &SimInterface::DeletedPlatform, this, &CommandDialog::HandleDeletedVehicle);
...
void WkSixDOF_Tuner::CommandDialog::showEvent(QShowEvent* aEvent)
{
...
void WkSixDOF_Tuner::CommandDialog::PlatformOfInterestChanged(wkf::Platform* aPlatform)
{
   if (aPlatform)
   {
      QString platformName = QString::fromStdString(aPlatform->GetName());
      auto    entry        = mVehicleMap.find(platformName);
...
void WkSixDOF_Tuner::CommandDialog::AlphaSendButton1Pressed()
{
   double alpha = mUi.alphaUnitsComboBox->ConvertToStandard(mUi.alpha1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::Alpha, alpha);
   UpdatePreviousCommand(mUi.alphaLabel->text(), mUi.alpha1LineEdit, mUi.alphaUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::AlphaSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::PitchRateSendButton1Pressed()
{
   double pitchRate = mUi.pitchRateUnitsComboBox->ConvertToStandard(mUi.pitchRate1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::PitchRate, pitchRate);
   UpdatePreviousCommand(mUi.pitchRateLabel->text(), mUi.pitchRate1LineEdit, mUi.pitchRateUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::PitchRateSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::DeltaPitchAngleSendButton1Pressed()
{
   double dltPitchAng =
      mUi.deltaPitchAngleUnitsComboBox->ConvertToStandard(mUi.deltaPitchAngle1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::DeltaPitch, dltPitchAng);
   UpdatePreviousCommand(mUi.deltaPitchAngleLabel->text(), mUi.deltaPitchAngle1LineEdit, mUi.deltaPitchAngleUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::DeltaPitchAngleSendButton2Pressed()
{
   double dltPitchAng =
...
void WkSixDOF_Tuner::CommandDialog::PitchGSendButton1Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::PitchGSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::BankAngleSendButton1Pressed()
{
   double bankAng = mUi.bankAngleUnitsComboBox->ConvertToStandard(mUi.bankAngle1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::BankAngle, bankAng);
   UpdatePreviousCommand(mUi.bankAngleLabel->text(), mUi.bankAngle1LineEdit, mUi.bankAngleUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::BankAngleSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::RollRateSendButton1Pressed()
{
   double rollRate = mUi.rollRateUnitsComboBox->ConvertToStandard(mUi.rollRate1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::RollRate, rollRate);
   UpdatePreviousCommand(mUi.rollRateLabel->text(), mUi.rollRate1LineEdit, mUi.rollRateUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::RollRateSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::DeltaRollSendButton1Pressed()
{
   double dltRoll = mUi.deltaRollUnitsComboBox->ConvertToStandard(mUi.deltaRoll1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::DeltaRoll, dltRoll);
   UpdatePreviousCommand(mUi.deltaRollLabel->text(), mUi.deltaRoll1LineEdit, mUi.deltaRollUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::DeltaRollSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::YawRateSendButton1Pressed()
{
   double yawRate = mUi.yawRateUnitsComboBox->ConvertToStandard(mUi.yawRate1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::YawRate, yawRate);
   UpdatePreviousCommand(mUi.yawRateLabel->text(), mUi.yawRate1LineEdit, mUi.yawRateUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::YawRateSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::BetaSendButton1Pressed()
{
   double beta = mUi.betaUnitsComboBox->ConvertToStandard(mUi.beta1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::Beta, beta);
   UpdatePreviousCommand(mUi.betaLabel->text(), mUi.beta1LineEdit, mUi.betaUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::BetaSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::YawGSendButton1Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::YawGSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::CASSendButton1Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::CASSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::TASSendButton1Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::TASSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::MachSendButton1Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::MachSendButton2Pressed()
{
   // unitless, no conversion necessary
...
void WkSixDOF_Tuner::CommandDialog::TaxiSpeedSendButton1Pressed()
{
   double taxiSpeed = mUi.taxiSpeedUnitsComboBox->ConvertToStandard(mUi.taxiSpeed1LineEdit->text().toDouble());
   mSimInterface->SendCommandBasedOnPID(wsf::six_dof::Pid::TaxiSpeed, taxiSpeed);
   UpdatePreviousCommand(mUi.taxiSpeedLabel->text(), mUi.taxiSpeed1LineEdit, mUi.taxiSpeedUnitsComboBox);
}

void WkSixDOF_Tuner::CommandDialog::TaxiSpeedSendButton2Pressed()
{
...
void WkSixDOF_Tuner::CommandDialog::HandleNewVehicle(const std::string& aName, int aId)
{
   QString name      = QString::fromStdString(aName);
   mVehicleMap[name] = aId;

   // If the newly discovered SixDOF Mover belongs to the Platform Of Interest, go ahead and update the displays.
...
void WkSixDOF_Tuner::CommandDialog::HandleDeletedVehicle(const std::string& aName)
{
   QString name = QString::fromStdString(aName);
...
void WkSixDOF_Tuner::CommandDialog::UpdatePreviousCommand(const QString& aCommandType,
