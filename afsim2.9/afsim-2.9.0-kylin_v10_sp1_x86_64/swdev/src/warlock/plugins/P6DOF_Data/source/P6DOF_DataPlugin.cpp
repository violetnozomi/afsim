...
WKF_PLUGIN_DEFINE_SYMBOLS(WkP6DOF_Data::Plugin,
                          "P6DOF Data",
...
WkP6DOF_Data::Plugin::Plugin(const QString& aPluginName, const size_t aUniqueId)
   : warlock::PluginT<SimInterface>(aPluginName, aUniqueId)
{
   ...
   itemParent->setText(0, "P6Dof Mover");
...
QList<QTreeWidgetItem*> WkP6DOF_Data::Plugin::GetPlatformData(const std::string& aPlatformName)
{
   if (mDataContainer.IsP6dofPlatform(aPlatformName))
   {
...
std::unique_ptr<warlock::PlotUpdater> WkP6DOF_Data::Plugin::GetPlotUpdater(const QString& aPlatformName,
                                                                           const QString& aY,
...
std::unique_ptr<wkf::Updater> WkP6DOF_Data::Plugin::GetUpdater(const QString& aPlatformName,
...
void WkP6DOF_Data::Plugin::GuiUpdate()
{
...
void WkP6DOF_Data::Plugin::CreateItem(QTreeWidgetItem* parent, eDataType aType, bool aDefaultVisibility)
{
...
void WkP6DOF_Data::Plugin::SetItemVisibility(eDataType aType, bool aVisible)
{
