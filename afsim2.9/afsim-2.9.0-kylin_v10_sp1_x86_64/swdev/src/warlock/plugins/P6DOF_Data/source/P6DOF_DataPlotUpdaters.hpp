...
#ifndef P6DOF_DATAPLOTUPDATERS_HPP
#define P6DOF_DATAPLOTUPDATERS_HPP
...
protected:
   ...
   virtual double ReadDataP(WsfP6DOF_Mover* aMover) = 0;
...
protected:
   double ReadDataP(WsfP6DOF_Mover* aMover) override;
   void   UnitChangedCB();
};
