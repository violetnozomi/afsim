...
// ****************************************************************************
#ifndef RVPLUGINP6DOFDATA_HPP
#define RVPLUGINP6DOFDATA_HPP
...
private:
   ...
   /** This enum handles all p6dof message types*/
   enum eP6dofDataType
   {
      // MsgP6dofCoreData
      eALTITUDE,
    ...
    */
   void CreateItem(QTreeWidgetItem* aParent, eP6dofDataType aType);

   std::map<eP6dofDataType, QString>                  mDataToStringMap;
   QList<QTreeWidgetItem*>                            mTopLevelWidgets;
   std::map<eP6dofDataType, QTreeWidgetItem*>         mStringDataWidgets;
   std::map<eP6dofDataType, wkf::UnitTreeWidgetItem*> mUnitDataWidgets;
