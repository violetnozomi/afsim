...
WKF_PLUGIN_DEFINE_SYMBOLS(RvP6DOFData::Plugin,
                          "P6DOF Data",
                          "P6DOF Movers and their plugins are deprecated in favor of the SixDOF Movers. The P6DOF Data "
                          "plugin is responsible for getting data from a P6DOF Mover and displaying it within the "
                          "Platform Details dialog. It has been replaced by the SixDOF Data plugin.",
                          "mystic",
                          false)

RvP6DOFData::Plugin::Plugin(const QString& aPluginName, const size_t aUniqueId)
   ...
   , mInterfacePtr(new Interface(this))
{
   ...
   QTreeWidgetItem* p6dofParent = new QTreeWidgetItem();
   p6dofParent->setText(0, "P6DOF");
   mTopLevelWidgets.push_back(p6dofParent);

   // MsgP6dofCoreData
   mCoreDataItemPtr = new QTreeWidgetItem(p6dofParent);
   ...
   // MsgP6dofKinematic
   mKinematicItemPtr = new QTreeWidgetItem(p6dofParent);
   ...
   // MsgP6dofEngineFuel
   mEngineFuelItemPtr = new QTreeWidgetItem(p6dofParent);
   ...
   // MsgP6dofAutopilot
   mAutopilotItemPtr = new QTreeWidgetItem(p6dofParent);
   ...
   // MsgP6dofAutopilotLimits
   mAutopilotLimitsItemPtr = new QTreeWidgetItem(p6dofParent);
   ...
   // MsgP6dofControlInputs
   mControlInputsItemPtr = new QTreeWidgetItem(p6dofParent);
   ...
   mControlSurfacesItemPtr = new QTreeWidgetItem(p6dofParent);
   mControlSurfacesItemPtr->setText(0, "Control Surfaces");

   mForceMomentItemPtr = new QTreeWidgetItem(p6dofParent);
   mForceMomentItemPtr->setText(0, "Force and Moment");
...
void RvP6DOFData::Plugin::PlatformOfInterestChanged(wkf::Platform* aPlatform)
{
...
/** Get an updater. */
std::unique_ptr<wkf::Updater> RvP6DOFData::Plugin::GetUpdater(const QString&     aPlatformName,
...
QList<wkf::PrefWidget*> RvP6DOFData::Plugin::GetPreferencesWidgets() const
{
 ...
 */
QList<QTreeWidgetItem*> RvP6DOFData::Plugin::GetPlatformData(const std::string& aPlatformName)
{
...
void RvP6DOFData::Plugin::AdvanceTimeRead(const rv::ResultData& aData)
{
...
/** Read data. */
void RvP6DOFData::Plugin::RegularRead(const rv::ResultData& aData)
{
   mInterfacePtr->AdvanceTimeRead(aData);
   mUpdatePosted = true;
}
...
/** Update the GUI. */
void RvP6DOFData::Plugin::GuiUpdate()
{
   if (mUpdatePosted)
   {
      RvP6DOFData::Interface::P6dofDataContainer data = mInterfacePtr->GetP6DOFData();

      if (mInterfacePtr->IsP6DofVisible())
      {
...
void RvP6DOFData::Plugin::CreateItem(QTreeWidgetItem* parent, eP6dofDataType aType)
{
...
/** Get a plot updater. */
std::unique_ptr<rv::PlotUpdater> RvP6DOFData::Plugin::GetPlotUpdater(const QString&               aX,
                                                                     const QString&               aY,
