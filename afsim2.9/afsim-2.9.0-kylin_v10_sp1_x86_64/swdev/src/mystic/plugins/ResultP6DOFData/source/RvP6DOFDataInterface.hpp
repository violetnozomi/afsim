...
// ****************************************************************************
#ifndef RVP6DOFDATAINTERFACE_HPP
#define RVP6DOFDATAINTERFACE_HPP
...
public:
   ...
   /** This is a container for p6dof event pipe messages. */
   struct P6dofDataContainer
   {
      std::string  m_name;
   ...
   const P6dofDataContainer GetP6DOFData();
...
#endif // RVP6DOFDATAINTERFACE_HPP
