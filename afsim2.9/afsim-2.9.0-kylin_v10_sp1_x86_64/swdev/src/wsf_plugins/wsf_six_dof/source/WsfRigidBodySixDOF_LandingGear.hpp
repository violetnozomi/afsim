...
#ifndef WSFRIGIDBODYSIXDOFLANDINGGEAR_HPP
#define WSFRIGIDBODYSIXDOFLANDINGGEAR_HPP
...
namespace six_dof
{
// The RigidBodyLandingGear class provides a means to provide forces and moments produced
// by landing gear and/or other contact points on the vehicle which are handled by
// instances of the RigidBodyGroundReactionPoint class.

class WSF_SIX_DOF_EXPORT RigidBodyLandingGear : public Object
{
public:
   ...
   RigidBodyGroundReactionPoint* GetNoseGear();

   // This returns a pointer to the right main gear
   RigidBodyGroundReactionPoint* GetRightMainGear();

   // This returns a pointer to the left main gear
   RigidBodyGroundReactionPoint* GetLeftMainGear();
...
protected:
   ...
   RigidBodyGroundReactionPoint*                             mNoseGear                   = nullptr;
   RigidBodyGroundReactionPoint*                             mRightMainGear              = nullptr;
   RigidBodyGroundReactionPoint*                             mLeftMainGear               = nullptr;
};
} // namespace six_dof
} // namespace wsf
