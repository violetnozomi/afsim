...
wsf::six_dof::RigidBodySyntheticPilot* wsf::six_dof::RigidBodySyntheticPilot::Clone() const
{
   return new RigidBodySyntheticPilot(*this);
}

wsf::six_dof::RigidBodySyntheticPilot::RigidBodySyntheticPilot(RigidBodyPilotObject* aPilotObject)
   : RigidBodyPilotObject(*aPilotObject)
{
}

bool wsf::six_dof::RigidBodySyntheticPilot::ProcessInput(UtInput& aInput)
{
   bool               myCommand = true;
   ...
   if (command == "synthetic_pilot")
   {
      ...
      while (block.ReadCommand())
      {
         ...
         {
            auto out = ut::log::error() << "Unrecognized command within RigidBodySyntheticPilot::ProcessInput().";
...
bool wsf::six_dof::RigidBodySyntheticPilot::Initialize(int64_t aSimTime_nanosec)
{
...
void wsf::six_dof::RigidBodySyntheticPilot::HoldAltitude()
{
...
void wsf::six_dof::RigidBodySyntheticPilot::HoldVerticalSpeed()
{
   Mover* vehicle = GetParentVehicle();
   if (vehicle == nullptr)
   {
...
void wsf::six_dof::RigidBodySyntheticPilot::HoldPitchAngle()
{
   Mover* vehicle = GetParentVehicle();
   if (vehicle == nullptr)
   {
...
void wsf::six_dof::RigidBodySyntheticPilot::HoldBankAngle()
{
   Mover* vehicle = GetParentVehicle();
   if (vehicle == nullptr)
   {
...
void wsf::six_dof::RigidBodySyntheticPilot::HoldHeading()
{
   Mover* vehicle = GetParentVehicle();
   if (vehicle == nullptr)
   {
...
void wsf::six_dof::RigidBodySyntheticPilot::HoldSpeedKCAS()
{
   Mover* vehicle = GetParentVehicle();
   if (vehicle == nullptr)
   {
...
void wsf::six_dof::RigidBodySyntheticPilot::HoldSpeedKTAS()
{
   Mover* vehicle = GetParentVehicle();
   if (vehicle == nullptr)
   {
...
void wsf::six_dof::RigidBodySyntheticPilot::HoldSpeedMach()
{
   Mover* vehicle = GetParentVehicle();
   if (vehicle == nullptr)
   {
