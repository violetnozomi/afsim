...
#ifndef WSF_SIXDOF_FORMATIONDETACHCOMMAND_HPP
#define WSF_SIXDOF_FORMATIONDETACHCOMMAND_HPP
...
namespace six_dof
{
class WSF_SIX_DOF_EXPORT FormationDetachCommand : public FormationCommand
{
public:
   FormationDetachCommand();
   FormationDetachCommand(const FormationDetachCommand& aOther) = default;
   ~FormationDetachCommand() override                           = default;

   FormationDetachCommand* Clone() const override;

   const char* GetScriptClassName() const override { return "WsfSixDOF_FormationDetachCommand"; }
...
#endif // WSF_SIXDOF_FORMATIONDETACHCOMMAND_HPP
