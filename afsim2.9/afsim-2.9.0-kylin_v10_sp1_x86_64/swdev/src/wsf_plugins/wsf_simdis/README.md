...
Supports output of SIMDIS's ASCII Scenario Input (ASI) file format.  This work is funded by Lockheed Martin Missiles & Fire Control and has been approved for release to the AFSIM community.
...
(2021 Feb 21) or higher DoD authority.
