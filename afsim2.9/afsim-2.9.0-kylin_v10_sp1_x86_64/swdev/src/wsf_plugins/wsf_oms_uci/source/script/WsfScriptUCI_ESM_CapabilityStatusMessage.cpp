...
#include "WsfScriptUCI_ESM_CapabilityStatusMessage.hpp"
...
UCI_ESM_CapabilityStatusMessageClass::UCI_ESM_CapabilityStatusMessageClass(const std::string& aClassName,
...
UT_DEFINE_SCRIPT_METHOD(UCI_ESM_CapabilityStatusMessageClass, UCI_ESM_CapabilityStatusMessage, CapabilityStatus, 1, "UCI_CapabilityStatus", "int")
{
   bool set{ false };
...
UT_DEFINE_SCRIPT_METHOD(UCI_ESM_CapabilityStatusMessageClass, UCI_ESM_CapabilityStatusMessage, Size, 0, "int", "")
{
