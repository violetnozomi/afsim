...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SystemManagementRequestType_h
#define Uci__Type__SystemManagementRequestType_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SystemManagementRequestType& accessor)
         ...
         /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           */
         virtual SystemManagementRequestTypeChoice getSystemManagementRequestTypeChoiceOrdinal() const
            throw(uci::base::UCIException) = 0;
         ...
         /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           *      base type.
           */
         virtual void setSystemManagementRequestTypeChoiceOrdinal(SystemManagementRequestTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null)
            throw(uci::base::UCIException) = 0;


         /** Returns the value of the enumeration that is identified by the SetMode.
           *
           * @return The value of the enumeration identified by SetMode.
           */
         virtual const uci::type::MessageModeEnum& getSetMode() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the SetMode.
           ...
           * @return The value of the enumeration identified by SetMode.
           */
         virtual uci::type::MessageModeEnum& getSetMode()
            throw(uci::base::UCIException) = 0;


         /** Sets the value of the enumeration that is identified by the SetMode.
           *
           * @param value The value to set the enumeration to
           */
         virtual void setSetMode(const uci::type::MessageModeEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the SetMode.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setSetMode(uci::type::MessageModeEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the SetIdentity.
           ...
           */
         virtual const uci::type::SystemIdentityType& getSetIdentity() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the SetIdentity.
           ...
           * @return The acecssor that provides access to the complex content that is identified by SetIdentity.
           */
         virtual uci::type::SystemIdentityType& getSetIdentity()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the SetIdentity to the contents of the complex content that is
           ...
           */
         virtual void setSetIdentity(const uci::type::SystemIdentityType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the SetLink16Metadata.
           ...
           */
         virtual const uci::type::Link16MetadataType& getSetLink16Metadata() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the SetLink16Metadata.
           ...
           * @return The acecssor that provides access to the complex content that is identified by SetLink16Metadata.
           */
         virtual uci::type::Link16MetadataType& getSetLink16Metadata()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the SetLink16Metadata to the contents of the complex content that is
           ...
           */
         virtual void setSetLink16Metadata(const uci::type::Link16MetadataType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the SetVoiceControl.
           ...
           */
         virtual const uci::type::VoiceControlType& getSetVoiceControl() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the SetVoiceControl.
           ...
           * @return The acecssor that provides access to the complex content that is identified by SetVoiceControl.
           */
         virtual uci::type::VoiceControlType& getSetVoiceControl()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the SetVoiceControl to the contents of the complex content that is
           ...
           */
         virtual void setSetVoiceControl(const uci::type::VoiceControlType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SystemManagementRequestType to the contents of the
           * SystemManagementRequestType on the right hand side (rhs) of the assignment operator.SystemManagementRequestType [only
           * available to derived classes]
           *
           * @param rhs The SystemManagementRequestType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::SystemManagementRequestType
           * @return A constant reference to this SystemManagementRequestType.
           */
         const SystemManagementRequestType& operator=(const SystemManagementRequestType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SystemManagementRequestType_h
