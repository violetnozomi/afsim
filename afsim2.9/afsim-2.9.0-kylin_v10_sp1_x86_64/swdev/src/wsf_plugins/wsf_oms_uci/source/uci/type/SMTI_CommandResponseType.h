...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SMTI_CommandResponseType_h
#define Uci__Type__SMTI_CommandResponseType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SMTI_CommandResponseType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SMTI_CommandResponseType& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the Capability.
           ...
           */
         virtual const uci::type::SMTI_CapabilityEnum& getCapability() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the Capability.
           ...
           * @return The value of the enumeration identified by Capability.
           */
         virtual uci::type::SMTI_CapabilityEnum& getCapability()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Capability.
           ...
           */
         virtual void setCapability(const uci::type::SMTI_CapabilityEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Capability.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setCapability(uci::type::SMTI_CapabilityEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the SubCapability.
           ...
           */
         virtual const uci::type::SMTI_SubCapabilityEnum& getSubCapability() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the SubCapability.
           ...
           * @return The value of the enumeration identified by SubCapability.
           */
         virtual uci::type::SMTI_SubCapabilityEnum& getSubCapability()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the SubCapability.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setSubCapability(const uci::type::SMTI_SubCapabilityEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the SubCapability.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setSubCapability(uci::type::SMTI_SubCapabilityEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;


         /** Returns whether this optionalfield SubCapabilityis available
           *
           * @return Whether the optional field is available (true) or not (false).
           */
         virtual bool hasSubCapability() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the optional field such that getSubCapability will return the optional field and not throw an exception when
           * invoked.
           *
           * @param type = uci::type::accessorType::sMTI_SubCapabilityEnum This Accessor's accessor type
           */
         virtual void enableSubCapability(uci::base::accessorType::AccessorType type = uci::type::accessorType::sMTI_SubCapabilityEnum)
            throw(uci::base::UCIException) = 0;


         /** Clears the optional item marking it as not being set. */
         virtual void clearSubCapability()
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           */
         virtual const uci::type::SMTI_CommandResponseType::ProductOutput& getProductOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           * @return The bounded list identified by ProductOutput.
           */
         virtual uci::type::SMTI_CommandResponseType::ProductOutput& getProductOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ProductOutput.
           ...
           *      accessor
           */
         virtual void setProductOutput(const uci::type::SMTI_CommandResponseType::ProductOutput& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the PreferredAllocation.
           ...
           */
         virtual const uci::type::SMTI_CommandResponseType::PreferredAllocation& getPreferredAllocation() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the PreferredAllocation.
           ...
           * @return The bounded list identified by PreferredAllocation.
           */
         virtual uci::type::SMTI_CommandResponseType::PreferredAllocation& getPreferredAllocation()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the PreferredAllocation.
           ...
           *      accessor
           */
         virtual void setPreferredAllocation(const uci::type::SMTI_CommandResponseType::PreferredAllocation& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SMTI_CommandResponseType to the contents of the
           * SMTI_CommandResponseType on the right hand side (rhs) of the assignment operator.SMTI_CommandResponseType [only
           * available to derived classes]
           *
           * @param rhs The SMTI_CommandResponseType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::SMTI_CommandResponseType
           * @return A constant reference to this SMTI_CommandResponseType.
           */
         const SMTI_CommandResponseType& operator=(const SMTI_CommandResponseType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SMTI_CommandResponseType_h
