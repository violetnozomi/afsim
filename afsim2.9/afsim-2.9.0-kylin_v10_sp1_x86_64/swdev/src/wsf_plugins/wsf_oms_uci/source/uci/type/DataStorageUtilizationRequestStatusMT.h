...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DataStorageUtilizationRequestStatusMT_h
#define Uci__Type__DataStorageUtilizationRequestStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class DataStorageUtilizationRequestStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~DataStorageUtilizationRequestStatusMT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DataStorageUtilizationRequestStatusMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::DataStorageUtilizationRequestStatusMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::DataStorageUtilizationRequestStatusMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::DataStorageUtilizationRequestStatusMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this DataStorageUtilizationRequestStatusMT to the contents of the
           * DataStorageUtilizationRequestStatusMT on the right hand side (rhs) of the assignment
           * operator.DataStorageUtilizationRequestStatusMT [only available to derived classes]
           *
           * @param rhs The DataStorageUtilizationRequestStatusMT on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::DataStorageUtilizationRequestStatusMT
           * @return A constant reference to this DataStorageUtilizationRequestStatusMT.
           */
         const DataStorageUtilizationRequestStatusMT& operator=(const DataStorageUtilizationRequestStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DataStorageUtilizationRequestStatusMT_h
