...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SecurityFileManagementType_h
#define Uci__Type__SecurityFileManagementType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SecurityFileManagementType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SecurityFileManagementType& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the Category.
           ...
           */
         virtual const uci::type::SecurityFileManagementEnum& getCategory() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the Category.
           ...
           * @return The value of the enumeration identified by Category.
           */
         virtual uci::type::SecurityFileManagementEnum& getCategory()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Category.
           ...
           */
         virtual void setCategory(const uci::type::SecurityFileManagementEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Category.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setCategory(uci::type::SecurityFileManagementEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SecurityFileManagementType to the contents of the
           * SecurityFileManagementType on the right hand side (rhs) of the assignment operator.SecurityFileManagementType [only
           * available to derived classes]
           *
           * @param rhs The SecurityFileManagementType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::SecurityFileManagementType
           * @return A constant reference to this SecurityFileManagementType.
           */
         const SecurityFileManagementType& operator=(const SecurityFileManagementType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SecurityFileManagementType_h
