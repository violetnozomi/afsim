...
*    Directive 5230.25.
*/
#ifndef Uci__Type__AssessmentID_Type_h
#define Uci__Type__AssessmentID_Type_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class AssessmentID_Type : public virtual uci::type::ID_Type {
      public:

         /** The destructor */
         virtual ~AssessmentID_Type()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const AssessmentID_Type& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this AssessmentID_Type to the contents of the AssessmentID_Type on the
           * right hand side (rhs) of the assignment operator.AssessmentID_Type [only available to derived classes]
           *
           * @param rhs The AssessmentID_Type on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::AssessmentID_Type
           * @return A constant reference to this AssessmentID_Type.
           */
         const AssessmentID_Type& operator=(const AssessmentID_Type& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__AssessmentID_Type_h
