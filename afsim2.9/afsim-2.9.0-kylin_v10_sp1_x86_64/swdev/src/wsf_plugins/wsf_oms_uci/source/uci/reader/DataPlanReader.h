...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__DataPlanReader_h
#define Uci__Reader__DataPlanReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The DataPlanListener provides the support to listen and handle incoming messages of the type uci::type::DataPlan */
      class DataPlanListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~DataPlanListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::DataPlan& message)
      ...
      class DataPlanReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~DataPlanReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(DataPlanListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(DataPlanListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, DataPlanListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, DataPlanListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DataPlanReader to copy from
           */
         DataPlanReader(const DataPlanReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DataPlanReader to the contents of the DataPlanReader on the right
           * hand side (rhs) of the assignment operator.DataPlanReader [only available to derived classes]
           *
           * @param rhs The DataPlanReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this DataPlanReader
           * @return A constant reference to this DataPlanReader.
           */
         const DataPlanReader& operator=(const DataPlanReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__DataPlanReader_h
