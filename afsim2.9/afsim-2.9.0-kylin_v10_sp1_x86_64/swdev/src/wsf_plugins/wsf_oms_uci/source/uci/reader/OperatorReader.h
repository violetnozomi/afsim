...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__OperatorReader_h
#define Uci__Reader__OperatorReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The OperatorListener provides the support to listen and handle incoming messages of the type uci::type::Operator */
      class OperatorListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~OperatorListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::Operator& message)
      ...
      class OperatorReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(OperatorListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(OperatorListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, OperatorListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, OperatorListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OperatorReader to copy from
           */
         OperatorReader(const OperatorReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OperatorReader to the contents of the OperatorReader on the right
           * hand side (rhs) of the assignment operator.OperatorReader [only available to derived classes]
           *
           * @param rhs The OperatorReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this OperatorReader
           * @return A constant reference to this OperatorReader.
           */
         const OperatorReader& operator=(const OperatorReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__OperatorReader_h
