...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommTerminalPlanActivationCommandStatusMDT_h
#define Uci__Type__CommTerminalPlanActivationCommandStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the CommTerminalPlanActivationCommandStatusMDT sequence accessor class */
      class CommTerminalPlanActivationCommandStatusMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~CommTerminalPlanActivationCommandStatusMDT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommTerminalPlanActivationCommandStatusMDT& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the CommandStatus.
           ...
           */
         virtual const uci::type::CommTerminalPlanActivationCommandStateEnum& getCommandStatus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the CommandStatus.
           ...
           * @return The value of the enumeration identified by CommandStatus.
           */
         virtual uci::type::CommTerminalPlanActivationCommandStateEnum& getCommandStatus()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the CommandStatus.
           ...
           */
         virtual void setCommandStatus(const uci::type::CommTerminalPlanActivationCommandStateEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the CommandStatus.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setCommandStatus(uci::type::CommTerminalPlanActivationCommandStateEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this CommTerminalPlanActivationCommandStatusMDT to the contents of the
           * CommTerminalPlanActivationCommandStatusMDT on the right hand side (rhs) of the assignment
           * operator.CommTerminalPlanActivationCommandStatusMDT [only available to derived classes]
           *
           * @param rhs The CommTerminalPlanActivationCommandStatusMDT on the right hand side (rhs) of the assignment operator
           *      whose contents are used to set the contents of this uci::type::CommTerminalPlanActivationCommandStatusMDT
           * @return A constant reference to this CommTerminalPlanActivationCommandStatusMDT.
           */
         const CommTerminalPlanActivationCommandStatusMDT& operator=(const CommTerminalPlanActivationCommandStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommTerminalPlanActivationCommandStatusMDT_h
