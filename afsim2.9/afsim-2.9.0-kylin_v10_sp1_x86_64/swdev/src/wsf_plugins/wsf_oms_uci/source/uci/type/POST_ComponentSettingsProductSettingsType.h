...
*    Directive 5230.25.
*/
#ifndef Uci__Type__POST_ComponentSettingsProductSettingsType_h
#define Uci__Type__POST_ComponentSettingsProductSettingsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the POST_ComponentSettingsProductSettingsType sequence accessor class */
      class POST_ComponentSettingsProductSettingsType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~POST_ComponentSettingsProductSettingsType()
         { }

         /** Returns this accessor's type constant, i.e. POST_ComponentSettingsProductSettingsType
           *
           * @return This accessor's type constant, i.e. POST_ComponentSettingsProductSettingsType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pOST_ComponentSettingsProductSettingsType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const POST_ComponentSettingsProductSettingsType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the ProductOutputControls.
           *
           * @return The acecssor that provides access to the complex content that is identified by ProductOutputControls.
           */
         virtual const uci::type::ComponentControlsA_Type& getProductOutputControls() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the ProductOutputControls.
           ...
           * @return The acecssor that provides access to the complex content that is identified by ProductOutputControls.
           */
         virtual uci::type::ComponentControlsA_Type& getProductOutputControls()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the ProductOutputControls to the contents of the complex content that
           * is accessed by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by ProductOutputControls
           */
         virtual void setProductOutputControls(const uci::type::ComponentControlsA_Type& value)
            throw(uci::base::UCIException) = 0;


         /** Returns whether the Element that is identified by ProductOutputControls exists (is enabled) or not.
           *
           * @return A boolean indicating whether the Element identified by ProductOutputControls is emabled or not
           */
         virtual bool hasProductOutputControls() const
            throw(uci::base::UCIException) = 0;


         /** Enables the Element that is identified by ProductOutputControls
           *
           * @param type = uci::type::accessorType::componentControlsA_Type This Accessor's accessor type
           */
         virtual void enableProductOutputControls(uci::base::accessorType::AccessorType type = uci::type::accessorType::componentControlsA_Type)
            throw(uci::base::UCIException) = 0;


         /** Clears (disabled) the Element that is identified by ProductOutputControls */
         virtual void clearProductOutputControls()
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         POST_ComponentSettingsProductSettingsType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The POST_ComponentSettingsProductSettingsType to copy from
           */
         POST_ComponentSettingsProductSettingsType(const POST_ComponentSettingsProductSettingsType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this POST_ComponentSettingsProductSettingsType to the contents of the
           * POST_ComponentSettingsProductSettingsType on the right hand side (rhs) of the assignment
           * operator.POST_ComponentSettingsProductSettingsType [only available to derived classes]
           *
           * @param rhs The POST_ComponentSettingsProductSettingsType on the right hand side (rhs) of the assignment operator
           *      whose contents are used to set the contents of this uci::type::POST_ComponentSettingsProductSettingsType
           * @return A constant reference to this POST_ComponentSettingsProductSettingsType.
           */
         const POST_ComponentSettingsProductSettingsType& operator=(const POST_ComponentSettingsProductSettingsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__POST_ComponentSettingsProductSettingsType_h
