...
*    Directive 5230.25.
*/
#ifndef Uci__Type__TaskMT_h
#define Uci__Type__TaskMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class TaskMT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. TaskMT
           *
           * @return This accessor's type constant, i.e. TaskMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::taskMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const TaskMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::TaskMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::TaskMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::TaskMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The TaskMT to copy from
           */
         TaskMT(const TaskMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this TaskMT to the contents of the TaskMT on the right hand side (rhs)
           * of the assignment operator.TaskMT [only available to derived classes]
           *
           * @param rhs The TaskMT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::TaskMT
           * @return A constant reference to this TaskMT.
           */
         const TaskMT& operator=(const TaskMT& rhs)
         {
            (void)rhs;
