...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductOutputCapabilityStatusImageryType_h
#define Uci__Type__ProductOutputCapabilityStatusImageryType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductOutputCapabilityStatusImageryType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductOutputCapabilityStatusImageryType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Returns the accessor that provides access to the complex content that is identified by the ProductOutputGeneratorID.
           *
           * @return The acecssor that provides access to the complex content that is identified by ProductOutputGeneratorID.
           */
         virtual const uci::type::PO_ProductGeneratorOutputID_Type& getProductOutputGeneratorID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the ProductOutputGeneratorID.
           ...
           * @return The acecssor that provides access to the complex content that is identified by ProductOutputGeneratorID.
           */
         virtual uci::type::PO_ProductGeneratorOutputID_Type& getProductOutputGeneratorID()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the ProductOutputGeneratorID to the contents of the complex content
           * that is accessed by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by ProductOutputGeneratorID
           */
         virtual void setProductOutputGeneratorID(const uci::type::PO_ProductGeneratorOutputID_Type& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ProductOutputCapabilityStatusImageryType to the contents of the
           * ProductOutputCapabilityStatusImageryType on the right hand side (rhs) of the assignment
           * operator.ProductOutputCapabilityStatusImageryType [only available to derived classes]
           *
           * @param rhs The ProductOutputCapabilityStatusImageryType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::ProductOutputCapabilityStatusImageryType
           * @return A constant reference to this ProductOutputCapabilityStatusImageryType.
           */
         const ProductOutputCapabilityStatusImageryType& operator=(const ProductOutputCapabilityStatusImageryType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductOutputCapabilityStatusImageryType_h
