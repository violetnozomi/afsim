...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ESM_ActivityMDT_h
#define Uci__Type__ESM_ActivityMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ESM_ActivityMDT sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ESM_ActivityMDT& accessor)
            throw(uci::base::UCIException) = 0;


         /** Indicates the dynamic operational characteristics of an Activity of an ESM Capability. [Maximum occurrences:
           * 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the Activity.
           ...
           */
         virtual const uci::type::ESM_ActivityMDT::Activity& getActivity() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Activity.
           ...
           * @return The bounded list identified by Activity.
           */
         virtual uci::type::ESM_ActivityMDT::Activity& getActivity()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Activity.
           ...
           *      accessor
           */
         virtual void setActivity(const uci::type::ESM_ActivityMDT::Activity& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ESM_ActivityMDT to the contents of the ESM_ActivityMDT on the
           * right hand side (rhs) of the assignment operator.ESM_ActivityMDT [only available to derived classes]
           *
           * @param rhs The ESM_ActivityMDT on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::ESM_ActivityMDT
           * @return A constant reference to this ESM_ActivityMDT.
           */
         const ESM_ActivityMDT& operator=(const ESM_ActivityMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ESM_ActivityMDT_h
