...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__MetaTaskReader_h
#define Uci__Reader__MetaTaskReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The MetaTaskListener provides the support to listen and handle incoming messages of the type uci::type::MetaTask */
      class MetaTaskListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~MetaTaskListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::MetaTask& message)
      ...
      class MetaTaskReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~MetaTaskReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(MetaTaskListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(MetaTaskListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, MetaTaskListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, MetaTaskListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The MetaTaskReader to copy from
           */
         MetaTaskReader(const MetaTaskReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this MetaTaskReader to the contents of the MetaTaskReader on the right
           * hand side (rhs) of the assignment operator.MetaTaskReader [only available to derived classes]
           *
           * @param rhs The MetaTaskReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this MetaTaskReader
           * @return A constant reference to this MetaTaskReader.
           */
         const MetaTaskReader& operator=(const MetaTaskReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__MetaTaskReader_h
