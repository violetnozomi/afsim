...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DamageReportMT_h
#define Uci__Type__DamageReportMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class DamageReportMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~DamageReportMT()
         { }

         /** Returns this accessor's type constant, i.e. DamageReportMT
           *
           * @return This accessor's type constant, i.e. DamageReportMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::damageReportMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DamageReportMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::DamageReportMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::DamageReportMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::DamageReportMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DamageReportMT to copy from
           */
         DamageReportMT(const DamageReportMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DamageReportMT to the contents of the DamageReportMT on the right
           * hand side (rhs) of the assignment operator.DamageReportMT [only available to derived classes]
           *
           * @param rhs The DamageReportMT on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::DamageReportMT
           * @return A constant reference to this DamageReportMT.
           */
         const DamageReportMT& operator=(const DamageReportMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DamageReportMT_h
