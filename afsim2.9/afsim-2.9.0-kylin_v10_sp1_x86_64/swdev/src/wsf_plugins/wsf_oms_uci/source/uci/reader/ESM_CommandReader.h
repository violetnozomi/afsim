...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__ESM_CommandReader_h
#define Uci__Reader__ESM_CommandReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The ESM_CommandListener provides the support to listen and handle incoming messages of the type
        * uci::type::ESM_Command
        */
      class ESM_CommandListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~ESM_CommandListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::ESM_Command& message)
      ...
      class ESM_CommandReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~ESM_CommandReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(ESM_CommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(ESM_CommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, ESM_CommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, ESM_CommandListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ESM_CommandReader to copy from
           */
         ESM_CommandReader(const ESM_CommandReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ESM_CommandReader to the contents of the ESM_CommandReader on the
           * right hand side (rhs) of the assignment operator.ESM_CommandReader [only available to derived classes]
           *
           * @param rhs The ESM_CommandReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this ESM_CommandReader
           * @return A constant reference to this ESM_CommandReader.
           */
         const ESM_CommandReader& operator=(const ESM_CommandReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__ESM_CommandReader_h
