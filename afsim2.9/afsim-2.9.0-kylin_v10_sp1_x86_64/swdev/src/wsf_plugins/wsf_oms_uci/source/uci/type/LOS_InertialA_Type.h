...
*    Directive 5230.25.
*/
#ifndef Uci__Type__LOS_InertialA_Type_h
#define Uci__Type__LOS_InertialA_Type_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const LOS_InertialA_Type& accessor)
         ...
         /** Enables the Element that is identified by Azimuth
           ...
           */
         virtual void enableAzimuth(uci::base::accessorType::AccessorType type = uci::type::accessorType::anglePositiveType)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this LOS_InertialA_Type to the contents of the LOS_InertialA_Type on
           * the right hand side (rhs) of the assignment operator.LOS_InertialA_Type [only available to derived classes]
           *
           * @param rhs The LOS_InertialA_Type on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::LOS_InertialA_Type
           * @return A constant reference to this LOS_InertialA_Type.
           */
         const LOS_InertialA_Type& operator=(const LOS_InertialA_Type& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__LOS_InertialA_Type_h
