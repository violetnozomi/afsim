...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DataPlanDetailsType_h
#define Uci__Type__DataPlanDetailsType_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DataPlanDetailsType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Indicates a list of Data Plan details keyed upon Data Gateways and represents their configuration data for a
           * timespan, zone, or other trigger. [Maximum occurrences: 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the AllocatedEffectivity.
           ...
           */
         virtual const uci::type::DataPlanDetailsType::AllocatedEffectivity& getAllocatedEffectivity() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the AllocatedEffectivity.
           ...
           * @return The bounded list identified by AllocatedEffectivity.
           */
         virtual uci::type::DataPlanDetailsType::AllocatedEffectivity& getAllocatedEffectivity()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the AllocatedEffectivity.
           ...
           *      accessor
           */
         virtual void setAllocatedEffectivity(const uci::type::DataPlanDetailsType::AllocatedEffectivity& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this DataPlanDetailsType to the contents of the DataPlanDetailsType on
           * the right hand side (rhs) of the assignment operator.DataPlanDetailsType [only available to derived classes]
           *
           * @param rhs The DataPlanDetailsType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::DataPlanDetailsType
           * @return A constant reference to this DataPlanDetailsType.
           */
         const DataPlanDetailsType& operator=(const DataPlanDetailsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DataPlanDetailsType_h
