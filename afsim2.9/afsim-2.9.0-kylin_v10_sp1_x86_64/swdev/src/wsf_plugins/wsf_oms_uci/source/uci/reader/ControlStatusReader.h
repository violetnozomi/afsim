...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__ControlStatusReader_h
#define Uci__Reader__ControlStatusReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The ControlStatusListener provides the support to listen and handle incoming messages of the type
        * uci::type::ControlStatus
        */
      class ControlStatusListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~ControlStatusListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::ControlStatus& message)
      ...
      class ControlStatusReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~ControlStatusReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(ControlStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(ControlStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, ControlStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, ControlStatusListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ControlStatusReader to copy from
           */
         ControlStatusReader(const ControlStatusReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ControlStatusReader to the contents of the ControlStatusReader on
           * the right hand side (rhs) of the assignment operator.ControlStatusReader [only available to derived classes]
           *
           * @param rhs The ControlStatusReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this ControlStatusReader
           * @return A constant reference to this ControlStatusReader.
           */
         const ControlStatusReader& operator=(const ControlStatusReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__ControlStatusReader_h
