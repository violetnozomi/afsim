...
*    Directive 5230.25.
*/
#ifndef Uci__Type__EA_EntityType_h
#define Uci__Type__EA_EntityType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the EA_EntityType sequence accessor class */
      class EA_EntityType : public virtual uci::base::Accessor {
      public:
         ...
         /** Returns this accessor's type constant, i.e. EA_EntityType
           *
           * @return This accessor's type constant, i.e. EA_EntityType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::eA_EntityType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const EA_EntityType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Indicates a proposed EA technique. See type annotations for further details. [Minimum occurrences: 0] [Maximum
         ...
         /** Indicates the proposed Component which the EA will be assigned to. [Minimum occurrences: 0] [Maximum occurrences:
           * 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the TechniqueID.
           ...
           */
         virtual const uci::type::EA_EntityType::TechniqueID& getTechniqueID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TechniqueID.
           ...
           * @return The bounded list identified by TechniqueID.
           */
         virtual uci::type::EA_EntityType::TechniqueID& getTechniqueID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the TechniqueID.
           ...
           *      accessor
           */
         virtual void setTechniqueID(const uci::type::EA_EntityType::TechniqueID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ComponentID.
           ...
           */
         virtual const uci::type::EA_EntityType::ComponentID& getComponentID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ComponentID.
           ...
           * @return The bounded list identified by ComponentID.
           */
         virtual uci::type::EA_EntityType::ComponentID& getComponentID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ComponentID.
           ...
           *      accessor
           */
         virtual void setComponentID(const uci::type::EA_EntityType::ComponentID& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         EA_EntityType(const EA_EntityType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this EA_EntityType to the contents of the EA_EntityType on the right
           * hand side (rhs) of the assignment operator.EA_EntityType [only available to derived classes]
           *
           * @param rhs The EA_EntityType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::EA_EntityType
           * @return A constant reference to this EA_EntityType.
           */
         const EA_EntityType& operator=(const EA_EntityType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__EA_EntityType_h
