...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ServiceConfigurationParamsRequestMDT_h
#define Uci__Type__ServiceConfigurationParamsRequestMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ServiceConfigurationParamsRequestMDT sequence accessor class */
      class ServiceConfigurationParamsRequestMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ServiceConfigurationParamsRequestMDT()
         { }

         /** Returns this accessor's type constant, i.e. ServiceConfigurationParamsRequestMDT
           *
           * @return This accessor's type constant, i.e. ServiceConfigurationParamsRequestMDT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::serviceConfigurationParamsRequestMDT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ServiceConfigurationParamsRequestMDT& accessor)
         ...
         /** Enables the Element that is identified by Category
           ...
           */
         virtual void enableCategory(uci::base::accessorType::AccessorType type = uci::type::accessorType::visibleString32Type)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         ServiceConfigurationParamsRequestMDT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ServiceConfigurationParamsRequestMDT to copy from
           */
         ServiceConfigurationParamsRequestMDT(const ServiceConfigurationParamsRequestMDT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ServiceConfigurationParamsRequestMDT to the contents of the
           * ServiceConfigurationParamsRequestMDT on the right hand side (rhs) of the assignment
           * operator.ServiceConfigurationParamsRequestMDT [only available to derived classes]
           *
           * @param rhs The ServiceConfigurationParamsRequestMDT on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::ServiceConfigurationParamsRequestMDT
           * @return A constant reference to this ServiceConfigurationParamsRequestMDT.
           */
         const ServiceConfigurationParamsRequestMDT& operator=(const ServiceConfigurationParamsRequestMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ServiceConfigurationParamsRequestMDT_h
