...
*    Directive 5230.25.
*/
#ifndef Uci__Type__AMTI_CommandResponseType_h
#define Uci__Type__AMTI_CommandResponseType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class AMTI_CommandResponseType : public virtual uci::base::Accessor {
      public:
         ...
         /** Returns this accessor's type constant, i.e. AMTI_CommandResponseType
           *
           * @return This accessor's type constant, i.e. AMTI_CommandResponseType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::aMTI_CommandResponseType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const AMTI_CommandResponseType& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the Capability.
           ...
           */
         virtual const uci::type::AMTI_CapabilityEnum& getCapability() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the Capability.
           ...
           * @return The value of the enumeration identified by Capability.
           */
         virtual uci::type::AMTI_CapabilityEnum& getCapability()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Capability.
           ...
           */
         virtual void setCapability(const uci::type::AMTI_CapabilityEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Capability.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setCapability(uci::type::AMTI_CapabilityEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           */
         virtual const uci::type::AMTI_CommandResponseType::ProductOutput& getProductOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           * @return The bounded list identified by ProductOutput.
           */
         virtual uci::type::AMTI_CommandResponseType::ProductOutput& getProductOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ProductOutput.
           ...
           *      accessor
           */
         virtual void setProductOutput(const uci::type::AMTI_CommandResponseType::ProductOutput& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the PreferredAllocation.
           ...
           */
         virtual const uci::type::AMTI_CommandResponseType::PreferredAllocation& getPreferredAllocation() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the PreferredAllocation.
           ...
           * @return The bounded list identified by PreferredAllocation.
           */
         virtual uci::type::AMTI_CommandResponseType::PreferredAllocation& getPreferredAllocation()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the PreferredAllocation.
           ...
           *      accessor
           */
         virtual void setPreferredAllocation(const uci::type::AMTI_CommandResponseType::PreferredAllocation& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         AMTI_CommandResponseType(const AMTI_CommandResponseType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this AMTI_CommandResponseType to the contents of the
           * AMTI_CommandResponseType on the right hand side (rhs) of the assignment operator.AMTI_CommandResponseType [only
           * available to derived classes]
           *
           * @param rhs The AMTI_CommandResponseType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::AMTI_CommandResponseType
           * @return A constant reference to this AMTI_CommandResponseType.
           */
         const AMTI_CommandResponseType& operator=(const AMTI_CommandResponseType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__AMTI_CommandResponseType_h
