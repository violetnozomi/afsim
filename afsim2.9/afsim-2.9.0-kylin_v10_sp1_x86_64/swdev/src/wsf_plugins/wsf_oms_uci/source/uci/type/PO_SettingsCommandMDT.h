...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_SettingsCommandMDT_h
#define Uci__Type__PO_SettingsCommandMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_SettingsCommandMDT sequence accessor class */
      class PO_SettingsCommandMDT : public virtual uci::type::CapabilitySettingsCommandBaseType {
      public:

         /** The destructor */
         virtual ~PO_SettingsCommandMDT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_SettingsCommandMDT& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this PO_SettingsCommandMDT to the contents of the PO_SettingsCommandMDT
           * on the right hand side (rhs) of the assignment operator.PO_SettingsCommandMDT [only available to derived classes]
           *
           * @param rhs The PO_SettingsCommandMDT on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::PO_SettingsCommandMDT
           * @return A constant reference to this PO_SettingsCommandMDT.
           */
         const PO_SettingsCommandMDT& operator=(const PO_SettingsCommandMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_SettingsCommandMDT_h
