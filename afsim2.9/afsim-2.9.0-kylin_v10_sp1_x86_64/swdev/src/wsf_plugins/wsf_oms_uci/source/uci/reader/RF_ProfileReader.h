...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__RF_ProfileReader_h
#define Uci__Reader__RF_ProfileReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The RF_ProfileListener provides the support to listen and handle incoming messages of the type uci::type::RF_Profile */
      class RF_ProfileListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~RF_ProfileListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::RF_Profile& message)
      ...
      class RF_ProfileReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~RF_ProfileReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(RF_ProfileListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(RF_ProfileListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, RF_ProfileListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, RF_ProfileListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The RF_ProfileReader to copy from
           */
         RF_ProfileReader(const RF_ProfileReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this RF_ProfileReader to the contents of the RF_ProfileReader on the
           * right hand side (rhs) of the assignment operator.RF_ProfileReader [only available to derived classes]
           *
           * @param rhs The RF_ProfileReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this RF_ProfileReader
           * @return A constant reference to this RF_ProfileReader.
           */
         const RF_ProfileReader& operator=(const RF_ProfileReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__RF_ProfileReader_h
