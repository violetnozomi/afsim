...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ESM_CapabilityType_h
#define Uci__Type__ESM_CapabilityType_h 1
...
#if !defined(Uci__Type__ESM_CapabilityOptionsType_h)
...
#if !defined(Uci__Type__ESM_PerformanceProfileType_h)
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ESM_CapabilityType sequence accessor class */
      class ESM_CapabilityType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ESM_CapabilityType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ESM_CapabilityType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Indicates a SubCapability of the ESM Capability, the second tier in the taxonomy of ESM. For ESM, the second tier is
           * an indication of the specific collection technique. See enumeration annotations for further details. [Maximum
           * occurrences: 12]
           */
         ...
         /** Indicates a summary of the expected coverage of a Dwell(s) associated with the Capability. This element does not
           ...
           * the ESM_Activity message. [Minimum occurrences: 0] [Maximum occurrences: 9223372036854775807]
           */
         ...
         /** Definition of ESM performance for the parent Capability, based on the status of Supporting Capabilities (i.e. Antenna
           ...
           * profiles. [Minimum occurrences: 0] [Maximum occurrences: 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the SubCapabilityType.
           ...
           */
         virtual const uci::type::ESM_CapabilityType::SubCapabilityType& getSubCapabilityType() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the SubCapabilityType.
           ...
           * @return The bounded list identified by SubCapabilityType.
           */
         virtual uci::type::ESM_CapabilityType::SubCapabilityType& getSubCapabilityType()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the SubCapabilityType.
           ...
           *      accessor
           */
         virtual void setSubCapabilityType(const uci::type::ESM_CapabilityType::SubCapabilityType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the GeolocationType.
           ...
           */
         virtual const uci::type::ESM_CapabilityType::GeolocationType& getGeolocationType() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the GeolocationType.
           ...
           * @return The bounded list identified by GeolocationType.
           */
         virtual uci::type::ESM_CapabilityType::GeolocationType& getGeolocationType()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the GeolocationType.
           ...
           *      accessor
           */
         virtual void setGeolocationType(const uci::type::ESM_CapabilityType::GeolocationType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the AcceptedInterface.
           ...
           */
         virtual const uci::type::ESM_CapabilityType::AcceptedInterface& getAcceptedInterface() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the AcceptedInterface.
           ...
           * @return The bounded list identified by AcceptedInterface.
           */
         virtual uci::type::ESM_CapabilityType::AcceptedInterface& getAcceptedInterface()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the AcceptedInterface.
           ...
           *      accessor
           */
         virtual void setAcceptedInterface(const uci::type::ESM_CapabilityType::AcceptedInterface& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the CapabilityOptions.
           ...
           */
         virtual const uci::type::ESM_CapabilityOptionsType& getCapabilityOptions() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the CapabilityOptions.
           ...
           * @return The acecssor that provides access to the complex content that is identified by CapabilityOptions.
           */
         virtual uci::type::ESM_CapabilityOptionsType& getCapabilityOptions()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the CapabilityOptions to the contents of the complex content that is
           ...
           */
         virtual void setCapabilityOptions(const uci::type::ESM_CapabilityOptionsType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DwellCoverage.
           ...
           */
         virtual const uci::type::ESM_CapabilityType::DwellCoverage& getDwellCoverage() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DwellCoverage.
           ...
           * @return The bounded list identified by DwellCoverage.
           */
         virtual uci::type::ESM_CapabilityType::DwellCoverage& getDwellCoverage()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the DwellCoverage.
           ...
           *      accessor
           */
         virtual void setDwellCoverage(const uci::type::ESM_CapabilityType::DwellCoverage& value)
            throw(uci::base::UCIException) = 0;


         /** Returns the bounded list that is identified by the ESM_PerformanceProfile.
           *
           * @return The bounded list identified by ESM_PerformanceProfile.
           */
         virtual const uci::type::ESM_CapabilityType::ESM_PerformanceProfile& getESM_PerformanceProfile() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ESM_PerformanceProfile.
           ...
           * @return The bounded list identified by ESM_PerformanceProfile.
           */
         virtual uci::type::ESM_CapabilityType::ESM_PerformanceProfile& getESM_PerformanceProfile()
            throw(uci::base::UCIException) = 0;


         /** Sets the bounded list that is identified by the ESM_PerformanceProfile.
           *
           * @param value The bounded list whose contents are to be used to set the value of the bounded list accessed by this
           *      accessor
           */
         virtual void setESM_PerformanceProfile(const uci::type::ESM_CapabilityType::ESM_PerformanceProfile& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           */
         virtual const uci::type::ESM_CapabilityType::ProductOutput& getProductOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           * @return The bounded list identified by ProductOutput.
           */
         virtual uci::type::ESM_CapabilityType::ProductOutput& getProductOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ProductOutput.
           ...
           *      accessor
           */
         virtual void setProductOutput(const uci::type::ESM_CapabilityType::ProductOutput& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the MessageOutput.
           ...
           */
         virtual const uci::type::ESM_CapabilityType::MessageOutput& getMessageOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the MessageOutput.
           ...
           * @return The bounded list identified by MessageOutput.
           */
         virtual uci::type::ESM_CapabilityType::MessageOutput& getMessageOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the MessageOutput.
           ...
           *      accessor
           */
         virtual void setMessageOutput(const uci::type::ESM_CapabilityType::MessageOutput& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ESM_CapabilityType to the contents of the ESM_CapabilityType on
           * the right hand side (rhs) of the assignment operator.ESM_CapabilityType [only available to derived classes]
           *
           * @param rhs The ESM_CapabilityType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::ESM_CapabilityType
           * @return A constant reference to this ESM_CapabilityType.
           */
         const ESM_CapabilityType& operator=(const ESM_CapabilityType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ESM_CapabilityType_h
