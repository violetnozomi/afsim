...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_TaskBaseType_h
#define Uci__Type__PO_TaskBaseType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_TaskBaseType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_TaskBaseType& accessor)
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           */
         virtual const uci::type::PO_TaskBaseType::Output& getOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           * @return The bounded list identified by Output.
           */
         virtual uci::type::PO_TaskBaseType::Output& getOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Output.
           ...
           *      accessor
           */
         virtual void setOutput(const uci::type::PO_TaskBaseType::Output& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this PO_TaskBaseType to the contents of the PO_TaskBaseType on the
           * right hand side (rhs) of the assignment operator.PO_TaskBaseType [only available to derived classes]
           *
           * @param rhs The PO_TaskBaseType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::PO_TaskBaseType
           * @return A constant reference to this PO_TaskBaseType.
           */
         const PO_TaskBaseType& operator=(const PO_TaskBaseType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_TaskBaseType_h
