...
*    Directive 5230.25.
*/
#ifndef Uci__Type__OperatorActionType_h
#define Uci__Type__OperatorActionType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the OperatorActionType sequence accessor class */
      class OperatorActionType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~OperatorActionType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const OperatorActionType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this OperatorActionType to the contents of the OperatorActionType on
           * the right hand side (rhs) of the assignment operator.OperatorActionType [only available to derived classes]
           *
           * @param rhs The OperatorActionType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::OperatorActionType
           * @return A constant reference to this OperatorActionType.
           */
         const OperatorActionType& operator=(const OperatorActionType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__OperatorActionType_h
