...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__RF_ReportReader_h
#define Uci__Reader__RF_ReportReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The RF_ReportListener provides the support to listen and handle incoming messages of the type uci::type::RF_Report */
      class RF_ReportListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~RF_ReportListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::RF_Report& message)
      ...
      class RF_ReportReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~RF_ReportReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(RF_ReportListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(RF_ReportListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, RF_ReportListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, RF_ReportListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The RF_ReportReader to copy from
           */
         RF_ReportReader(const RF_ReportReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this RF_ReportReader to the contents of the RF_ReportReader on the
           * right hand side (rhs) of the assignment operator.RF_ReportReader [only available to derived classes]
           *
           * @param rhs The RF_ReportReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this RF_ReportReader
           * @return A constant reference to this RF_ReportReader.
           */
         const RF_ReportReader& operator=(const RF_ReportReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__RF_ReportReader_h
