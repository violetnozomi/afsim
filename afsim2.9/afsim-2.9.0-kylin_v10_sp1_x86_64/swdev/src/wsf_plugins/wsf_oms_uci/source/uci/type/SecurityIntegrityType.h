...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SecurityIntegrityType_h
#define Uci__Type__SecurityIntegrityType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SecurityIntegrityType sequence accessor class */
      class SecurityIntegrityType : public virtual uci::base::Accessor {
      public:
         ...
         /** Returns this accessor's type constant, i.e. SecurityIntegrityType
           *
           * @return This accessor's type constant, i.e. SecurityIntegrityType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::securityIntegrityType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SecurityIntegrityType& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the Category.
           ...
           */
         virtual const uci::type::SecurityIntegrityEnum& getCategory() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the Category.
           ...
           * @return The value of the enumeration identified by Category.
           */
         virtual uci::type::SecurityIntegrityEnum& getCategory()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Category.
           ...
           */
         virtual void setCategory(const uci::type::SecurityIntegrityEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Category.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setCategory(uci::type::SecurityIntegrityEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         SecurityIntegrityType(const SecurityIntegrityType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SecurityIntegrityType to the contents of the SecurityIntegrityType
           * on the right hand side (rhs) of the assignment operator.SecurityIntegrityType [only available to derived classes]
           *
           * @param rhs The SecurityIntegrityType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::SecurityIntegrityType
           * @return A constant reference to this SecurityIntegrityType.
           */
         const SecurityIntegrityType& operator=(const SecurityIntegrityType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SecurityIntegrityType_h
