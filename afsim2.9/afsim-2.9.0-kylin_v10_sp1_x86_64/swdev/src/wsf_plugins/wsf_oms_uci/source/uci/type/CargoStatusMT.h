...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CargoStatusMT_h
#define Uci__Type__CargoStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class CargoStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~CargoStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. CargoStatusMT
           *
           * @return This accessor's type constant, i.e. CargoStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::cargoStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CargoStatusMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::CargoStatusMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::CargoStatusMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::CargoStatusMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         CargoStatusMT(const CargoStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CargoStatusMT to the contents of the CargoStatusMT on the right
           * hand side (rhs) of the assignment operator.CargoStatusMT [only available to derived classes]
           *
           * @param rhs The CargoStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::CargoStatusMT
           * @return A constant reference to this CargoStatusMT.
           */
         const CargoStatusMT& operator=(const CargoStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CargoStatusMT_h
