...
*    Directive 5230.25.
*/
#ifndef Uci__Type__QueryRequestMT_h
#define Uci__Type__QueryRequestMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class QueryRequestMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~QueryRequestMT()
         { }

         /** Returns this accessor's type constant, i.e. QueryRequestMT
           *
           * @return This accessor's type constant, i.e. QueryRequestMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::queryRequestMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const QueryRequestMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::QueryRequestMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::QueryRequestMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::QueryRequestMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The QueryRequestMT to copy from
           */
         QueryRequestMT(const QueryRequestMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this QueryRequestMT to the contents of the QueryRequestMT on the right
           * hand side (rhs) of the assignment operator.QueryRequestMT [only available to derived classes]
           *
           * @param rhs The QueryRequestMT on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::QueryRequestMT
           * @return A constant reference to this QueryRequestMT.
           */
         const QueryRequestMT& operator=(const QueryRequestMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__QueryRequestMT_h
