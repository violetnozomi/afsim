...
*    Directive 5230.25.
*/
#ifndef Uci__Type__FusionSettingsQFT_h
#define Uci__Type__FusionSettingsQFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the FusionSettingsQFT sequence accessor class */
      class FusionSettingsQFT : public virtual uci::type::QueryFilterPET {
      public:

         /** The destructor */
         virtual ~FusionSettingsQFT()
         { }

         /** Returns this accessor's type constant, i.e. FusionSettingsQFT
           *
           * @return This accessor's type constant, i.e. FusionSettingsQFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::fusionSettingsQFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const FusionSettingsQFT& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The FusionSettingsQFT to copy from
           */
         FusionSettingsQFT(const FusionSettingsQFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this FusionSettingsQFT to the contents of the FusionSettingsQFT on the
           * right hand side (rhs) of the assignment operator.FusionSettingsQFT [only available to derived classes]
           *
           * @param rhs The FusionSettingsQFT on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::FusionSettingsQFT
           * @return A constant reference to this FusionSettingsQFT.
           */
         const FusionSettingsQFT& operator=(const FusionSettingsQFT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__FusionSettingsQFT_h
