...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_ComponentProductGeneratorOutputType_h
#define Uci__Type__PO_ComponentProductGeneratorOutputType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_ComponentProductGeneratorOutputType sequence accessor class */
      class PO_ComponentProductGeneratorOutputType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~PO_ComponentProductGeneratorOutputType()
         { }

         /** Returns this accessor's type constant, i.e. PO_ComponentProductGeneratorOutputType
           *
           * @return This accessor's type constant, i.e. PO_ComponentProductGeneratorOutputType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pO_ComponentProductGeneratorOutputType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_ComponentProductGeneratorOutputType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Product.
           *
           * @return The acecssor that provides access to the complex content that is identified by Product.
           */
         virtual const uci::type::ProductOutputType& getProduct() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Product.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Product.
           */
         virtual uci::type::ProductOutputType& getProduct()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the Product to the contents of the complex content that is accessed by
           * the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by Product
           */
         virtual void setProduct(const uci::type::ProductOutputType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         PO_ComponentProductGeneratorOutputType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The PO_ComponentProductGeneratorOutputType to copy from
           */
         PO_ComponentProductGeneratorOutputType(const PO_ComponentProductGeneratorOutputType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this PO_ComponentProductGeneratorOutputType to the contents of the
           * PO_ComponentProductGeneratorOutputType on the right hand side (rhs) of the assignment
           * operator.PO_ComponentProductGeneratorOutputType [only available to derived classes]
           *
           * @param rhs The PO_ComponentProductGeneratorOutputType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::PO_ComponentProductGeneratorOutputType
           * @return A constant reference to this PO_ComponentProductGeneratorOutputType.
           */
         const PO_ComponentProductGeneratorOutputType& operator=(const PO_ComponentProductGeneratorOutputType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_ComponentProductGeneratorOutputType_h
