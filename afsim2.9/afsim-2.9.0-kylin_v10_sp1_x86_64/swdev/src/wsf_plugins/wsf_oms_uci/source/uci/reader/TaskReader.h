...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__TaskReader_h
#define Uci__Reader__TaskReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The TaskListener provides the support to listen and handle incoming messages of the type uci::type::Task */
      class TaskListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::Task& message)
      ...
      class TaskReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(TaskListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(TaskListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, TaskListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, TaskListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The TaskReader to copy from
           */
         TaskReader(const TaskReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this TaskReader to the contents of the TaskReader on the right hand
           * side (rhs) of the assignment operator.TaskReader [only available to derived classes]
           *
           * @param rhs The TaskReader on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this TaskReader
           * @return A constant reference to this TaskReader.
           */
         const TaskReader& operator=(const TaskReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__TaskReader_h
