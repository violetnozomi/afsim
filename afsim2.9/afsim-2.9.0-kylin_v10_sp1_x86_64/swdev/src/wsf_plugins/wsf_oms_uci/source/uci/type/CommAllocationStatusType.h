...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommAllocationStatusType_h
#define Uci__Type__CommAllocationStatusType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the CommAllocationStatusType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommAllocationStatusType& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the AllocationUpdateStatus.
           *
           * @return The value of the enumeration identified by AllocationUpdateStatus.
           */
         virtual const uci::type::ProcessingStatusEnum& getAllocationUpdateStatus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the AllocationUpdateStatus.
           ...
           * @return The value of the enumeration identified by AllocationUpdateStatus.
           */
         virtual uci::type::ProcessingStatusEnum& getAllocationUpdateStatus()
            throw(uci::base::UCIException) = 0;


         /** Sets the value of the enumeration that is identified by the AllocationUpdateStatus.
           *
           * @param value The value to set the enumeration to
           */
         virtual void setAllocationUpdateStatus(const uci::type::ProcessingStatusEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the AllocationUpdateStatus.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setAllocationUpdateStatus(uci::type::ProcessingStatusEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this CommAllocationStatusType to the contents of the
           * CommAllocationStatusType on the right hand side (rhs) of the assignment operator.CommAllocationStatusType [only
           * available to derived classes]
           *
           * @param rhs The CommAllocationStatusType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::CommAllocationStatusType
           * @return A constant reference to this CommAllocationStatusType.
           */
         const CommAllocationStatusType& operator=(const CommAllocationStatusType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommAllocationStatusType_h
