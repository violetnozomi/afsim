...
*    Directive 5230.25.
*/
#ifndef Uci__Type__WeatherRadarTaskType_h
#define Uci__Type__WeatherRadarTaskType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the WeatherRadarTaskType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const WeatherRadarTaskType& accessor)
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           */
         virtual const uci::type::WeatherRadarTaskType::Output& getOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           * @return The bounded list identified by Output.
           */
         virtual uci::type::WeatherRadarTaskType::Output& getOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Output.
           ...
           *      accessor
           */
         virtual void setOutput(const uci::type::WeatherRadarTaskType::Output& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this WeatherRadarTaskType to the contents of the WeatherRadarTaskType
           * on the right hand side (rhs) of the assignment operator.WeatherRadarTaskType [only available to derived classes]
           *
           * @param rhs The WeatherRadarTaskType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::WeatherRadarTaskType
           * @return A constant reference to this WeatherRadarTaskType.
           */
         const WeatherRadarTaskType& operator=(const WeatherRadarTaskType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__WeatherRadarTaskType_h
