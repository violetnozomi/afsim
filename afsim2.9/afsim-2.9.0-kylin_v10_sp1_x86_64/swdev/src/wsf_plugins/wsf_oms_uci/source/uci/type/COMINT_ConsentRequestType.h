...
*    Directive 5230.25.
*/
#ifndef Uci__Type__COMINT_ConsentRequestType_h
#define Uci__Type__COMINT_ConsentRequestType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the COMINT_ConsentRequestType sequence accessor class */
      class COMINT_ConsentRequestType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~COMINT_ConsentRequestType()
         { }

         /** Returns this accessor's type constant, i.e. COMINT_ConsentRequestType
           *
           * @return This accessor's type constant, i.e. COMINT_ConsentRequestType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::cOMINT_ConsentRequestType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const COMINT_ConsentRequestType& accessor)
      ...
      protected:
         ...
         COMINT_ConsentRequestType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The COMINT_ConsentRequestType to copy from
           */
         COMINT_ConsentRequestType(const COMINT_ConsentRequestType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this COMINT_ConsentRequestType to the contents of the
           * COMINT_ConsentRequestType on the right hand side (rhs) of the assignment operator.COMINT_ConsentRequestType [only
           * available to derived classes]
           *
           * @param rhs The COMINT_ConsentRequestType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::COMINT_ConsentRequestType
           * @return A constant reference to this COMINT_ConsentRequestType.
           */
         const COMINT_ConsentRequestType& operator=(const COMINT_ConsentRequestType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__COMINT_ConsentRequestType_h
