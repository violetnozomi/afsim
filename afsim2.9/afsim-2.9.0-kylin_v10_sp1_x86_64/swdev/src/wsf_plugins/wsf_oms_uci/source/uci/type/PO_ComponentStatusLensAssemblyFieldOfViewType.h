...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_ComponentStatusLensAssemblyFieldOfViewType_h
#define Uci__Type__PO_ComponentStatusLensAssemblyFieldOfViewType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_ComponentStatusLensAssemblyFieldOfViewType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_ComponentStatusLensAssemblyFieldOfViewType& accessor)
         ...
         /** Returns whether the Element that is identified by AutoZoom exists (is enabled) or not.
           *
           * @return A boolean indicating whether the Element identified by AutoZoom is emabled or not
           */
         virtual bool hasAutoZoom() const
            throw(uci::base::UCIException) = 0;


         /** Enables the Element that is identified by AutoZoom
           *
           * @param type = uci::base::accessorType::booleanAccessor This Accessor's accessor type
           */
         virtual void enableAutoZoom(uci::base::accessorType::AccessorType type = uci::base::accessorType::booleanAccessor)
            throw(uci::base::UCIException) = 0;


         /** Clears (disabled) the Element that is identified by AutoZoom */
         virtual void clearAutoZoom()
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this PO_ComponentStatusLensAssemblyFieldOfViewType to the contents of
           * the PO_ComponentStatusLensAssemblyFieldOfViewType on the right hand side (rhs) of the assignment
           * operator.PO_ComponentStatusLensAssemblyFieldOfViewType [only available to derived classes]
           *
           * @param rhs The PO_ComponentStatusLensAssemblyFieldOfViewType on the right hand side (rhs) of the assignment operator
           *      whose contents are used to set the contents of this uci::type::PO_ComponentStatusLensAssemblyFieldOfViewType
           * @return A constant reference to this PO_ComponentStatusLensAssemblyFieldOfViewType.
           */
         const PO_ComponentStatusLensAssemblyFieldOfViewType& operator=(const PO_ComponentStatusLensAssemblyFieldOfViewType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_ComponentStatusLensAssemblyFieldOfViewType_h
