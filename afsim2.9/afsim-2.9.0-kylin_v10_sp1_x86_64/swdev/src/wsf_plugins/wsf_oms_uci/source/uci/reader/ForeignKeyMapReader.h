...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__ForeignKeyMapReader_h
#define Uci__Reader__ForeignKeyMapReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The ForeignKeyMapListener provides the support to listen and handle incoming messages of the type
        * uci::type::ForeignKeyMap
        */
      class ForeignKeyMapListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~ForeignKeyMapListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::ForeignKeyMap& message)
            throw(uci::base::UCIException) = 0;


      }; // ForeignKeyMapListener


      /** The Reader provides the support to reader incoming messages. */
      class ForeignKeyMapReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~ForeignKeyMapReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(ForeignKeyMapListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(ForeignKeyMapListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, ForeignKeyMapListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, ForeignKeyMapListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ForeignKeyMapReader to copy from
           */
         ForeignKeyMapReader(const ForeignKeyMapReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ForeignKeyMapReader to the contents of the ForeignKeyMapReader on
           * the right hand side (rhs) of the assignment operator.ForeignKeyMapReader [only available to derived classes]
           *
           * @param rhs The ForeignKeyMapReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this ForeignKeyMapReader
           * @return A constant reference to this ForeignKeyMapReader.
           */
         const ForeignKeyMapReader& operator=(const ForeignKeyMapReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__ForeignKeyMapReader_h
