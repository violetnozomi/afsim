...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductDisseminationStatusType_h
#define Uci__Type__ProductDisseminationStatusType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductDisseminationStatusType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductDisseminationStatusType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Product.
           ...
           */
         virtual const uci::type::DisseminationProductType& getProduct() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Product.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Product.
           */
         virtual uci::type::DisseminationProductType& getProduct()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Product to the contents of the complex content that is accessed by
           ...
           */
         virtual void setProduct(const uci::type::DisseminationProductType& value)
            throw(uci::base::UCIException) = 0;


         /** Returns the value of the enumeration that is identified by the ProductDisseminationState.
           *
           * @return The value of the enumeration identified by ProductDisseminationState.
           */
         virtual const uci::type::DisseminationStatusEnum& getProductDisseminationState() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the ProductDisseminationState.
           ...
           * @return The value of the enumeration identified by ProductDisseminationState.
           */
         virtual uci::type::DisseminationStatusEnum& getProductDisseminationState()
            throw(uci::base::UCIException) = 0;


         /** Sets the value of the enumeration that is identified by the ProductDisseminationState.
           *
           * @param value The value to set the enumeration to
           */
         virtual void setProductDisseminationState(const uci::type::DisseminationStatusEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the ProductDisseminationState.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setProductDisseminationState(uci::type::DisseminationStatusEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ProductDisseminationStatusType to the contents of the
           * ProductDisseminationStatusType on the right hand side (rhs) of the assignment operator.ProductDisseminationStatusType
           * [only available to derived classes]
           *
           * @param rhs The ProductDisseminationStatusType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::ProductDisseminationStatusType
           * @return A constant reference to this ProductDisseminationStatusType.
           */
         const ProductDisseminationStatusType& operator=(const ProductDisseminationStatusType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductDisseminationStatusType_h
