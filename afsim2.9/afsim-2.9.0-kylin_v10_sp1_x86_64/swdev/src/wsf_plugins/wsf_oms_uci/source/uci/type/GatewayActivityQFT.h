...
*    Directive 5230.25.
*/
#ifndef Uci__Type__GatewayActivityQFT_h
#define Uci__Type__GatewayActivityQFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** Query Filter Type to query for Gateway Activity. */
      class GatewayActivityQFT : public virtual uci::type::QueryFilterPET {
      public:

         /** The destructor */
         virtual ~GatewayActivityQFT()
         { }

         /** Returns this accessor's type constant, i.e. GatewayActivityQFT
           *
           * @return This accessor's type constant, i.e. GatewayActivityQFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::gatewayActivityQFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const GatewayActivityQFT& accessor)
            throw(uci::base::UCIException) = 0;


         /** [Minimum occurrences: 0] [Maximum occurrences: 29] */
         typedef uci::base::BoundedList<uci::type::CommCapabilityEnum, uci::type::accessorType::commCapabilityEnum> CapabilityType;
         ...
         /** Returns the bounded list that is identified by the CapabilityType.
           ...
           */
         virtual const uci::type::GatewayActivityQFT::CapabilityType& getCapabilityType() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CapabilityType.
           ...
           * @return The bounded list identified by CapabilityType.
           */
         virtual uci::type::GatewayActivityQFT::CapabilityType& getCapabilityType()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the CapabilityType.
           ...
           *      accessor
           */
         virtual void setCapabilityType(const uci::type::GatewayActivityQFT::CapabilityType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the SubCapabilityType.
           ...
           */
         virtual const uci::type::GatewayActivityQFT::SubCapabilityType& getSubCapabilityType() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the SubCapabilityType.
           ...
           * @return The bounded list identified by SubCapabilityType.
           */
         virtual uci::type::GatewayActivityQFT::SubCapabilityType& getSubCapabilityType()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the SubCapabilityType.
           ...
           *      accessor
           */
         virtual void setSubCapabilityType(const uci::type::GatewayActivityQFT::SubCapabilityType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Source.
           ...
           */
         virtual const uci::type::GatewayActivityQFT::Source& getSource() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Source.
           ...
           * @return The bounded list identified by Source.
           */
         virtual uci::type::GatewayActivityQFT::Source& getSource()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Source.
           ...
           *      accessor
           */
         virtual void setSource(const uci::type::GatewayActivityQFT::Source& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The GatewayActivityQFT to copy from
           */
         GatewayActivityQFT(const GatewayActivityQFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this GatewayActivityQFT to the contents of the GatewayActivityQFT on
           * the right hand side (rhs) of the assignment operator.GatewayActivityQFT [only available to derived classes]
           *
           * @param rhs The GatewayActivityQFT on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::GatewayActivityQFT
           * @return A constant reference to this GatewayActivityQFT.
           */
         const GatewayActivityQFT& operator=(const GatewayActivityQFT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__GatewayActivityQFT_h
