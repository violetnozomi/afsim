...
*    Directive 5230.25.
*/
#ifndef Uci__Type__OpLineQFT_h
#define Uci__Type__OpLineQFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the OpLineQFT sequence accessor class */
      class OpLineQFT : public virtual uci::type::QueryFilterPET {
      public:
         ...
         /** Returns this accessor's type constant, i.e. OpLineQFT
           *
           * @return This accessor's type constant, i.e. OpLineQFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::opLineQFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const OpLineQFT& accessor)
         ...
         /** Filter on the OpLine ID [Minimum occurrences: 0] [Maximum occurrences: 9223372036854775807] */
         typedef uci::base::BoundedList<uci::type::OpLineID_Type, uci::type::accessorType::opLineID_Type> OpLineID;

         /** Filter on the category [Minimum occurrences: 0] [Maximum occurrences: 11] */
         ...
         /** Returns the bounded list that is identified by the SystemID.
           ...
           */
         virtual const uci::type::OpLineQFT::SystemID& getSystemID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the SystemID.
           ...
           * @return The bounded list identified by SystemID.
           */
         virtual uci::type::OpLineQFT::SystemID& getSystemID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the SystemID.
           ...
           *      accessor
           */
         virtual void setSystemID(const uci::type::OpLineQFT::SystemID& value)
            throw(uci::base::UCIException) = 0;


         /** Returns the bounded list that is identified by the OpLineID.
           *
           * @return The bounded list identified by OpLineID.
           */
         virtual const uci::type::OpLineQFT::OpLineID& getOpLineID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the OpLineID.
           ...
           * @return The bounded list identified by OpLineID.
           */
         virtual uci::type::OpLineQFT::OpLineID& getOpLineID()
            throw(uci::base::UCIException) = 0;


         /** Sets the bounded list that is identified by the OpLineID.
           *
           * @param value The bounded list whose contents are to be used to set the value of the bounded list accessed by this
           *      accessor
           */
         virtual void setOpLineID(const uci::type::OpLineQFT::OpLineID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Category.
           ...
           */
         virtual const uci::type::OpLineQFT::Category& getCategory() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Category.
           ...
           * @return The bounded list identified by Category.
           */
         virtual uci::type::OpLineQFT::Category& getCategory()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Category.
           ...
           *      accessor
           */
         virtual void setCategory(const uci::type::OpLineQFT::Category& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpLineQFT to copy from
           */
         OpLineQFT(const OpLineQFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpLineQFT to the contents of the OpLineQFT on the right hand side
           * (rhs) of the assignment operator.OpLineQFT [only available to derived classes]
           *
           * @param rhs The OpLineQFT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::OpLineQFT
           * @return A constant reference to this OpLineQFT.
           */
         const OpLineQFT& operator=(const OpLineQFT& rhs)
         {
            (void)rhs;
