...
*    Directive 5230.25.
*/
#ifndef Uci__Type__String512Type_h
#define Uci__Type__String512Type_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** [Minimum length: 0] [Maximum length: 512] */
      typedef xs::String String512Type;

   } // Namespace: type
} // Namespace: uci

#endif // Uci__Type__String512Type_h
