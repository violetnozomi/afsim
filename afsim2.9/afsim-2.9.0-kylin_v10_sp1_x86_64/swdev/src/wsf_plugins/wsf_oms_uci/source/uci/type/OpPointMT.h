...
*    Directive 5230.25.
*/
#ifndef Uci__Type__OpPointMT_h
#define Uci__Type__OpPointMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class OpPointMT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. OpPointMT
           *
           * @return This accessor's type constant, i.e. OpPointMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::opPointMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const OpPointMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::OpPointMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::OpPointMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::OpPointMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpPointMT to copy from
           */
         OpPointMT(const OpPointMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpPointMT to the contents of the OpPointMT on the right hand side
           * (rhs) of the assignment operator.OpPointMT [only available to derived classes]
           *
           * @param rhs The OpPointMT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::OpPointMT
           * @return A constant reference to this OpPointMT.
           */
         const OpPointMT& operator=(const OpPointMT& rhs)
         {
            (void)rhs;
