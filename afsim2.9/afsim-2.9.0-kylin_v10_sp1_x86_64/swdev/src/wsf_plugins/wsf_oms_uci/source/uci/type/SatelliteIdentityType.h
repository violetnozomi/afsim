...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SatelliteIdentityType_h
#define Uci__Type__SatelliteIdentityType_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SatelliteIdentityType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SatelliteIdentityType to the contents of the SatelliteIdentityType
           * on the right hand side (rhs) of the assignment operator.SatelliteIdentityType [only available to derived classes]
           *
           * @param rhs The SatelliteIdentityType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::SatelliteIdentityType
           * @return A constant reference to this SatelliteIdentityType.
           */
         const SatelliteIdentityType& operator=(const SatelliteIdentityType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SatelliteIdentityType_h
