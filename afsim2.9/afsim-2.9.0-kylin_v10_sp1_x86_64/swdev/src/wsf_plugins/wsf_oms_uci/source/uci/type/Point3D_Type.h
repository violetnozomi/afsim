...
*    Directive 5230.25.
*/
#ifndef Uci__Type__Point3D_Type_h
#define Uci__Type__Point3D_Type_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** Positional data relative to WGS-84 ellipsoid with latitude, longitude and altitude as mandatory entries. */
      class Point3D_Type : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~Point3D_Type()
         { }

         /** Returns this accessor's type constant, i.e. Point3D_Type
           *
           * @return This accessor's type constant, i.e. Point3D_Type
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::point3D_Type;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const Point3D_Type& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The Point3D_Type to copy from
           */
         Point3D_Type(const Point3D_Type& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this Point3D_Type to the contents of the Point3D_Type on the right hand
           * side (rhs) of the assignment operator.Point3D_Type [only available to derived classes]
           *
           * @param rhs The Point3D_Type on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::Point3D_Type
           * @return A constant reference to this Point3D_Type.
           */
         const Point3D_Type& operator=(const Point3D_Type& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__Point3D_Type_h
