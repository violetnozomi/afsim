...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__WeatherReader_h
#define Uci__Reader__WeatherReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The WeatherListener provides the support to listen and handle incoming messages of the type uci::type::Weather */
      class WeatherListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~WeatherListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::Weather& message)
      ...
      class WeatherReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(WeatherListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(WeatherListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, WeatherListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, WeatherListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The WeatherReader to copy from
           */
         WeatherReader(const WeatherReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this WeatherReader to the contents of the WeatherReader on the right
           * hand side (rhs) of the assignment operator.WeatherReader [only available to derived classes]
           *
           * @param rhs The WeatherReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this WeatherReader
           * @return A constant reference to this WeatherReader.
           */
         const WeatherReader& operator=(const WeatherReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__WeatherReader_h
