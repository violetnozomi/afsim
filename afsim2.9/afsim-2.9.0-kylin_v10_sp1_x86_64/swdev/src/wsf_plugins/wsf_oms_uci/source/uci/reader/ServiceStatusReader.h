...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__ServiceStatusReader_h
#define Uci__Reader__ServiceStatusReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The ServiceStatusListener provides the support to listen and handle incoming messages of the type
        * uci::type::ServiceStatus
        */
      class ServiceStatusListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::ServiceStatus& message)
      ...
      class ServiceStatusReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~ServiceStatusReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(ServiceStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(ServiceStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, ServiceStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, ServiceStatusListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ServiceStatusReader to copy from
           */
         ServiceStatusReader(const ServiceStatusReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ServiceStatusReader to the contents of the ServiceStatusReader on
           * the right hand side (rhs) of the assignment operator.ServiceStatusReader [only available to derived classes]
           *
           * @param rhs The ServiceStatusReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this ServiceStatusReader
           * @return A constant reference to this ServiceStatusReader.
           */
         const ServiceStatusReader& operator=(const ServiceStatusReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__ServiceStatusReader_h
