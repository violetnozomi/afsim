...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommUHF_SATCOM_CommWaveformCapabilityCommandType_h
#define Uci__Type__CommUHF_SATCOM_CommWaveformCapabilityCommandType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is a polymorphic extension which allows for the extension of the base CommWaveformCapabilityCommandPET for
        ...
        */
      class CommUHF_SATCOM_CommWaveformCapabilityCommandType : public virtual uci::type::CommWaveformCapabilityCommandPET {
      public:

         /** The destructor */
         virtual ~CommUHF_SATCOM_CommWaveformCapabilityCommandType()
         { }

         /** Returns this accessor's type constant, i.e. CommUHF_SATCOM_CommWaveformCapabilityCommandType
           *
           * @return This accessor's type constant, i.e. CommUHF_SATCOM_CommWaveformCapabilityCommandType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::commUHF_SATCOM_CommWaveformCapabilityCommandType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommUHF_SATCOM_CommWaveformCapabilityCommandType& accessor)
         ...
         /** Returns the bounded list that is identified by the GuardSlotID.
           ...
           */
         virtual const uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType::GuardSlotID& getGuardSlotID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the GuardSlotID.
           ...
           * @return The bounded list identified by GuardSlotID.
           */
         virtual uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType::GuardSlotID& getGuardSlotID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the GuardSlotID.
           ...
           *      accessor
           */
         virtual void setGuardSlotID(const uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType::GuardSlotID& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         CommUHF_SATCOM_CommWaveformCapabilityCommandType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CommUHF_SATCOM_CommWaveformCapabilityCommandType to copy from
           */
         CommUHF_SATCOM_CommWaveformCapabilityCommandType(const CommUHF_SATCOM_CommWaveformCapabilityCommandType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CommUHF_SATCOM_CommWaveformCapabilityCommandType to the contents
           * of the CommUHF_SATCOM_CommWaveformCapabilityCommandType on the right hand side (rhs) of the assignment
           * operator.CommUHF_SATCOM_CommWaveformCapabilityCommandType [only available to derived classes]
           *
           * @param rhs The CommUHF_SATCOM_CommWaveformCapabilityCommandType on the right hand side (rhs) of the assignment
           *      operator whose contents are used to set the contents of this
           *      uci::type::CommUHF_SATCOM_CommWaveformCapabilityCommandType
           * @return A constant reference to this CommUHF_SATCOM_CommWaveformCapabilityCommandType.
           */
         const CommUHF_SATCOM_CommWaveformCapabilityCommandType& operator=(const CommUHF_SATCOM_CommWaveformCapabilityCommandType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommUHF_SATCOM_CommWaveformCapabilityCommandType_h
