...
*    Directive 5230.25.
*/
#ifndef Uci__Type__GenerateOptionMetaTaskType_h
#define Uci__Type__GenerateOptionMetaTaskType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the GenerateOptionMetaTaskType sequence accessor class */
      class GenerateOptionMetaTaskType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~GenerateOptionMetaTaskType()
         { }

         /** Returns this accessor's type constant, i.e. GenerateOptionMetaTaskType
           *
           * @return This accessor's type constant, i.e. GenerateOptionMetaTaskType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::generateOptionMetaTaskType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const GenerateOptionMetaTaskType& accessor)
      ...
      protected:
         ...
         GenerateOptionMetaTaskType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The GenerateOptionMetaTaskType to copy from
           */
         GenerateOptionMetaTaskType(const GenerateOptionMetaTaskType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this GenerateOptionMetaTaskType to the contents of the
           * GenerateOptionMetaTaskType on the right hand side (rhs) of the assignment operator.GenerateOptionMetaTaskType [only
           * available to derived classes]
           *
           * @param rhs The GenerateOptionMetaTaskType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::GenerateOptionMetaTaskType
           * @return A constant reference to this GenerateOptionMetaTaskType.
           */
         const GenerateOptionMetaTaskType& operator=(const GenerateOptionMetaTaskType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__GenerateOptionMetaTaskType_h
