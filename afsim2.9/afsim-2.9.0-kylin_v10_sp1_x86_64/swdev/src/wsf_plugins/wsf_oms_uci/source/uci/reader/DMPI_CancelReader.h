...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__DMPI_CancelReader_h
#define Uci__Reader__DMPI_CancelReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The DMPI_CancelListener provides the support to listen and handle incoming messages of the type
        * uci::type::DMPI_Cancel
        */
      class DMPI_CancelListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~DMPI_CancelListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::DMPI_Cancel& message)
      ...
      class DMPI_CancelReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~DMPI_CancelReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(DMPI_CancelListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(DMPI_CancelListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, DMPI_CancelListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, DMPI_CancelListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DMPI_CancelReader to copy from
           */
         DMPI_CancelReader(const DMPI_CancelReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DMPI_CancelReader to the contents of the DMPI_CancelReader on the
           * right hand side (rhs) of the assignment operator.DMPI_CancelReader [only available to derived classes]
           *
           * @param rhs The DMPI_CancelReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this DMPI_CancelReader
           * @return A constant reference to this DMPI_CancelReader.
           */
         const DMPI_CancelReader& operator=(const DMPI_CancelReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__DMPI_CancelReader_h
