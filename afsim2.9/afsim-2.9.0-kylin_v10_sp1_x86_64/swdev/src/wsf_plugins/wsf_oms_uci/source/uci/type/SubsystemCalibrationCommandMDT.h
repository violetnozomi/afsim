...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SubsystemCalibrationCommandMDT_h
#define Uci__Type__SubsystemCalibrationCommandMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SubsystemCalibrationCommandMDT sequence accessor class */
      class SubsystemCalibrationCommandMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~SubsystemCalibrationCommandMDT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SubsystemCalibrationCommandMDT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the CommandType.
           ...
           */
         virtual const uci::type::SubsystemCalibrationCommandType& getCommandType() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the CommandType.
           ...
           * @return The acecssor that provides access to the complex content that is identified by CommandType.
           */
         virtual uci::type::SubsystemCalibrationCommandType& getCommandType()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the CommandType to the contents of the complex content that is
           ...
           */
         virtual void setCommandType(const uci::type::SubsystemCalibrationCommandType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SubsystemCalibrationCommandMDT to the contents of the
           * SubsystemCalibrationCommandMDT on the right hand side (rhs) of the assignment operator.SubsystemCalibrationCommandMDT
           * [only available to derived classes]
           *
           * @param rhs The SubsystemCalibrationCommandMDT on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::SubsystemCalibrationCommandMDT
           * @return A constant reference to this SubsystemCalibrationCommandMDT.
           */
         const SubsystemCalibrationCommandMDT& operator=(const SubsystemCalibrationCommandMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SubsystemCalibrationCommandMDT_h
