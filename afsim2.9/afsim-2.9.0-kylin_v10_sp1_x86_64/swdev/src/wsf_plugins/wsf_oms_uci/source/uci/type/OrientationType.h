...
*    Directive 5230.25.
*/
#ifndef Uci__Type__OrientationType_h
#define Uci__Type__OrientationType_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const OrientationType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this OrientationType to the contents of the OrientationType on the
           * right hand side (rhs) of the assignment operator.OrientationType [only available to derived classes]
           *
           * @param rhs The OrientationType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::OrientationType
           * @return A constant reference to this OrientationType.
           */
         const OrientationType& operator=(const OrientationType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__OrientationType_h
