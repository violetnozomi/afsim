...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommandRepetitionType_h
#define Uci__Type__CommandRepetitionType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class CommandRepetitionType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~CommandRepetitionType()
         { }

         /** Returns this accessor's type constant, i.e. CommandRepetitionType
           *
           * @return This accessor's type constant, i.e. CommandRepetitionType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::commandRepetitionType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommandRepetitionType& accessor)
            throw(uci::base::UCIException) = 0;


         /** The following enumeration is used to identify which element of this Choice has been chosen. */
         enum CommandRepetitionTypeChoice {
            COMMANDREPETITIONTYPE_CHOICE_NONE,
            COMMANDREPETITIONTYPE_CHOICE_PERIODIC,
            COMMANDREPETITIONTYPE_CHOICE_FINITE,
            COMMANDREPETITIONTYPE_CHOICE_POSITIONCHANGE,
            COMMANDREPETITIONTYPE_CHOICE_CONTINUOUS
         };
         ...
         /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           */
         virtual CommandRepetitionTypeChoice getCommandRepetitionTypeChoiceOrdinal() const
            throw(uci::base::UCIException) = 0;
         ...
         /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           * getCommandRepetitionTypeChoiceOrdinal() will be the ordinal specified when this method was invoked. In addition, the
           ...
           *      base type.
           */
         virtual void setCommandRepetitionTypeChoiceOrdinal(CommandRepetitionTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the PositionChange.
           ...
           */
         virtual const uci::type::RepetitionPositionChangeType& getPositionChange() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the PositionChange.
           ...
           * @return The acecssor that provides access to the complex content that is identified by PositionChange.
           */
         virtual uci::type::RepetitionPositionChangeType& getPositionChange()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the PositionChange to the contents of the complex content that is
           ...
           */
         virtual void setPositionChange(const uci::type::RepetitionPositionChangeType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CommandRepetitionType to copy from
           */
         CommandRepetitionType(const CommandRepetitionType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CommandRepetitionType to the contents of the CommandRepetitionType
           * on the right hand side (rhs) of the assignment operator.CommandRepetitionType [only available to derived classes]
           *
           * @param rhs The CommandRepetitionType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::CommandRepetitionType
           * @return A constant reference to this CommandRepetitionType.
           */
         const CommandRepetitionType& operator=(const CommandRepetitionType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommandRepetitionType_h
