...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CryptoTypeEnum_h
#define Uci__Type__CryptoTypeEnum_h 1
   ...
   namespace type {
      ...
      public:
         ...
         enum EnumerationItem {
            ...
            enumNotSet,
            //  UCI_AES's ordinal value */
            UCI_AES,

            //  UCI_ANDVT's ordinal value */
            UCI_ANDVT,

            //  UCI_FASCINATOR's ordinal value */
            UCI_FASCINATOR,

            //  UCI_HAIPE's ordinal value */
            UCI_HAIPE,

            //  UCI_KG_84's ordinal value */
            UCI_KG_84,

            //  UCI_KG_84_M1's ordinal value */
            UCI_KG_84_M1,

            //  UCI_KG_84_M2's ordinal value */
            UCI_KG_84_M2,

            //  UCI_KG_84_M3's ordinal value */
            UCI_KG_84_M3,

            //  UCI_KG_84_M4's ordinal value */
            UCI_KG_84_M4,

            //  UCI_KG_254's ordinal value */
            UCI_KG_254,

            //  UCI_KYV_5's ordinal value */
            UCI_KYV_5,

            //  UCI_MELP's ordinal value */
            UCI_MELP,

            //  UCI_VINSON's ordinal value */
            UCI_VINSON,
         ...
         /** The assignment operator. Sets the contents of this CryptoTypeEnum to the contents of the CryptoTypeEnum on the right
           * hand side (rhs) of the assignment operator.CryptoTypeEnum
           *
           ...
           * @return A constant reference to this CryptoTypeEnum.
           */
         const CryptoTypeEnum& operator=(const CryptoTypeEnum& rhs)
         {
         ...
         /** The assignment operator. Sets the value of this CryptoTypeEnum enumeration to the EnumerationItem on the right hand
           * side of the assignment operator.
           *
           * @param rhs The EnumerationItemwhose value is to be assigned to this CryptoTypeEnum enumeration
           * @return A reference to this CryptoTypeEnum enumeration
           */
         const CryptoTypeEnum& operator=(EnumerationItem rhs)
         {
            setValue(rhs);
            return *this;
         }
         ...
         /** Sets the value of this CryptoTypeEnum enumeration to the value of the specified enumeration item.
           *
           * @param item The EnumerationItemwhose value is to be used to set the value of this CryptoTypeEnum enumeration
           */
         ...
         /** Tests whether the value of this CryptoTypeEnum enumeration is equal to the value of the specified EnumerationItem.
           ...
           * @return True if the value of the EnumerationItem(rhs) is equal to the value of this CryptoTypeEnum enumeration, false
           *      otherwise
           */
         ...
         /** Tests whether the value of the specified EnumerationItem is less than the value of the specified CryptoTypeEnum
           ...
           * @param rhs The CryptoTypeEnum enumeration whose value is to be compared against the value of the specified
           *      EnumerationItem
           * @return True if the value of the EnumerationItem(lhs) is less than the value of the CryptoTypeEnum enumeration (rhs),
           *      false otherwise
           */
         friend bool operator<(EnumerationItem lhs, const CryptoTypeEnum& rhs)
         {
...
#endif // Uci__Type__CryptoTypeEnum_h
