...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SAR_CapabilityStatusMDT_h
#define Uci__Type__SAR_CapabilityStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SAR_CapabilityStatusMDT sequence accessor class */
      class SAR_CapabilityStatusMDT : public virtual uci::type::CapabilityStatusBaseType {
      public:

         /** The destructor */
         virtual ~SAR_CapabilityStatusMDT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SAR_CapabilityStatusMDT& accessor)
         ...
         /** Returns the bounded list that is identified by the CapabilityStatus.
           ...
           */
         virtual const uci::type::SAR_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CapabilityStatus.
           ...
           * @return The bounded list identified by CapabilityStatus.
           */
         virtual uci::type::SAR_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the CapabilityStatus.
           ...
           *      accessor
           */
         virtual void setCapabilityStatus(const uci::type::SAR_CapabilityStatusMDT::CapabilityStatus& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the RF_Profile.
           ...
           */
         virtual const uci::type::SAR_CapabilityStatusMDT::RF_Profile& getRF_Profile() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the RF_Profile.
           ...
           * @return The bounded list identified by RF_Profile.
           */
         virtual uci::type::SAR_CapabilityStatusMDT::RF_Profile& getRF_Profile()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the RF_Profile.
           ...
           *      accessor
           */
         virtual void setRF_Profile(const uci::type::SAR_CapabilityStatusMDT::RF_Profile& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CurrentMessageOutput.
           ...
           */
         virtual const uci::type::SAR_CapabilityStatusMDT::CurrentMessageOutput& getCurrentMessageOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CurrentMessageOutput.
           ...
           * @return The bounded list identified by CurrentMessageOutput.
           */
         virtual uci::type::SAR_CapabilityStatusMDT::CurrentMessageOutput& getCurrentMessageOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the CurrentMessageOutput.
           ...
           *      accessor
           */
         virtual void setCurrentMessageOutput(const uci::type::SAR_CapabilityStatusMDT::CurrentMessageOutput& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ElectronicProtectionOptionsEnabled.
           ...
           */
         virtual const uci::type::SAR_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& getElectronicProtectionOptionsEnabled() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ElectronicProtectionOptionsEnabled.
           ...
           * @return The bounded list identified by ElectronicProtectionOptionsEnabled.
           */
         virtual uci::type::SAR_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& getElectronicProtectionOptionsEnabled()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ElectronicProtectionOptionsEnabled.
           ...
           *      accessor
           */
         virtual void setElectronicProtectionOptionsEnabled(const uci::type::SAR_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SAR_CapabilityStatusMDT to the contents of the
           * SAR_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator.SAR_CapabilityStatusMDT [only
           * available to derived classes]
           *
           * @param rhs The SAR_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::SAR_CapabilityStatusMDT
           * @return A constant reference to this SAR_CapabilityStatusMDT.
           */
         const SAR_CapabilityStatusMDT& operator=(const SAR_CapabilityStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SAR_CapabilityStatusMDT_h
