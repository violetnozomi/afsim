...
*    Directive 5230.25.
*/
#ifndef Uci__Type__MissionPlanReferenceType_h
#define Uci__Type__MissionPlanReferenceType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the MissionPlanReferenceType sequence accessor class */
      class MissionPlanReferenceType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~MissionPlanReferenceType()
         { }

         /** Returns this accessor's type constant, i.e. MissionPlanReferenceType
           *
           * @return This accessor's type constant, i.e. MissionPlanReferenceType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::missionPlanReferenceType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const MissionPlanReferenceType& accessor)
      ...
      protected:
         ...
         MissionPlanReferenceType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The MissionPlanReferenceType to copy from
           */
         MissionPlanReferenceType(const MissionPlanReferenceType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this MissionPlanReferenceType to the contents of the
           * MissionPlanReferenceType on the right hand side (rhs) of the assignment operator.MissionPlanReferenceType [only
           * available to derived classes]
           *
           * @param rhs The MissionPlanReferenceType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::MissionPlanReferenceType
           * @return A constant reference to this MissionPlanReferenceType.
           */
         const MissionPlanReferenceType& operator=(const MissionPlanReferenceType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__MissionPlanReferenceType_h
