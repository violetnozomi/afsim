...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ConflictedRouteSegmentType_h
#define Uci__Type__ConflictedRouteSegmentType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ConflictedRouteSegmentType sequence accessor class */
      class ConflictedRouteSegmentType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ConflictedRouteSegmentType()
         { }

         /** Returns this accessor's type constant, i.e. ConflictedRouteSegmentType
           *
           * @return This accessor's type constant, i.e. ConflictedRouteSegmentType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::conflictedRouteSegmentType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ConflictedRouteSegmentType& accessor)
      ...
      protected:
         ...
         ConflictedRouteSegmentType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ConflictedRouteSegmentType to copy from
           */
         ConflictedRouteSegmentType(const ConflictedRouteSegmentType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ConflictedRouteSegmentType to the contents of the
           * ConflictedRouteSegmentType on the right hand side (rhs) of the assignment operator.ConflictedRouteSegmentType [only
           * available to derived classes]
           *
           * @param rhs The ConflictedRouteSegmentType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::ConflictedRouteSegmentType
           * @return A constant reference to this ConflictedRouteSegmentType.
           */
         const ConflictedRouteSegmentType& operator=(const ConflictedRouteSegmentType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ConflictedRouteSegmentType_h
