...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ControllerType_h
#define Uci__Type__ControllerType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ControllerType sequence accessor class */
      class ControllerType : public virtual uci::base::Accessor {
      public:
         ...
         /** Returns this accessor's type constant, i.e. ControllerType
           *
           * @return This accessor's type constant, i.e. ControllerType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::controllerType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ControllerType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ControllerType to copy from
           */
         ControllerType(const ControllerType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ControllerType to the contents of the ControllerType on the right
           * hand side (rhs) of the assignment operator.ControllerType [only available to derived classes]
           *
           * @param rhs The ControllerType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::ControllerType
           * @return A constant reference to this ControllerType.
           */
         const ControllerType& operator=(const ControllerType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ControllerType_h
