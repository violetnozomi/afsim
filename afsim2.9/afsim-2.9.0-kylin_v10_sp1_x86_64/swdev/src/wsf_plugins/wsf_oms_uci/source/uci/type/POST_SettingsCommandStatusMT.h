...
*    Directive 5230.25.
*/
#ifndef Uci__Type__POST_SettingsCommandStatusMT_h
#define Uci__Type__POST_SettingsCommandStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the POST_SettingsCommandStatusMT sequence accessor class */
      class POST_SettingsCommandStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~POST_SettingsCommandStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. POST_SettingsCommandStatusMT
           *
           * @return This accessor's type constant, i.e. POST_SettingsCommandStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pOST_SettingsCommandStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const POST_SettingsCommandStatusMT& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The POST_SettingsCommandStatusMT to copy from
           */
         POST_SettingsCommandStatusMT(const POST_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this POST_SettingsCommandStatusMT to the contents of the
           * POST_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator.POST_SettingsCommandStatusMT
           * [only available to derived classes]
           *
           * @param rhs The POST_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::POST_SettingsCommandStatusMT
           * @return A constant reference to this POST_SettingsCommandStatusMT.
           */
         const POST_SettingsCommandStatusMT& operator=(const POST_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__POST_SettingsCommandStatusMT_h
