...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductDownloadStatusType_h
#define Uci__Type__ProductDownloadStatusType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductDownloadStatusType sequence accessor class */
      class ProductDownloadStatusType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ProductDownloadStatusType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductDownloadStatusType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the InputProduct.
           ...
           */
         virtual const uci::type::ProductReferenceType& getInputProduct() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the InputProduct.
           ...
           * @return The acecssor that provides access to the complex content that is identified by InputProduct.
           */
         virtual uci::type::ProductReferenceType& getInputProduct()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the InputProduct to the contents of the complex content that is
           ...
           */
         virtual void setInputProduct(const uci::type::ProductReferenceType& value)
            throw(uci::base::UCIException) = 0;


         /** Returns the value of the enumeration that is identified by the ProductDownloadState.
           *
           * @return The value of the enumeration identified by ProductDownloadState.
           */
         virtual const uci::type::ProcessingStatusEnum& getProductDownloadState() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the ProductDownloadState.
           ...
           * @return The value of the enumeration identified by ProductDownloadState.
           */
         virtual uci::type::ProcessingStatusEnum& getProductDownloadState()
            throw(uci::base::UCIException) = 0;


         /** Sets the value of the enumeration that is identified by the ProductDownloadState.
           *
           * @param value The value to set the enumeration to
           */
         virtual void setProductDownloadState(const uci::type::ProcessingStatusEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the ProductDownloadState.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setProductDownloadState(uci::type::ProcessingStatusEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ProductDownloadStatusType to the contents of the
           * ProductDownloadStatusType on the right hand side (rhs) of the assignment operator.ProductDownloadStatusType [only
           * available to derived classes]
           *
           * @param rhs The ProductDownloadStatusType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::ProductDownloadStatusType
           * @return A constant reference to this ProductDownloadStatusType.
           */
         const ProductDownloadStatusType& operator=(const ProductDownloadStatusType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductDownloadStatusType_h
