...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__ESM_ActivityReader_h
#define Uci__Reader__ESM_ActivityReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The ESM_ActivityListener provides the support to listen and handle incoming messages of the type
        * uci::type::ESM_Activity
        */
      class ESM_ActivityListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~ESM_ActivityListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::ESM_Activity& message)
            throw(uci::base::UCIException) = 0;


      }; // ESM_ActivityListener


      /** The Reader provides the support to reader incoming messages. */
      class ESM_ActivityReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~ESM_ActivityReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(ESM_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(ESM_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, ESM_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, ESM_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ESM_ActivityReader to copy from
           */
         ESM_ActivityReader(const ESM_ActivityReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ESM_ActivityReader to the contents of the ESM_ActivityReader on
           * the right hand side (rhs) of the assignment operator.ESM_ActivityReader [only available to derived classes]
           *
           * @param rhs The ESM_ActivityReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this ESM_ActivityReader
           * @return A constant reference to this ESM_ActivityReader.
           */
         const ESM_ActivityReader& operator=(const ESM_ActivityReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__ESM_ActivityReader_h
