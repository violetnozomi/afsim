...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_ComponentStatusFocalPlaneArrayChannelType_h
#define Uci__Type__PO_ComponentStatusFocalPlaneArrayChannelType_h 1
...
#if !defined(Uci__Type__PO_ComponentStatusFocalPlaneArrayOpticalBandType_h)
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_ComponentStatusFocalPlaneArrayChannelType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_ComponentStatusFocalPlaneArrayChannelType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the OpticalBand.
           ...
           */
         virtual const uci::type::PO_ComponentStatusFocalPlaneArrayOpticalBandType& getOpticalBand() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the OpticalBand.
           ...
           * @return The acecssor that provides access to the complex content that is identified by OpticalBand.
           */
         virtual uci::type::PO_ComponentStatusFocalPlaneArrayOpticalBandType& getOpticalBand()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the OpticalBand to the contents of the complex content that is
           ...
           */
         virtual void setOpticalBand(const uci::type::PO_ComponentStatusFocalPlaneArrayOpticalBandType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this PO_ComponentStatusFocalPlaneArrayChannelType to the contents of
           * the PO_ComponentStatusFocalPlaneArrayChannelType on the right hand side (rhs) of the assignment
           * operator.PO_ComponentStatusFocalPlaneArrayChannelType [only available to derived classes]
           *
           * @param rhs The PO_ComponentStatusFocalPlaneArrayChannelType on the right hand side (rhs) of the assignment operator
           *      whose contents are used to set the contents of this uci::type::PO_ComponentStatusFocalPlaneArrayChannelType
           * @return A constant reference to this PO_ComponentStatusFocalPlaneArrayChannelType.
           */
         const PO_ComponentStatusFocalPlaneArrayChannelType& operator=(const PO_ComponentStatusFocalPlaneArrayChannelType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_ComponentStatusFocalPlaneArrayChannelType_h
