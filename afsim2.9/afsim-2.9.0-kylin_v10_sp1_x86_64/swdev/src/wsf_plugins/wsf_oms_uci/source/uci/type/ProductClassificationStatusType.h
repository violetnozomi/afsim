...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductClassificationStatusType_h
#define Uci__Type__ProductClassificationStatusType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductClassificationStatusType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductClassificationStatusType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Returns the accessor that provides access to the complex content that is identified by the InputProduct.
           *
           * @return The acecssor that provides access to the complex content that is identified by InputProduct.
           */
         virtual const uci::type::InputProductType& getInputProduct() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the InputProduct.
           ...
           * @return The acecssor that provides access to the complex content that is identified by InputProduct.
           */
         virtual uci::type::InputProductType& getInputProduct()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the InputProduct to the contents of the complex content that is
           * accessed by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by InputProduct
           */
         virtual void setInputProduct(const uci::type::InputProductType& value)
            throw(uci::base::UCIException) = 0;


         /** Returns the value of the enumeration that is identified by the ProductClassificationState.
           *
           * @return The value of the enumeration identified by ProductClassificationState.
           */
         virtual const uci::type::ProcessingStatusEnum& getProductClassificationState() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the ProductClassificationState.
           ...
           * @return The value of the enumeration identified by ProductClassificationState.
           */
         virtual uci::type::ProcessingStatusEnum& getProductClassificationState()
            throw(uci::base::UCIException) = 0;


         /** Sets the value of the enumeration that is identified by the ProductClassificationState.
           *
           * @param value The value to set the enumeration to
           */
         virtual void setProductClassificationState(const uci::type::ProcessingStatusEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the ProductClassificationState.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setProductClassificationState(uci::type::ProcessingStatusEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ProductClassificationStatusType to the contents of the
           * ProductClassificationStatusType on the right hand side (rhs) of the assignment
           * operator.ProductClassificationStatusType [only available to derived classes]
           *
           * @param rhs The ProductClassificationStatusType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::ProductClassificationStatusType
           * @return A constant reference to this ProductClassificationStatusType.
           */
         const ProductClassificationStatusType& operator=(const ProductClassificationStatusType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductClassificationStatusType_h
