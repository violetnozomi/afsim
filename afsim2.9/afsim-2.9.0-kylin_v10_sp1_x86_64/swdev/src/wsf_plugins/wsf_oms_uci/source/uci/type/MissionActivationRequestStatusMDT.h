...
*    Directive 5230.25.
*/
#ifndef Uci__Type__MissionActivationRequestStatusMDT_h
#define Uci__Type__MissionActivationRequestStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the MissionActivationRequestStatusMDT sequence accessor class */
      class MissionActivationRequestStatusMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~MissionActivationRequestStatusMDT()
         { }

         /** Returns this accessor's type constant, i.e. MissionActivationRequestStatusMDT
           *
           * @return This accessor's type constant, i.e. MissionActivationRequestStatusMDT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::missionActivationRequestStatusMDT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const MissionActivationRequestStatusMDT& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The MissionActivationRequestStatusMDT to copy from
           */
         MissionActivationRequestStatusMDT(const MissionActivationRequestStatusMDT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this MissionActivationRequestStatusMDT to the contents of the
           * MissionActivationRequestStatusMDT on the right hand side (rhs) of the assignment
           * operator.MissionActivationRequestStatusMDT [only available to derived classes]
           *
           * @param rhs The MissionActivationRequestStatusMDT on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::MissionActivationRequestStatusMDT
           * @return A constant reference to this MissionActivationRequestStatusMDT.
           */
         const MissionActivationRequestStatusMDT& operator=(const MissionActivationRequestStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__MissionActivationRequestStatusMDT_h
