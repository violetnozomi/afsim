...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ESM_AcquisitionTargetType_h
#define Uci__Type__ESM_AcquisitionTargetType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ESM_AcquisitionTargetType choice accessor class */
      class ESM_AcquisitionTargetType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ESM_AcquisitionTargetType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ESM_AcquisitionTargetType& accessor)
         ...
         /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           */
         virtual ESM_AcquisitionTargetTypeChoice getESM_AcquisitionTargetTypeChoiceOrdinal() const
            throw(uci::base::UCIException) = 0;
         ...
         /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           *      base type.
           */
         virtual void setESM_AcquisitionTargetTypeChoiceOrdinal(ESM_AcquisitionTargetTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ESM_AcquisitionTargetType to the contents of the
           * ESM_AcquisitionTargetType on the right hand side (rhs) of the assignment operator.ESM_AcquisitionTargetType [only
           * available to derived classes]
           *
           * @param rhs The ESM_AcquisitionTargetType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::ESM_AcquisitionTargetType
           * @return A constant reference to this ESM_AcquisitionTargetType.
           */
         const ESM_AcquisitionTargetType& operator=(const ESM_AcquisitionTargetType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ESM_AcquisitionTargetType_h
