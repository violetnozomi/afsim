...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CapabilityMetadataType_h
#define Uci__Type__CapabilityMetadataType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the CapabilityMetadataType sequence accessor class */
      class CapabilityMetadataType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~CapabilityMetadataType()
         { }

         /** Returns this accessor's type constant, i.e. CapabilityMetadataType
           *
           * @return This accessor's type constant, i.e. CapabilityMetadataType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::capabilityMetadataType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CapabilityMetadataType& accessor)
         ...
         /** Returns whether the Element that is identified by CapabilityCommandID exists (is enabled) or not.
           *
           * @return A boolean indicating whether the Element identified by CapabilityCommandID is emabled or not
           */
         virtual bool hasCapabilityCommandID() const
            throw(uci::base::UCIException) = 0;


         /** Enables the Element that is identified by CapabilityCommandID
           *
           * @param type = uci::type::accessorType::capabilityCommandID_Type This Accessor's accessor type
           */
         virtual void enableCapabilityCommandID(uci::base::accessorType::AccessorType type = uci::type::accessorType::capabilityCommandID_Type)
            throw(uci::base::UCIException) = 0;


         /** Clears (disabled) the Element that is identified by CapabilityCommandID */
         virtual void clearCapabilityCommandID()
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         CapabilityMetadataType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CapabilityMetadataType to copy from
           */
         CapabilityMetadataType(const CapabilityMetadataType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CapabilityMetadataType to the contents of the
           * CapabilityMetadataType on the right hand side (rhs) of the assignment operator.CapabilityMetadataType [only available
           * to derived classes]
           *
           * @param rhs The CapabilityMetadataType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::CapabilityMetadataType
           * @return A constant reference to this CapabilityMetadataType.
           */
         const CapabilityMetadataType& operator=(const CapabilityMetadataType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CapabilityMetadataType_h
