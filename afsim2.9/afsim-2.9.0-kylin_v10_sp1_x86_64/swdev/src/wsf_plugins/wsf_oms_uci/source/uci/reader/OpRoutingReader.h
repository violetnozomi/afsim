...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__OpRoutingReader_h
#define Uci__Reader__OpRoutingReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The OpRoutingListener provides the support to listen and handle incoming messages of the type uci::type::OpRouting */
      class OpRoutingListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~OpRoutingListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::OpRouting& message)
      ...
      class OpRoutingReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~OpRoutingReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(OpRoutingListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(OpRoutingListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, OpRoutingListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, OpRoutingListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpRoutingReader to copy from
           */
         OpRoutingReader(const OpRoutingReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpRoutingReader to the contents of the OpRoutingReader on the
           * right hand side (rhs) of the assignment operator.OpRoutingReader [only available to derived classes]
           *
           * @param rhs The OpRoutingReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this OpRoutingReader
           * @return A constant reference to this OpRoutingReader.
           */
         const OpRoutingReader& operator=(const OpRoutingReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__OpRoutingReader_h
