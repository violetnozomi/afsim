...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommRequirementMissionPlanReferenceType_h
#define Uci__Type__CommRequirementMissionPlanReferenceType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the CommRequirementMissionPlanReferenceType sequence accessor class */
      class CommRequirementMissionPlanReferenceType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~CommRequirementMissionPlanReferenceType()
         { }

         /** Returns this accessor's type constant, i.e. CommRequirementMissionPlanReferenceType
           *
           * @return This accessor's type constant, i.e. CommRequirementMissionPlanReferenceType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::commRequirementMissionPlanReferenceType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommRequirementMissionPlanReferenceType& accessor)
      ...
      protected:
         ...
         CommRequirementMissionPlanReferenceType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CommRequirementMissionPlanReferenceType to copy from
           */
         CommRequirementMissionPlanReferenceType(const CommRequirementMissionPlanReferenceType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CommRequirementMissionPlanReferenceType to the contents of the
           * CommRequirementMissionPlanReferenceType on the right hand side (rhs) of the assignment
           * operator.CommRequirementMissionPlanReferenceType [only available to derived classes]
           *
           * @param rhs The CommRequirementMissionPlanReferenceType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::CommRequirementMissionPlanReferenceType
           * @return A constant reference to this CommRequirementMissionPlanReferenceType.
           */
         const CommRequirementMissionPlanReferenceType& operator=(const CommRequirementMissionPlanReferenceType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommRequirementMissionPlanReferenceType_h
