...
*    Directive 5230.25.
*/
#ifndef Uci__Type__EmitterEntryType_h
#define Uci__Type__EmitterEntryType_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const EmitterEntryType& accessor)
         ...
         /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           */
         virtual EmitterEntryTypeChoice getEmitterEntryTypeChoiceOrdinal() const
            throw(uci::base::UCIException) = 0;
         ...
         /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           *      base type.
           */
         virtual void setEmitterEntryTypeChoiceOrdinal(EmitterEntryTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MDF_Entry.
           *
           * @return The acecssor that provides access to the complex content that is identified by MDF_Entry.
           */
         virtual const uci::type::ForeignKeyType& getMDF_Entry() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MDF_Entry.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MDF_Entry.
           */
         virtual uci::type::ForeignKeyType& getMDF_Entry()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the MDF_Entry to the contents of the complex content that is accessed
           * by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by MDF_Entry
           */
         virtual void setMDF_Entry(const uci::type::ForeignKeyType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this EmitterEntryType to the contents of the EmitterEntryType on the
           * right hand side (rhs) of the assignment operator.EmitterEntryType [only available to derived classes]
           *
           * @param rhs The EmitterEntryType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::EmitterEntryType
           * @return A constant reference to this EmitterEntryType.
           */
         const EmitterEntryType& operator=(const EmitterEntryType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__EmitterEntryType_h
