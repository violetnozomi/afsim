...
*    Directive 5230.25.
*/
#ifndef Uci__Type__EntityManagementDownType_h
#define Uci__Type__EntityManagementDownType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the EntityManagementDownType sequence accessor class */
      class EntityManagementDownType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~EntityManagementDownType()
         { }

         /** Returns this accessor's type constant, i.e. EntityManagementDownType
           *
           * @return This accessor's type constant, i.e. EntityManagementDownType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::entityManagementDownType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const EntityManagementDownType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The EntityManagementDownType to copy from
           */
         EntityManagementDownType(const EntityManagementDownType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this EntityManagementDownType to the contents of the
           * EntityManagementDownType on the right hand side (rhs) of the assignment operator.EntityManagementDownType [only
           * available to derived classes]
           *
           * @param rhs The EntityManagementDownType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::EntityManagementDownType
           * @return A constant reference to this EntityManagementDownType.
           */
         const EntityManagementDownType& operator=(const EntityManagementDownType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__EntityManagementDownType_h
