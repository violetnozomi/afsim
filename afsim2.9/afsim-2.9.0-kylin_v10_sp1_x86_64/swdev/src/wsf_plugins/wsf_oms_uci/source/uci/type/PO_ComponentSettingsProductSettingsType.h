...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_ComponentSettingsProductSettingsType_h
#define Uci__Type__PO_ComponentSettingsProductSettingsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_ComponentSettingsProductSettingsType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_ComponentSettingsProductSettingsType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this PO_ComponentSettingsProductSettingsType to the contents of the
           * PO_ComponentSettingsProductSettingsType on the right hand side (rhs) of the assignment
           * operator.PO_ComponentSettingsProductSettingsType [only available to derived classes]
           *
           * @param rhs The PO_ComponentSettingsProductSettingsType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::PO_ComponentSettingsProductSettingsType
           * @return A constant reference to this PO_ComponentSettingsProductSettingsType.
           */
         const PO_ComponentSettingsProductSettingsType& operator=(const PO_ComponentSettingsProductSettingsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_ComponentSettingsProductSettingsType_h
