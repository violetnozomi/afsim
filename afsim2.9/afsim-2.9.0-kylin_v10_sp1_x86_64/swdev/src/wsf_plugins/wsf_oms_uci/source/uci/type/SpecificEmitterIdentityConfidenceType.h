...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SpecificEmitterIdentityConfidenceType_h
#define Uci__Type__SpecificEmitterIdentityConfidenceType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SpecificEmitterIdentityConfidenceType sequence accessor class */
      class SpecificEmitterIdentityConfidenceType : public virtual uci::type::SpecificEmitterIdentityType {
      public:

         /** The destructor */
         virtual ~SpecificEmitterIdentityConfidenceType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SpecificEmitterIdentityConfidenceType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SpecificEmitterIdentityConfidenceType to the contents of the
           * SpecificEmitterIdentityConfidenceType on the right hand side (rhs) of the assignment
           * operator.SpecificEmitterIdentityConfidenceType [only available to derived classes]
           *
           * @param rhs The SpecificEmitterIdentityConfidenceType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::SpecificEmitterIdentityConfidenceType
           * @return A constant reference to this SpecificEmitterIdentityConfidenceType.
           */
         const SpecificEmitterIdentityConfidenceType& operator=(const SpecificEmitterIdentityConfidenceType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SpecificEmitterIdentityConfidenceType_h
