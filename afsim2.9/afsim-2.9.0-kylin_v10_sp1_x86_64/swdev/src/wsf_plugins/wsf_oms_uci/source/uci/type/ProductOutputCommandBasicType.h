...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductOutputCommandBasicType_h
#define Uci__Type__ProductOutputCommandBasicType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductOutputCommandBasicType sequence accessor class */
      class ProductOutputCommandBasicType : public virtual uci::type::ProductOutputType {
      public:

         /** The destructor */
         virtual ~ProductOutputCommandBasicType()
         { }

         /** Returns this accessor's type constant, i.e. ProductOutputCommandBasicType
           *
           * @return This accessor's type constant, i.e. ProductOutputCommandBasicType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::productOutputCommandBasicType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductOutputCommandBasicType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ProductOutputCommandBasicType to copy from
           */
         ProductOutputCommandBasicType(const ProductOutputCommandBasicType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ProductOutputCommandBasicType to the contents of the
           * ProductOutputCommandBasicType on the right hand side (rhs) of the assignment operator.ProductOutputCommandBasicType
           * [only available to derived classes]
           *
           * @param rhs The ProductOutputCommandBasicType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::ProductOutputCommandBasicType
           * @return A constant reference to this ProductOutputCommandBasicType.
           */
         const ProductOutputCommandBasicType& operator=(const ProductOutputCommandBasicType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductOutputCommandBasicType_h
