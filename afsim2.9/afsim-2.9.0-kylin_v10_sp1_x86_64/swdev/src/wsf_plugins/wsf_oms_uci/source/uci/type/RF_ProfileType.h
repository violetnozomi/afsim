...
*    Directive 5230.25.
*/
#ifndef Uci__Type__RF_ProfileType_h
#define Uci__Type__RF_ProfileType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the RF_ProfileType sequence accessor class */
      class RF_ProfileType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~RF_ProfileType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const RF_ProfileType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this RF_ProfileType to the contents of the RF_ProfileType on the right
           * hand side (rhs) of the assignment operator.RF_ProfileType [only available to derived classes]
           *
           * @param rhs The RF_ProfileType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::RF_ProfileType
           * @return A constant reference to this RF_ProfileType.
           */
         const RF_ProfileType& operator=(const RF_ProfileType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__RF_ProfileType_h
