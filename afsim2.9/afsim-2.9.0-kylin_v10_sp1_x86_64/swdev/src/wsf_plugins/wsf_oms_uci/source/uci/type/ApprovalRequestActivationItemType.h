...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ApprovalRequestActivationItemType_h
#define Uci__Type__ApprovalRequestActivationItemType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ApprovalRequestActivationItemType sequence accessor class */
      class ApprovalRequestActivationItemType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ApprovalRequestActivationItemType()
         { }

         /** Returns this accessor's type constant, i.e. ApprovalRequestActivationItemType
           *
           * @return This accessor's type constant, i.e. ApprovalRequestActivationItemType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::approvalRequestActivationItemType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ApprovalRequestActivationItemType& accessor)
      ...
      protected:
         ...
         ApprovalRequestActivationItemType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ApprovalRequestActivationItemType to copy from
           */
         ApprovalRequestActivationItemType(const ApprovalRequestActivationItemType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ApprovalRequestActivationItemType to the contents of the
           * ApprovalRequestActivationItemType on the right hand side (rhs) of the assignment
           * operator.ApprovalRequestActivationItemType [only available to derived classes]
           *
           * @param rhs The ApprovalRequestActivationItemType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::ApprovalRequestActivationItemType
           * @return A constant reference to this ApprovalRequestActivationItemType.
           */
         const ApprovalRequestActivationItemType& operator=(const ApprovalRequestActivationItemType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ApprovalRequestActivationItemType_h
