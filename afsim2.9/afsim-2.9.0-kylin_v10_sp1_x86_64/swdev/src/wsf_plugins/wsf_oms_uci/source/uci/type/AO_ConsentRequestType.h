...
*    Directive 5230.25.
*/
#ifndef Uci__Type__AO_ConsentRequestType_h
#define Uci__Type__AO_ConsentRequestType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the AO_ConsentRequestType sequence accessor class */
      class AO_ConsentRequestType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~AO_ConsentRequestType()
         { }

         /** Returns this accessor's type constant, i.e. AO_ConsentRequestType
           *
           * @return This accessor's type constant, i.e. AO_ConsentRequestType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::aO_ConsentRequestType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const AO_ConsentRequestType& accessor)
      ...
      protected:
         ...
         AO_ConsentRequestType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The AO_ConsentRequestType to copy from
           */
         AO_ConsentRequestType(const AO_ConsentRequestType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this AO_ConsentRequestType to the contents of the AO_ConsentRequestType
           * on the right hand side (rhs) of the assignment operator.AO_ConsentRequestType [only available to derived classes]
           *
           * @param rhs The AO_ConsentRequestType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::AO_ConsentRequestType
           * @return A constant reference to this AO_ConsentRequestType.
           */
         const AO_ConsentRequestType& operator=(const AO_ConsentRequestType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__AO_ConsentRequestType_h
