...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommUHF_SATCOM_CommWaveformActivityCommandType_h
#define Uci__Type__CommUHF_SATCOM_CommWaveformActivityCommandType_h 1

#if !defined(Uci__Type__CommWaveformActivityCommandPET_h)
# include "uci/type/CommWaveformActivityCommandPET.h"
#endif

#if !defined(Uci__Type__CommRangeDelayChoiceType_h)
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is a polymorphic extension which allows for the extension of the base CommWaveformActivityCommandPET for
        * communication UHF SATCOM parameters.
        */
      class CommUHF_SATCOM_CommWaveformActivityCommandType : public virtual uci::type::CommWaveformActivityCommandPET {
      public:

         /** The destructor */
         virtual ~CommUHF_SATCOM_CommWaveformActivityCommandType()
         { }

         /** Returns this accessor's type constant, i.e. CommUHF_SATCOM_CommWaveformActivityCommandType
           *
           * @return This accessor's type constant, i.e. CommUHF_SATCOM_CommWaveformActivityCommandType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::commUHF_SATCOM_CommWaveformActivityCommandType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommUHF_SATCOM_CommWaveformActivityCommandType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the RangeDelay.
           *
           * @return The acecssor that provides access to the complex content that is identified by RangeDelay.
           */
         virtual const uci::type::CommRangeDelayChoiceType& getRangeDelay() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the RangeDelay.
           ...
           * @return The acecssor that provides access to the complex content that is identified by RangeDelay.
           */
         virtual uci::type::CommRangeDelayChoiceType& getRangeDelay()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the RangeDelay to the contents of the complex content that is accessed
           * by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by RangeDelay
           */
         virtual void setRangeDelay(const uci::type::CommRangeDelayChoiceType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the GuardSlotID.
           ...
           */
         virtual const uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType::GuardSlotID& getGuardSlotID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the GuardSlotID.
           ...
           * @return The bounded list identified by GuardSlotID.
           */
         virtual uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType::GuardSlotID& getGuardSlotID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the GuardSlotID.
           ...
           *      accessor
           */
         virtual void setGuardSlotID(const uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType::GuardSlotID& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         CommUHF_SATCOM_CommWaveformActivityCommandType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CommUHF_SATCOM_CommWaveformActivityCommandType to copy from
           */
         CommUHF_SATCOM_CommWaveformActivityCommandType(const CommUHF_SATCOM_CommWaveformActivityCommandType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CommUHF_SATCOM_CommWaveformActivityCommandType to the contents of
           * the CommUHF_SATCOM_CommWaveformActivityCommandType on the right hand side (rhs) of the assignment
           * operator.CommUHF_SATCOM_CommWaveformActivityCommandType [only available to derived classes]
           *
           * @param rhs The CommUHF_SATCOM_CommWaveformActivityCommandType on the right hand side (rhs) of the assignment operator
           *      whose contents are used to set the contents of this uci::type::CommUHF_SATCOM_CommWaveformActivityCommandType
           * @return A constant reference to this CommUHF_SATCOM_CommWaveformActivityCommandType.
           */
         const CommUHF_SATCOM_CommWaveformActivityCommandType& operator=(const CommUHF_SATCOM_CommWaveformActivityCommandType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommUHF_SATCOM_CommWaveformActivityCommandType_h
