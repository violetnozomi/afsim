...
*    Directive 5230.25.
*/
#ifndef Uci__Type__Velocity3D_Type_h
#define Uci__Type__Velocity3D_Type_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const Velocity3D_Type& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this Velocity3D_Type to the contents of the Velocity3D_Type on the
           * right hand side (rhs) of the assignment operator.Velocity3D_Type [only available to derived classes]
           *
           * @param rhs The Velocity3D_Type on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::Velocity3D_Type
           * @return A constant reference to this Velocity3D_Type.
           */
         const Velocity3D_Type& operator=(const Velocity3D_Type& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__Velocity3D_Type_h
