...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__CommAssetReader_h
#define Uci__Reader__CommAssetReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The CommAssetListener provides the support to listen and handle incoming messages of the type uci::type::CommAsset */
      class CommAssetListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~CommAssetListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::CommAsset& message)
      ...
      class CommAssetReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~CommAssetReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(CommAssetListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(CommAssetListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, CommAssetListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, CommAssetListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CommAssetReader to copy from
           */
         CommAssetReader(const CommAssetReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CommAssetReader to the contents of the CommAssetReader on the
           * right hand side (rhs) of the assignment operator.CommAssetReader [only available to derived classes]
           *
           * @param rhs The CommAssetReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this CommAssetReader
           * @return A constant reference to this CommAssetReader.
           */
         const CommAssetReader& operator=(const CommAssetReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__CommAssetReader_h
