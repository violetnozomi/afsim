...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SAR_SettingsCommandStatusMT_h
#define Uci__Type__SAR_SettingsCommandStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SAR_SettingsCommandStatusMT sequence accessor class */
      class SAR_SettingsCommandStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~SAR_SettingsCommandStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. SAR_SettingsCommandStatusMT
           *
           * @return This accessor's type constant, i.e. SAR_SettingsCommandStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::sAR_SettingsCommandStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SAR_SettingsCommandStatusMT& accessor)
      ...
      protected:
         ...
         SAR_SettingsCommandStatusMT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The SAR_SettingsCommandStatusMT to copy from
           */
         SAR_SettingsCommandStatusMT(const SAR_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SAR_SettingsCommandStatusMT to the contents of the
           * SAR_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator.SAR_SettingsCommandStatusMT [only
           * available to derived classes]
           *
           * @param rhs The SAR_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::SAR_SettingsCommandStatusMT
           * @return A constant reference to this SAR_SettingsCommandStatusMT.
           */
         const SAR_SettingsCommandStatusMT& operator=(const SAR_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SAR_SettingsCommandStatusMT_h
