...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ControleeType_h
#define Uci__Type__ControleeType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ControleeType sequence accessor class */
      class ControleeType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ControleeType()
         { }

         /** Returns this accessor's type constant, i.e. ControleeType
           *
           * @return This accessor's type constant, i.e. ControleeType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::controleeType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ControleeType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ControleeType to copy from
           */
         ControleeType(const ControleeType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ControleeType to the contents of the ControleeType on the right
           * hand side (rhs) of the assignment operator.ControleeType [only available to derived classes]
           *
           * @param rhs The ControleeType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::ControleeType
           * @return A constant reference to this ControleeType.
           */
         const ControleeType& operator=(const ControleeType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ControleeType_h
