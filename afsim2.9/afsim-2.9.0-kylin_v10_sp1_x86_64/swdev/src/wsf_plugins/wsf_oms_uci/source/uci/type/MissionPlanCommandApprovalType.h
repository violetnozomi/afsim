...
*    Directive 5230.25.
*/
#ifndef Uci__Type__MissionPlanCommandApprovalType_h
#define Uci__Type__MissionPlanCommandApprovalType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the MissionPlanCommandApprovalType sequence accessor class */
      class MissionPlanCommandApprovalType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~MissionPlanCommandApprovalType()
         { }

         /** Returns this accessor's type constant, i.e. MissionPlanCommandApprovalType
           *
           * @return This accessor's type constant, i.e. MissionPlanCommandApprovalType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::missionPlanCommandApprovalType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const MissionPlanCommandApprovalType& accessor)
      ...
      protected:
         ...
         MissionPlanCommandApprovalType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The MissionPlanCommandApprovalType to copy from
           */
         MissionPlanCommandApprovalType(const MissionPlanCommandApprovalType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this MissionPlanCommandApprovalType to the contents of the
           * MissionPlanCommandApprovalType on the right hand side (rhs) of the assignment operator.MissionPlanCommandApprovalType
           * [only available to derived classes]
           *
           * @param rhs The MissionPlanCommandApprovalType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::MissionPlanCommandApprovalType
           * @return A constant reference to this MissionPlanCommandApprovalType.
           */
         const MissionPlanCommandApprovalType& operator=(const MissionPlanCommandApprovalType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__MissionPlanCommandApprovalType_h
