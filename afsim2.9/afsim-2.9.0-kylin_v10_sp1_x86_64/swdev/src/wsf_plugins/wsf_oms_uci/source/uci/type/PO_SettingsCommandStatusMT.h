...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_SettingsCommandStatusMT_h
#define Uci__Type__PO_SettingsCommandStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_SettingsCommandStatusMT sequence accessor class */
      class PO_SettingsCommandStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~PO_SettingsCommandStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. PO_SettingsCommandStatusMT
           *
           * @return This accessor's type constant, i.e. PO_SettingsCommandStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pO_SettingsCommandStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_SettingsCommandStatusMT& accessor)
      ...
      protected:
         ...
         PO_SettingsCommandStatusMT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The PO_SettingsCommandStatusMT to copy from
           */
         PO_SettingsCommandStatusMT(const PO_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this PO_SettingsCommandStatusMT to the contents of the
           * PO_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator.PO_SettingsCommandStatusMT [only
           * available to derived classes]
           *
           * @param rhs The PO_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::PO_SettingsCommandStatusMT
           * @return A constant reference to this PO_SettingsCommandStatusMT.
           */
         const PO_SettingsCommandStatusMT& operator=(const PO_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_SettingsCommandStatusMT_h
