...
*    Directive 5230.25.
*/
#ifndef Uci__Type__GatewaySettingsCommandStatusMT_h
#define Uci__Type__GatewaySettingsCommandStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class GatewaySettingsCommandStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~GatewaySettingsCommandStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. GatewaySettingsCommandStatusMT
           *
           * @return This accessor's type constant, i.e. GatewaySettingsCommandStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::gatewaySettingsCommandStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const GatewaySettingsCommandStatusMT& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The GatewaySettingsCommandStatusMT to copy from
           */
         GatewaySettingsCommandStatusMT(const GatewaySettingsCommandStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this GatewaySettingsCommandStatusMT to the contents of the
           * GatewaySettingsCommandStatusMT on the right hand side (rhs) of the assignment operator.GatewaySettingsCommandStatusMT
           * [only available to derived classes]
           *
           * @param rhs The GatewaySettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::GatewaySettingsCommandStatusMT
           * @return A constant reference to this GatewaySettingsCommandStatusMT.
           */
         const GatewaySettingsCommandStatusMT& operator=(const GatewaySettingsCommandStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__GatewaySettingsCommandStatusMT_h
