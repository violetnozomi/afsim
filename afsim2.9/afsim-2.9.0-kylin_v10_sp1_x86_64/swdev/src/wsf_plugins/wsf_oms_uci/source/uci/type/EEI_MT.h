...
*    Directive 5230.25.
*/
#ifndef Uci__Type__EEI_MT_h
#define Uci__Type__EEI_MT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class EEI_MT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. EEI_MT
           *
           * @return This accessor's type constant, i.e. EEI_MT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::eEI_MT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const EEI_MT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::EEI_MDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::EEI_MDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::EEI_MDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The EEI_MT to copy from
           */
         EEI_MT(const EEI_MT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this EEI_MT to the contents of the EEI_MT on the right hand side (rhs)
           * of the assignment operator.EEI_MT [only available to derived classes]
           *
           * @param rhs The EEI_MT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::EEI_MT
           * @return A constant reference to this EEI_MT.
           */
         const EEI_MT& operator=(const EEI_MT& rhs)
         {
            (void)rhs;
