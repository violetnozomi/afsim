...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SubsystemSpecificationType_h
#define Uci__Type__SubsystemSpecificationType_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SubsystemSpecificationType& accessor)
            throw(uci::base::UCIException) = 0;


         /** List specific components of a subsystem, if applicable. [Minimum occurrences: 0] [Maximum occurrences:
           * 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the ComponentID.
           ...
           */
         virtual const uci::type::SubsystemSpecificationType::ComponentID& getComponentID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ComponentID.
           ...
           * @return The bounded list identified by ComponentID.
           */
         virtual uci::type::SubsystemSpecificationType::ComponentID& getComponentID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ComponentID.
           ...
           *      accessor
           */
         virtual void setComponentID(const uci::type::SubsystemSpecificationType::ComponentID& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SubsystemSpecificationType to the contents of the
           * SubsystemSpecificationType on the right hand side (rhs) of the assignment operator.SubsystemSpecificationType [only
           * available to derived classes]
           *
           * @param rhs The SubsystemSpecificationType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::SubsystemSpecificationType
           * @return A constant reference to this SubsystemSpecificationType.
           */
         const SubsystemSpecificationType& operator=(const SubsystemSpecificationType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SubsystemSpecificationType_h
