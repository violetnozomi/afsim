...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommPointingPlanAssessmentType_h
#define Uci__Type__CommPointingPlanAssessmentType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      public:
         ...
         /** The destructor */
         virtual ~CommPointingPlanAssessmentType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommPointingPlanAssessmentType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Parameters.
           ...
           */
         virtual const uci::type::CommPointingPlanRequestType& getParameters() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Parameters.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Parameters.
           */
         virtual uci::type::CommPointingPlanRequestType& getParameters()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Parameters to the contents of the complex content that is accessed
           ...
           */
         virtual void setParameters(const uci::type::CommPointingPlanRequestType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by Parameters
           *
           * @param type = uci::type::accessorType::commPointingPlanRequestType This Accessor's accessor type
           */
         virtual void enableParameters(uci::base::accessorType::AccessorType type = uci::type::accessorType::commPointingPlanRequestType)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Data.
           ...
           */
         virtual const uci::type::CommPointingPlanDataType& getData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Data.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Data.
           */
         virtual uci::type::CommPointingPlanDataType& getData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Data to the contents of the complex content that is accessed by
           ...
           */
         virtual void setData(const uci::type::CommPointingPlanDataType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this CommPointingPlanAssessmentType to the contents of the
           * CommPointingPlanAssessmentType on the right hand side (rhs) of the assignment operator.CommPointingPlanAssessmentType
           * [only available to derived classes]
           *
           * @param rhs The CommPointingPlanAssessmentType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::CommPointingPlanAssessmentType
           * @return A constant reference to this CommPointingPlanAssessmentType.
           */
         const CommPointingPlanAssessmentType& operator=(const CommPointingPlanAssessmentType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommPointingPlanAssessmentType_h
