...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ESM_SettingsCommandStatusMT_h
#define Uci__Type__ESM_SettingsCommandStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ESM_SettingsCommandStatusMT sequence accessor class */
      class ESM_SettingsCommandStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~ESM_SettingsCommandStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. ESM_SettingsCommandStatusMT
           *
           * @return This accessor's type constant, i.e. ESM_SettingsCommandStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::eSM_SettingsCommandStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ESM_SettingsCommandStatusMT& accessor)
      ...
      protected:
         ...
         ESM_SettingsCommandStatusMT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ESM_SettingsCommandStatusMT to copy from
           */
         ESM_SettingsCommandStatusMT(const ESM_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ESM_SettingsCommandStatusMT to the contents of the
           * ESM_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator.ESM_SettingsCommandStatusMT [only
           * available to derived classes]
           *
           * @param rhs The ESM_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::ESM_SettingsCommandStatusMT
           * @return A constant reference to this ESM_SettingsCommandStatusMT.
           */
         const ESM_SettingsCommandStatusMT& operator=(const ESM_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ESM_SettingsCommandStatusMT_h
