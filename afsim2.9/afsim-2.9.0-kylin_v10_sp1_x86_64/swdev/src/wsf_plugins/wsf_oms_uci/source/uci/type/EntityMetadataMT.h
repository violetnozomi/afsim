...
*    Directive 5230.25.
*/
#ifndef Uci__Type__EntityMetadataMT_h
#define Uci__Type__EntityMetadataMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class EntityMetadataMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~EntityMetadataMT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const EntityMetadataMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::EntityMetadataMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::EntityMetadataMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::EntityMetadataMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this EntityMetadataMT to the contents of the EntityMetadataMT on the
           * right hand side (rhs) of the assignment operator.EntityMetadataMT [only available to derived classes]
           *
           * @param rhs The EntityMetadataMT on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::EntityMetadataMT
           * @return A constant reference to this EntityMetadataMT.
           */
         const EntityMetadataMT& operator=(const EntityMetadataMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__EntityMetadataMT_h
