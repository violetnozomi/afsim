...
*    Directive 5230.25.
*/
#ifndef Uci__Type__EntityMT_h
#define Uci__Type__EntityMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class EntityMT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. EntityMT
           *
           * @return This accessor's type constant, i.e. EntityMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::entityMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const EntityMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::EntityMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::EntityMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::EntityMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The EntityMT to copy from
           */
         EntityMT(const EntityMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this EntityMT to the contents of the EntityMT on the right hand side
           * (rhs) of the assignment operator.EntityMT [only available to derived classes]
           *
           * @param rhs The EntityMT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::EntityMT
           * @return A constant reference to this EntityMT.
           */
         const EntityMT& operator=(const EntityMT& rhs)
         {
            (void)rhs;
