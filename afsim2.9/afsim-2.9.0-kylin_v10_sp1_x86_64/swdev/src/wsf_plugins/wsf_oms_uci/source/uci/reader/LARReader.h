...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__LARReader_h
#define Uci__Reader__LARReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The LARListener provides the support to listen and handle incoming messages of the type uci::type::LAR */
      class LARListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::LAR& message)
      ...
      class LARReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(LARListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(LARListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, LARListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, LARListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The LARReader to copy from
           */
         LARReader(const LARReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this LARReader to the contents of the LARReader on the right hand side
           * (rhs) of the assignment operator.LARReader [only available to derived classes]
           *
           * @param rhs The LARReader on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this LARReader
           * @return A constant reference to this LARReader.
           */
         const LARReader& operator=(const LARReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__LARReader_h
