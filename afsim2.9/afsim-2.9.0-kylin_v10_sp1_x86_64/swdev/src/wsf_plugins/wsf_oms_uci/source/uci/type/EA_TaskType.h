...
*    Directive 5230.25.
*/
#ifndef Uci__Type__EA_TaskType_h
#define Uci__Type__EA_TaskType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the EA_TaskType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const EA_TaskType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the RouteRequirements.
           ...
           */
         virtual const uci::type::EA_TaskRouteRequirementsType& getRouteRequirements() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the RouteRequirements.
           ...
           * @return The acecssor that provides access to the complex content that is identified by RouteRequirements.
           */
         virtual uci::type::EA_TaskRouteRequirementsType& getRouteRequirements()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the RouteRequirements to the contents of the complex content that is
           ...
           */
         virtual void setRouteRequirements(const uci::type::EA_TaskRouteRequirementsType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by RouteRequirements
           *
           * @param type = uci::type::accessorType::eA_TaskRouteRequirementsType This Accessor's accessor type
           */
         virtual void enableRouteRequirements(uci::base::accessorType::AccessorType type = uci::type::accessorType::eA_TaskRouteRequirementsType)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this EA_TaskType to the contents of the EA_TaskType on the right hand
           * side (rhs) of the assignment operator.EA_TaskType [only available to derived classes]
           *
           * @param rhs The EA_TaskType on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::EA_TaskType
           * @return A constant reference to this EA_TaskType.
           */
         const EA_TaskType& operator=(const EA_TaskType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__EA_TaskType_h
