...
*    Directive 5230.25.
*/
#ifndef Uci__Type__RF_OperationType_h
#define Uci__Type__RF_OperationType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the RF_OperationType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const RF_OperationType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Indicates the unique IDs of related activities [Minimum occurrences: 0] [Maximum occurrences: 9223372036854775807] */
         ...
         /** Returns the bounded list that is identified by the ActivityID.
           ...
           */
         virtual const uci::type::RF_OperationType::ActivityID& getActivityID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ActivityID.
           ...
           * @return The bounded list identified by ActivityID.
           */
         virtual uci::type::RF_OperationType::ActivityID& getActivityID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ActivityID.
           ...
           *      accessor
           */
         virtual void setActivityID(const uci::type::RF_OperationType::ActivityID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the PRI.
           ...
           */
         virtual const uci::type::DurationRangeType& getPRI() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the PRI.
           ...
           * @return The acecssor that provides access to the complex content that is identified by PRI.
           */
         virtual uci::type::DurationRangeType& getPRI()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the PRI to the contents of the complex content that is accessed by the
           ...
           */
         virtual void setPRI(const uci::type::DurationRangeType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by PRI
           ...
           */
         virtual void enablePRI(uci::base::accessorType::AccessorType type = uci::type::accessorType::durationRangeType)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the DutyCycle.
           *
           * @return The acecssor that provides access to the complex content that is identified by DutyCycle.
           */
         virtual const uci::type::PercentRangeType& getDutyCycle() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the DutyCycle.
           ...
           * @return The acecssor that provides access to the complex content that is identified by DutyCycle.
           */
         virtual uci::type::PercentRangeType& getDutyCycle()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the DutyCycle to the contents of the complex content that is accessed
           * by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by DutyCycle
           */
         virtual void setDutyCycle(const uci::type::PercentRangeType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by DutyCycle
           ...
           */
         virtual void enableDutyCycle(uci::base::accessorType::AccessorType type = uci::type::accessorType::percentRangeType)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the
           ...
           *      ConfigureInteroperabilityReport.
           */
         virtual const uci::type::ConfigureInteroperabilityReportType& getConfigureInteroperabilityReport() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the
           ...
           *      ConfigureInteroperabilityReport.
           */
         virtual uci::type::ConfigureInteroperabilityReportType& getConfigureInteroperabilityReport()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the ConfigureInteroperabilityReport to the contents of the complex
           * content that is accessed by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by ConfigureInteroperabilityReport
           */
         virtual void setConfigureInteroperabilityReport(const uci::type::ConfigureInteroperabilityReportType& value)
            throw(uci::base::UCIException) = 0;


         /** Returns whether the Element that is identified by ConfigureInteroperabilityReport exists (is enabled) or not.
           *
           * @return A boolean indicating whether the Element identified by ConfigureInteroperabilityReport is emabled or not
           */
         virtual bool hasConfigureInteroperabilityReport() const
            throw(uci::base::UCIException) = 0;


         /** Enables the Element that is identified by ConfigureInteroperabilityReport
           *
           * @param type = uci::type::accessorType::configureInteroperabilityReportType This Accessor's accessor type
           */
         virtual void enableConfigureInteroperabilityReport(uci::base::accessorType::AccessorType type = uci::type::accessorType::configureInteroperabilityReportType)
            throw(uci::base::UCIException) = 0;


         /** Clears (disabled) the Element that is identified by ConfigureInteroperabilityReport */
         virtual void clearConfigureInteroperabilityReport()
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this RF_OperationType to the contents of the RF_OperationType on the
           * right hand side (rhs) of the assignment operator.RF_OperationType [only available to derived classes]
           *
           * @param rhs The RF_OperationType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::RF_OperationType
           * @return A constant reference to this RF_OperationType.
           */
         const RF_OperationType& operator=(const RF_OperationType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__RF_OperationType_h
