...
*    Directive 5230.25.
*/
#ifndef Uci__Type__GatewayControlType_h
#define Uci__Type__GatewayControlType_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const GatewayControlType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this GatewayControlType to the contents of the GatewayControlType on
           * the right hand side (rhs) of the assignment operator.GatewayControlType [only available to derived classes]
           *
           * @param rhs The GatewayControlType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::GatewayControlType
           * @return A constant reference to this GatewayControlType.
           */
         const GatewayControlType& operator=(const GatewayControlType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__GatewayControlType_h
