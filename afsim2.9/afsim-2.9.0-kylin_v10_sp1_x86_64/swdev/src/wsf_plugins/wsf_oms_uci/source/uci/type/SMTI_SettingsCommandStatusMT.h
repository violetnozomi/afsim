...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SMTI_SettingsCommandStatusMT_h
#define Uci__Type__SMTI_SettingsCommandStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SMTI_SettingsCommandStatusMT sequence accessor class */
      class SMTI_SettingsCommandStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~SMTI_SettingsCommandStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. SMTI_SettingsCommandStatusMT
           *
           * @return This accessor's type constant, i.e. SMTI_SettingsCommandStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::sMTI_SettingsCommandStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SMTI_SettingsCommandStatusMT& accessor)
      ...
      protected:
         ...
         SMTI_SettingsCommandStatusMT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The SMTI_SettingsCommandStatusMT to copy from
           */
         SMTI_SettingsCommandStatusMT(const SMTI_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SMTI_SettingsCommandStatusMT to the contents of the
           * SMTI_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator.SMTI_SettingsCommandStatusMT
           * [only available to derived classes]
           *
           * @param rhs The SMTI_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::SMTI_SettingsCommandStatusMT
           * @return A constant reference to this SMTI_SettingsCommandStatusMT.
           */
         const SMTI_SettingsCommandStatusMT& operator=(const SMTI_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SMTI_SettingsCommandStatusMT_h
