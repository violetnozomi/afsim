...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommRelayActivityType_h
#define Uci__Type__CommRelayActivityType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the CommRelayActivityType sequence accessor class */
      class CommRelayActivityType : public virtual uci::type::ActivityBaseType {
      public:

         /** The destructor */
         virtual ~CommRelayActivityType()
         { }

         /** Returns this accessor's type constant, i.e. CommRelayActivityType
           *
           * @return This accessor's type constant, i.e. CommRelayActivityType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::commRelayActivityType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommRelayActivityType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Indicates a signal being relayed. [Minimum occurrences: 0] [Maximum occurrences: 9223372036854775807] */
         ...
         /** Returns the bounded list that is identified by the FrequencySet.
           ...
           */
         virtual const uci::type::CommRelayActivityType::FrequencySet& getFrequencySet() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the FrequencySet.
           ...
           * @return The bounded list identified by FrequencySet.
           */
         virtual uci::type::CommRelayActivityType::FrequencySet& getFrequencySet()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the FrequencySet.
           ...
           *      accessor
           */
         virtual void setFrequencySet(const uci::type::CommRelayActivityType::FrequencySet& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         CommRelayActivityType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CommRelayActivityType to copy from
           */
         CommRelayActivityType(const CommRelayActivityType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CommRelayActivityType to the contents of the CommRelayActivityType
           * on the right hand side (rhs) of the assignment operator.CommRelayActivityType [only available to derived classes]
           *
           * @param rhs The CommRelayActivityType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::CommRelayActivityType
           * @return A constant reference to this CommRelayActivityType.
           */
         const CommRelayActivityType& operator=(const CommRelayActivityType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommRelayActivityType_h
