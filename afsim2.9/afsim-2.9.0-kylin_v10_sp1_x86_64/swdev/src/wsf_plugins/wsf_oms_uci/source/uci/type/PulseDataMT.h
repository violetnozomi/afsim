...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PulseDataMT_h
#define Uci__Type__PulseDataMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class PulseDataMT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. PulseDataMT
           *
           * @return This accessor's type constant, i.e. PulseDataMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pulseDataMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PulseDataMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::PulseDataMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::PulseDataMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::PulseDataMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The PulseDataMT to copy from
           */
         PulseDataMT(const PulseDataMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this PulseDataMT to the contents of the PulseDataMT on the right hand
           * side (rhs) of the assignment operator.PulseDataMT [only available to derived classes]
           *
           * @param rhs The PulseDataMT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::PulseDataMT
           * @return A constant reference to this PulseDataMT.
           */
         const PulseDataMT& operator=(const PulseDataMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PulseDataMT_h
