...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__TaskCancelReader_h
#define Uci__Reader__TaskCancelReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The TaskCancelListener provides the support to listen and handle incoming messages of the type uci::type::TaskCancel */
      class TaskCancelListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~TaskCancelListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::TaskCancel& message)
      ...
      class TaskCancelReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~TaskCancelReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(TaskCancelListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(TaskCancelListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, TaskCancelListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, TaskCancelListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The TaskCancelReader to copy from
           */
         TaskCancelReader(const TaskCancelReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this TaskCancelReader to the contents of the TaskCancelReader on the
           * right hand side (rhs) of the assignment operator.TaskCancelReader [only available to derived classes]
           *
           * @param rhs The TaskCancelReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this TaskCancelReader
           * @return A constant reference to this TaskCancelReader.
           */
         const TaskCancelReader& operator=(const TaskCancelReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__TaskCancelReader_h
