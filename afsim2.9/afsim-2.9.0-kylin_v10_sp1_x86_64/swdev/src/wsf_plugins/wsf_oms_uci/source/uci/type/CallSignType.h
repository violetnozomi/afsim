...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CallSignType_h
#define Uci__Type__CallSignType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** Indicates an associated call sign. Multiple call signs are allowed for different communications systems, registries
        ...
        */
      class CallSignType : public virtual uci::type::ForeignKeyType {
      public:

         /** The destructor */
         virtual ~CallSignType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CallSignType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this CallSignType to the contents of the CallSignType on the right hand
           * side (rhs) of the assignment operator.CallSignType [only available to derived classes]
           *
           * @param rhs The CallSignType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::CallSignType
           * @return A constant reference to this CallSignType.
           */
         const CallSignType& operator=(const CallSignType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CallSignType_h
