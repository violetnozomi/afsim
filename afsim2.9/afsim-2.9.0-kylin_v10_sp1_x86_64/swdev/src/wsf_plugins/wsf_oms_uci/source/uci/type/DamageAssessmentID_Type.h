...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DamageAssessmentID_Type_h
#define Uci__Type__DamageAssessmentID_Type_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class DamageAssessmentID_Type : public virtual uci::type::ID_Type {
      public:

         /** The destructor */
         virtual ~DamageAssessmentID_Type()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DamageAssessmentID_Type& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this DamageAssessmentID_Type to the contents of the
           * DamageAssessmentID_Type on the right hand side (rhs) of the assignment operator.DamageAssessmentID_Type [only
           * available to derived classes]
           *
           * @param rhs The DamageAssessmentID_Type on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::DamageAssessmentID_Type
           * @return A constant reference to this DamageAssessmentID_Type.
           */
         const DamageAssessmentID_Type& operator=(const DamageAssessmentID_Type& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DamageAssessmentID_Type_h
