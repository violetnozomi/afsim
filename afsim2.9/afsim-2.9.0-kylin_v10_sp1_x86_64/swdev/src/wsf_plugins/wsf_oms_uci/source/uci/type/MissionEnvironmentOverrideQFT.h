...
*    Directive 5230.25.
*/
#ifndef Uci__Type__MissionEnvironmentOverrideQFT_h
#define Uci__Type__MissionEnvironmentOverrideQFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the MissionEnvironmentOverrideQFT sequence accessor class */
      class MissionEnvironmentOverrideQFT : public virtual uci::type::QueryFilterPET {
      public:

         /** The destructor */
         virtual ~MissionEnvironmentOverrideQFT()
         { }

         /** Returns this accessor's type constant, i.e. MissionEnvironmentOverrideQFT
           *
           * @return This accessor's type constant, i.e. MissionEnvironmentOverrideQFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::missionEnvironmentOverrideQFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const MissionEnvironmentOverrideQFT& accessor)
         ...
         /** Returns whether the Element that is identified by OpLineID exists (is enabled) or not.
           *
           * @return A boolean indicating whether the Element identified by OpLineID is emabled or not
           */
         virtual bool hasOpLineID() const
            throw(uci::base::UCIException) = 0;


         /** Enables the Element that is identified by OpLineID
           *
           * @param type = uci::type::accessorType::opLineID_Type This Accessor's accessor type
           */
         virtual void enableOpLineID(uci::base::accessorType::AccessorType type = uci::type::accessorType::opLineID_Type)
            throw(uci::base::UCIException) = 0;


         /** Clears (disabled) the Element that is identified by OpLineID */
         virtual void clearOpLineID()
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         MissionEnvironmentOverrideQFT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The MissionEnvironmentOverrideQFT to copy from
           */
         MissionEnvironmentOverrideQFT(const MissionEnvironmentOverrideQFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this MissionEnvironmentOverrideQFT to the contents of the
           * MissionEnvironmentOverrideQFT on the right hand side (rhs) of the assignment operator.MissionEnvironmentOverrideQFT
           * [only available to derived classes]
           *
           * @param rhs The MissionEnvironmentOverrideQFT on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::MissionEnvironmentOverrideQFT
           * @return A constant reference to this MissionEnvironmentOverrideQFT.
           */
         const MissionEnvironmentOverrideQFT& operator=(const MissionEnvironmentOverrideQFT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__MissionEnvironmentOverrideQFT_h
