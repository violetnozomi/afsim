...
*    Directive 5230.25.
*/
#ifndef Uci__Type__FusionSettingsRequestQFT_h
#define Uci__Type__FusionSettingsRequestQFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the FusionSettingsRequestQFT sequence accessor class */
      class FusionSettingsRequestQFT : public virtual uci::type::QueryFilterPET {
      public:

         /** The destructor */
         virtual ~FusionSettingsRequestQFT()
         { }

         /** Returns this accessor's type constant, i.e. FusionSettingsRequestQFT
           *
           * @return This accessor's type constant, i.e. FusionSettingsRequestQFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::fusionSettingsRequestQFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const FusionSettingsRequestQFT& accessor)
      ...
      protected:
         ...
         FusionSettingsRequestQFT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The FusionSettingsRequestQFT to copy from
           */
         FusionSettingsRequestQFT(const FusionSettingsRequestQFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this FusionSettingsRequestQFT to the contents of the
           * FusionSettingsRequestQFT on the right hand side (rhs) of the assignment operator.FusionSettingsRequestQFT [only
           * available to derived classes]
           *
           * @param rhs The FusionSettingsRequestQFT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::FusionSettingsRequestQFT
           * @return A constant reference to this FusionSettingsRequestQFT.
           */
         const FusionSettingsRequestQFT& operator=(const FusionSettingsRequestQFT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__FusionSettingsRequestQFT_h
