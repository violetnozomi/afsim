...
*    Directive 5230.25.
*/
#ifndef Uci__Type__EA_SettingsCommandStatusMT_h
#define Uci__Type__EA_SettingsCommandStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the EA_SettingsCommandStatusMT sequence accessor class */
      class EA_SettingsCommandStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~EA_SettingsCommandStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. EA_SettingsCommandStatusMT
           *
           * @return This accessor's type constant, i.e. EA_SettingsCommandStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::eA_SettingsCommandStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const EA_SettingsCommandStatusMT& accessor)
      ...
      protected:
         ...
         EA_SettingsCommandStatusMT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The EA_SettingsCommandStatusMT to copy from
           */
         EA_SettingsCommandStatusMT(const EA_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this EA_SettingsCommandStatusMT to the contents of the
           * EA_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator.EA_SettingsCommandStatusMT [only
           * available to derived classes]
           *
           * @param rhs The EA_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::EA_SettingsCommandStatusMT
           * @return A constant reference to this EA_SettingsCommandStatusMT.
           */
         const EA_SettingsCommandStatusMT& operator=(const EA_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__EA_SettingsCommandStatusMT_h
