...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__OpLineReader_h
#define Uci__Reader__OpLineReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The OpLineListener provides the support to listen and handle incoming messages of the type uci::type::OpLine */
      class OpLineListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~OpLineListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::OpLine& message)
      ...
      class OpLineReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~OpLineReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(OpLineListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(OpLineListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, OpLineListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, OpLineListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpLineReader to copy from
           */
         OpLineReader(const OpLineReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpLineReader to the contents of the OpLineReader on the right hand
           * side (rhs) of the assignment operator.OpLineReader [only available to derived classes]
           *
           * @param rhs The OpLineReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this OpLineReader
           * @return A constant reference to this OpLineReader.
           */
         const OpLineReader& operator=(const OpLineReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__OpLineReader_h
