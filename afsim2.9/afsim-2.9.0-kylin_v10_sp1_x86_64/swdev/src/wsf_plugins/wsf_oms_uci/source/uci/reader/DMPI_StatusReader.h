...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__DMPI_StatusReader_h
#define Uci__Reader__DMPI_StatusReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The DMPI_StatusListener provides the support to listen and handle incoming messages of the type
        * uci::type::DMPI_Status
        */
      class DMPI_StatusListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~DMPI_StatusListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::DMPI_Status& message)
      ...
      class DMPI_StatusReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~DMPI_StatusReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(DMPI_StatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(DMPI_StatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, DMPI_StatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, DMPI_StatusListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DMPI_StatusReader to copy from
           */
         DMPI_StatusReader(const DMPI_StatusReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DMPI_StatusReader to the contents of the DMPI_StatusReader on the
           * right hand side (rhs) of the assignment operator.DMPI_StatusReader [only available to derived classes]
           *
           * @param rhs The DMPI_StatusReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this DMPI_StatusReader
           * @return A constant reference to this DMPI_StatusReader.
           */
         const DMPI_StatusReader& operator=(const DMPI_StatusReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__DMPI_StatusReader_h
