...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductManagementTaskDataType_h
#define Uci__Type__ProductManagementTaskDataType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class ProductManagementTaskDataType : public virtual uci::type::TaskDataBaseType {
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductManagementTaskDataType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ProductManagementTaskDataType to the contents of the
           * ProductManagementTaskDataType on the right hand side (rhs) of the assignment operator.ProductManagementTaskDataType
           * [only available to derived classes]
           *
           * @param rhs The ProductManagementTaskDataType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::ProductManagementTaskDataType
           * @return A constant reference to this ProductManagementTaskDataType.
           */
         const ProductManagementTaskDataType& operator=(const ProductManagementTaskDataType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductManagementTaskDataType_h
