...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DamagedHumanType_h
#define Uci__Type__DamagedHumanType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the DamagedHumanType sequence accessor class */
      class DamagedHumanType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~DamagedHumanType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DamagedHumanType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this DamagedHumanType to the contents of the DamagedHumanType on the
           * right hand side (rhs) of the assignment operator.DamagedHumanType [only available to derived classes]
           *
           * @param rhs The DamagedHumanType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::DamagedHumanType
           * @return A constant reference to this DamagedHumanType.
           */
         const DamagedHumanType& operator=(const DamagedHumanType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DamagedHumanType_h
