...
*    Directive 5230.25.
*/
#ifndef Uci__Type__POST_ComponentProductGeneratorType_h
#define Uci__Type__POST_ComponentProductGeneratorType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the POST_ComponentProductGeneratorType sequence accessor class */
      class POST_ComponentProductGeneratorType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~POST_ComponentProductGeneratorType()
         { }

         /** Returns this accessor's type constant, i.e. POST_ComponentProductGeneratorType
           *
           * @return This accessor's type constant, i.e. POST_ComponentProductGeneratorType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pOST_ComponentProductGeneratorType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const POST_ComponentProductGeneratorType& accessor)
         ...
         /** Returns the bounded list that is identified by the FPA_ID.
           ...
           */
         virtual const uci::type::POST_ComponentProductGeneratorType::FPA_ID& getFPA_ID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the FPA_ID.
           ...
           * @return The bounded list identified by FPA_ID.
           */
         virtual uci::type::POST_ComponentProductGeneratorType::FPA_ID& getFPA_ID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the FPA_ID.
           ...
           *      accessor
           */
         virtual void setFPA_ID(const uci::type::POST_ComponentProductGeneratorType::FPA_ID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ComponentProductOutput.
           *
           * @return The bounded list identified by ComponentProductOutput.
           */
         virtual const uci::type::POST_ComponentProductGeneratorType::ComponentProductOutput& getComponentProductOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ComponentProductOutput.
           ...
           * @return The bounded list identified by ComponentProductOutput.
           */
         virtual uci::type::POST_ComponentProductGeneratorType::ComponentProductOutput& getComponentProductOutput()
            throw(uci::base::UCIException) = 0;


         /** Sets the bounded list that is identified by the ComponentProductOutput.
           *
           * @param value The bounded list whose contents are to be used to set the value of the bounded list accessed by this
           *      accessor
           */
         virtual void setComponentProductOutput(const uci::type::POST_ComponentProductGeneratorType::ComponentProductOutput& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         POST_ComponentProductGeneratorType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The POST_ComponentProductGeneratorType to copy from
           */
         POST_ComponentProductGeneratorType(const POST_ComponentProductGeneratorType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this POST_ComponentProductGeneratorType to the contents of the
           * POST_ComponentProductGeneratorType on the right hand side (rhs) of the assignment
           * operator.POST_ComponentProductGeneratorType [only available to derived classes]
           *
           * @param rhs The POST_ComponentProductGeneratorType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::POST_ComponentProductGeneratorType
           * @return A constant reference to this POST_ComponentProductGeneratorType.
           */
         const POST_ComponentProductGeneratorType& operator=(const POST_ComponentProductGeneratorType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__POST_ComponentProductGeneratorType_h
