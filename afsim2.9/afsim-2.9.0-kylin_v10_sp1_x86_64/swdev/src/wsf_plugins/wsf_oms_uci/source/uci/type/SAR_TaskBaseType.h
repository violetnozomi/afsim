...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SAR_TaskBaseType_h
#define Uci__Type__SAR_TaskBaseType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SAR_TaskBaseType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SAR_TaskBaseType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the DesiredWaveform.
           ...
           */
         virtual const uci::type::SAR_WaveformType& getDesiredWaveform() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the DesiredWaveform.
           ...
           * @return The acecssor that provides access to the complex content that is identified by DesiredWaveform.
           */
         virtual uci::type::SAR_WaveformType& getDesiredWaveform()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the DesiredWaveform to the contents of the complex content that is
           ...
           */
         virtual void setDesiredWaveform(const uci::type::SAR_WaveformType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by DesiredWaveform
           *
           * @param type = uci::type::accessorType::sAR_WaveformType This Accessor's accessor type
           */
         virtual void enableDesiredWaveform(uci::base::accessorType::AccessorType type = uci::type::accessorType::sAR_WaveformType)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           */
         virtual const uci::type::SAR_TaskBaseType::Output& getOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           * @return The bounded list identified by Output.
           */
         virtual uci::type::SAR_TaskBaseType::Output& getOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Output.
           ...
           *      accessor
           */
         virtual void setOutput(const uci::type::SAR_TaskBaseType::Output& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SAR_TaskBaseType to the contents of the SAR_TaskBaseType on the
           * right hand side (rhs) of the assignment operator.SAR_TaskBaseType [only available to derived classes]
           *
           * @param rhs The SAR_TaskBaseType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::SAR_TaskBaseType
           * @return A constant reference to this SAR_TaskBaseType.
           */
         const SAR_TaskBaseType& operator=(const SAR_TaskBaseType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SAR_TaskBaseType_h
