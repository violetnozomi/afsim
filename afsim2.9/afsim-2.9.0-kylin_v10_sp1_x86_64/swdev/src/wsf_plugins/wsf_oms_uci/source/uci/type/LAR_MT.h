...
*    Directive 5230.25.
*/
#ifndef Uci__Type__LAR_MT_h
#define Uci__Type__LAR_MT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class LAR_MT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. LAR_MT
           *
           * @return This accessor's type constant, i.e. LAR_MT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::lAR_MT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const LAR_MT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::LAR_MDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::LAR_MDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::LAR_MDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The LAR_MT to copy from
           */
         LAR_MT(const LAR_MT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this LAR_MT to the contents of the LAR_MT on the right hand side (rhs)
           * of the assignment operator.LAR_MT [only available to derived classes]
           *
           * @param rhs The LAR_MT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::LAR_MT
           * @return A constant reference to this LAR_MT.
           */
         const LAR_MT& operator=(const LAR_MT& rhs)
         {
            (void)rhs;
