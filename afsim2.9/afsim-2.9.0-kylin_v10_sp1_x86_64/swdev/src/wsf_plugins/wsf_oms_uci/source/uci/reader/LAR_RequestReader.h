...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__LAR_RequestReader_h
#define Uci__Reader__LAR_RequestReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The LAR_RequestListener provides the support to listen and handle incoming messages of the type
        * uci::type::LAR_Request
        */
      class LAR_RequestListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~LAR_RequestListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::LAR_Request& message)
      ...
      class LAR_RequestReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~LAR_RequestReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(LAR_RequestListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(LAR_RequestListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, LAR_RequestListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, LAR_RequestListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The LAR_RequestReader to copy from
           */
         LAR_RequestReader(const LAR_RequestReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this LAR_RequestReader to the contents of the LAR_RequestReader on the
           * right hand side (rhs) of the assignment operator.LAR_RequestReader [only available to derived classes]
           *
           * @param rhs The LAR_RequestReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this LAR_RequestReader
           * @return A constant reference to this LAR_RequestReader.
           */
         const LAR_RequestReader& operator=(const LAR_RequestReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__LAR_RequestReader_h
