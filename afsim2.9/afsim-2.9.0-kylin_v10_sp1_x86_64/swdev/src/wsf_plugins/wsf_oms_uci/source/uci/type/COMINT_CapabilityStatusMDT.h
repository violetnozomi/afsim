...
*    Directive 5230.25.
*/
#ifndef Uci__Type__COMINT_CapabilityStatusMDT_h
#define Uci__Type__COMINT_CapabilityStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the COMINT_CapabilityStatusMDT sequence accessor class */
      class COMINT_CapabilityStatusMDT : public virtual uci::type::CapabilityStatusBaseType {
      public:

         /** The destructor */
         virtual ~COMINT_CapabilityStatusMDT()
         { }

         /** Returns this accessor's type constant, i.e. COMINT_CapabilityStatusMDT
           *
           * @return This accessor's type constant, i.e. COMINT_CapabilityStatusMDT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::cOMINT_CapabilityStatusMDT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const COMINT_CapabilityStatusMDT& accessor)
         ...
         /** Indicates a RF Emission Profile currently applied to the Capability. If omitted, there are no current profiles and
           ...
           * 9223372036854775807]
           */
         typedef uci::base::BoundedList<uci::type::CapabilityRF_ProfileStatusType, uci::type::accessorType::capabilityRF_ProfileStatusType> RF_Profile;
         ...
         /** Returns the bounded list that is identified by the CapabilityStatus.
           ...
           */
         virtual const uci::type::COMINT_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CapabilityStatus.
           ...
           * @return The bounded list identified by CapabilityStatus.
           */
         virtual uci::type::COMINT_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the CapabilityStatus.
           ...
           *      accessor
           */
         virtual void setCapabilityStatus(const uci::type::COMINT_CapabilityStatusMDT::CapabilityStatus& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the RF_Profile.
           ...
           */
         virtual const uci::type::COMINT_CapabilityStatusMDT::RF_Profile& getRF_Profile() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the RF_Profile.
           ...
           * @return The bounded list identified by RF_Profile.
           */
         virtual uci::type::COMINT_CapabilityStatusMDT::RF_Profile& getRF_Profile()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the RF_Profile.
           ...
           *      accessor
           */
         virtual void setRF_Profile(const uci::type::COMINT_CapabilityStatusMDT::RF_Profile& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         COMINT_CapabilityStatusMDT(const COMINT_CapabilityStatusMDT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this COMINT_CapabilityStatusMDT to the contents of the
           * COMINT_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator.COMINT_CapabilityStatusMDT [only
           * available to derived classes]
           *
           * @param rhs The COMINT_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::COMINT_CapabilityStatusMDT
           * @return A constant reference to this COMINT_CapabilityStatusMDT.
           */
         const COMINT_CapabilityStatusMDT& operator=(const COMINT_CapabilityStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__COMINT_CapabilityStatusMDT_h
