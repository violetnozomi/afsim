...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_CollectionConstraintsEnum_h
#define Uci__Type__PO_CollectionConstraintsEnum_h 1
   ...
   namespace type {
      ...
      public:
         ...
         enum EnumerationItem {
            ...
            enumNotSet,
            //  UCI_MAP_ANGLE's ordinal value */
            UCI_MAP_ANGLE,

            //  UCI_GRAZING_ANGLE's ordinal value */
            UCI_GRAZING_ANGLE,

            //  UCI_LOOKAHEAD_ANGLE's ordinal value */
            UCI_LOOKAHEAD_ANGLE,

            //  UCI_ELEVATION_ANGLE's ordinal value */
            UCI_ELEVATION_ANGLE,

            //  UCI_SLANT_RANGE's ordinal value */
            UCI_SLANT_RANGE,

            //  UCI_COLLECTION_PATTERN's ordinal value */
            UCI_COLLECTION_PATTERN,

            //  UCI_SUN_ELEVATION's ordinal value */
            UCI_SUN_ELEVATION,

            //  UCI_SUN_AZIMUTH's ordinal value */
            UCI_SUN_AZIMUTH,

            //  UCI_SWEEP_SPEED's ordinal value */
            UCI_SWEEP_SPEED,
         ...
         /** The destructor */
         virtual ~PO_CollectionConstraintsEnum()
         { }
         ...
         /** The assignment operator. Sets the contents of this PO_CollectionConstraintsEnum to the contents of the
           * PO_CollectionConstraintsEnum on the right hand side (rhs) of the assignment operator.PO_CollectionConstraintsEnum
           *
           ...
           * @return A constant reference to this PO_CollectionConstraintsEnum.
           */
         const PO_CollectionConstraintsEnum& operator=(const PO_CollectionConstraintsEnum& rhs)
         {
         ...
         /** The assignment operator. Sets the value of this PO_CollectionConstraintsEnum enumeration to the EnumerationItem on
           * the right hand side of the assignment operator.
           *
           * @param rhs The EnumerationItemwhose value is to be assigned to this PO_CollectionConstraintsEnum enumeration
           * @return A reference to this PO_CollectionConstraintsEnum enumeration
           */
         const PO_CollectionConstraintsEnum& operator=(EnumerationItem rhs)
         {
            setValue(rhs);
            return *this;
         }
         ...
         /** Sets the value of this PO_CollectionConstraintsEnum enumeration to the value of the specified enumeration item.
           *
           * @param item The EnumerationItemwhose value is to be used to set the value of this PO_CollectionConstraintsEnum
           *      enumeration
           */
...
#endif // Uci__Type__PO_CollectionConstraintsEnum_h
