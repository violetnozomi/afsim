...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__StrikeCommandReader_h
#define Uci__Reader__StrikeCommandReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The StrikeCommandListener provides the support to listen and handle incoming messages of the type
        * uci::type::StrikeCommand
        */
      class StrikeCommandListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~StrikeCommandListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::StrikeCommand& message)
            throw(uci::base::UCIException) = 0;


      }; // StrikeCommandListener


      /** The Reader provides the support to reader incoming messages. */
      class StrikeCommandReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~StrikeCommandReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(StrikeCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(StrikeCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, StrikeCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, StrikeCommandListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The StrikeCommandReader to copy from
           */
         StrikeCommandReader(const StrikeCommandReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this StrikeCommandReader to the contents of the StrikeCommandReader on
           * the right hand side (rhs) of the assignment operator.StrikeCommandReader [only available to derived classes]
           *
           * @param rhs The StrikeCommandReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this StrikeCommandReader
           * @return A constant reference to this StrikeCommandReader.
           */
         const StrikeCommandReader& operator=(const StrikeCommandReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__StrikeCommandReader_h
