...
*    Directive 5230.25.
*/
#ifndef Uci__Base__BoundedList_h
#define Uci__Base__BoundedList_h 1
...
namespace uci {
   ...
   namespace base {
      ...
      public:
         ...
         /** The UNBOUNDED_BOUND is the maximum size of a bounded list. If the valud returned by the getMaximumOccurs() method
           * equals this value, then no bounds were specified in the XSD specification and this list is bounded simply by natural
           * indexing.
           */
         static const size_type UNBOUNDED_BOUND = ULONG_MAX;
         ...
         /** The returns this boundedList's "maxOccurs" as specified in the XML Schema specification.
           ...
           */
         virtual size_type getMaximumOccurs() const
            throw() = 0;
         ...
         /** The returns this boundedList's "minOccurs" as specified in the XML Schema specification.
           ...
           */
         virtual size_type getMinimumOccurs() const
            throw() = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this BoundedList<T,V> to the contents of the BoundedList<T,V> on the
           * right hand side (rhs) of the assignment operator.BoundedList<T,V> [only available to derived classes]
           *
           * @param rhs The BoundedList<T,V> on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::base::BoundedList<T,V>
           * @return A constant reference to this BoundedList<T,V>.
           */
         const BoundedList<T,V>& operator=(const BoundedList<T,V>& rhs)
         {
            (void)rhs;
...
#endif // Uci__Base__BoundedList_h
