...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SystemApproverType_h
#define Uci__Type__SystemApproverType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SystemApproverType sequence accessor class */
      class SystemApproverType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~SystemApproverType()
         { }

         /** Returns this accessor's type constant, i.e. SystemApproverType
           *
           * @return This accessor's type constant, i.e. SystemApproverType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::systemApproverType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SystemApproverType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The SystemApproverType to copy from
           */
         SystemApproverType(const SystemApproverType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SystemApproverType to the contents of the SystemApproverType on
           * the right hand side (rhs) of the assignment operator.SystemApproverType [only available to derived classes]
           *
           * @param rhs The SystemApproverType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::SystemApproverType
           * @return A constant reference to this SystemApproverType.
           */
         const SystemApproverType& operator=(const SystemApproverType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SystemApproverType_h
