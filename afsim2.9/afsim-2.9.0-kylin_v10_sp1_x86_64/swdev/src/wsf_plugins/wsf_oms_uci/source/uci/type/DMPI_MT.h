...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DMPI_MT_h
#define Uci__Type__DMPI_MT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class DMPI_MT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. DMPI_MT
           *
           * @return This accessor's type constant, i.e. DMPI_MT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::dMPI_MT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DMPI_MT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::DMPI_MDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::DMPI_MDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::DMPI_MDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DMPI_MT to copy from
           */
         DMPI_MT(const DMPI_MT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DMPI_MT to the contents of the DMPI_MT on the right hand side
           * (rhs) of the assignment operator.DMPI_MT [only available to derived classes]
           *
           * @param rhs The DMPI_MT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::DMPI_MT
           * @return A constant reference to this DMPI_MT.
           */
         const DMPI_MT& operator=(const DMPI_MT& rhs)
         {
            (void)rhs;
