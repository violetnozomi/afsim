...
*    Directive 5230.25.
*/
#ifndef Uci__Type__AMTI_CapabilityOptionsType_h
#define Uci__Type__AMTI_CapabilityOptionsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the AMTI_CapabilityOptionsType sequence accessor class */
      class AMTI_CapabilityOptionsType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~AMTI_CapabilityOptionsType()
         { }

         /** Returns this accessor's type constant, i.e. AMTI_CapabilityOptionsType
           *
           * @return This accessor's type constant, i.e. AMTI_CapabilityOptionsType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::aMTI_CapabilityOptionsType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const AMTI_CapabilityOptionsType& accessor)
         ...
         /** Returns the bounded list that is identified by the ElectronicProtectionOptionsSupported.
           ...
           */
         virtual const uci::type::AMTI_CapabilityOptionsType::ElectronicProtectionOptionsSupported& getElectronicProtectionOptionsSupported() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ElectronicProtectionOptionsSupported.
           ...
           * @return The bounded list identified by ElectronicProtectionOptionsSupported.
           */
         virtual uci::type::AMTI_CapabilityOptionsType::ElectronicProtectionOptionsSupported& getElectronicProtectionOptionsSupported()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ElectronicProtectionOptionsSupported.
           ...
           *      accessor
           */
         virtual void setElectronicProtectionOptionsSupported(const uci::type::AMTI_CapabilityOptionsType::ElectronicProtectionOptionsSupported& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         AMTI_CapabilityOptionsType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The AMTI_CapabilityOptionsType to copy from
           */
         AMTI_CapabilityOptionsType(const AMTI_CapabilityOptionsType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this AMTI_CapabilityOptionsType to the contents of the
           * AMTI_CapabilityOptionsType on the right hand side (rhs) of the assignment operator.AMTI_CapabilityOptionsType [only
           * available to derived classes]
           *
           * @param rhs The AMTI_CapabilityOptionsType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::AMTI_CapabilityOptionsType
           * @return A constant reference to this AMTI_CapabilityOptionsType.
           */
         const AMTI_CapabilityOptionsType& operator=(const AMTI_CapabilityOptionsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__AMTI_CapabilityOptionsType_h
