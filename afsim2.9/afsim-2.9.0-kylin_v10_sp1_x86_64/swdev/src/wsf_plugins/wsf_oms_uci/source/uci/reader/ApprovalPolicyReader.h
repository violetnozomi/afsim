...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__ApprovalPolicyReader_h
#define Uci__Reader__ApprovalPolicyReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The ApprovalPolicyListener provides the support to listen and handle incoming messages of the type
        * uci::type::ApprovalPolicy
        */
      class ApprovalPolicyListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~ApprovalPolicyListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::ApprovalPolicy& message)
            throw(uci::base::UCIException) = 0;


      }; // ApprovalPolicyListener


      /** The Reader provides the support to reader incoming messages. */
      class ApprovalPolicyReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~ApprovalPolicyReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(ApprovalPolicyListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(ApprovalPolicyListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, ApprovalPolicyListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, ApprovalPolicyListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ApprovalPolicyReader to copy from
           */
         ApprovalPolicyReader(const ApprovalPolicyReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ApprovalPolicyReader to the contents of the ApprovalPolicyReader
           * on the right hand side (rhs) of the assignment operator.ApprovalPolicyReader [only available to derived classes]
           *
           * @param rhs The ApprovalPolicyReader on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this ApprovalPolicyReader
           * @return A constant reference to this ApprovalPolicyReader.
           */
         const ApprovalPolicyReader& operator=(const ApprovalPolicyReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__ApprovalPolicyReader_h
