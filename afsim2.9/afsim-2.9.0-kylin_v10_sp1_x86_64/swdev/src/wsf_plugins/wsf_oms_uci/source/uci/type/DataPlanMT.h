...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DataPlanMT_h
#define Uci__Type__DataPlanMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class DataPlanMT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. DataPlanMT
           *
           * @return This accessor's type constant, i.e. DataPlanMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::dataPlanMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DataPlanMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::DataPlanMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::DataPlanMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::DataPlanMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DataPlanMT to copy from
           */
         DataPlanMT(const DataPlanMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DataPlanMT to the contents of the DataPlanMT on the right hand
           * side (rhs) of the assignment operator.DataPlanMT [only available to derived classes]
           *
           * @param rhs The DataPlanMT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::DataPlanMT
           * @return A constant reference to this DataPlanMT.
           */
         const DataPlanMT& operator=(const DataPlanMT& rhs)
         {
            (void)rhs;
