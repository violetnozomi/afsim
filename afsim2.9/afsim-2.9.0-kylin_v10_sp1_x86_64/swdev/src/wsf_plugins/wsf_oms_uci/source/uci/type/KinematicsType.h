...
*    Directive 5230.25.
*/
#ifndef Uci__Type__KinematicsType_h
#define Uci__Type__KinematicsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the KinematicsType sequence accessor class */
      class KinematicsType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~KinematicsType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const KinematicsType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this KinematicsType to the contents of the KinematicsType on the right
           * hand side (rhs) of the assignment operator.KinematicsType [only available to derived classes]
           *
           * @param rhs The KinematicsType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::KinematicsType
           * @return A constant reference to this KinematicsType.
           */
         const KinematicsType& operator=(const KinematicsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__KinematicsType_h
