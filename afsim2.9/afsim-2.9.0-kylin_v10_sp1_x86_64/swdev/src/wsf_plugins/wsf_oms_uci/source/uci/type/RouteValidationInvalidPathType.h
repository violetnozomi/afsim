...
*    Directive 5230.25.
*/
#ifndef Uci__Type__RouteValidationInvalidPathType_h
#define Uci__Type__RouteValidationInvalidPathType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the RouteValidationInvalidPathType sequence accessor class */
      class RouteValidationInvalidPathType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~RouteValidationInvalidPathType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const RouteValidationInvalidPathType& accessor)
            throw(uci::base::UCIException) = 0;


         /** This element identifies segments that were found to be invalid. [Minimum occurrences: 0] [Maximum occurrences:
           * 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the InvalidSegment.
           *
           * @return The bounded list identified by InvalidSegment.
           */
         virtual const uci::type::RouteValidationInvalidPathType::InvalidSegment& getInvalidSegment() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the InvalidSegment.
           ...
           * @return The bounded list identified by InvalidSegment.
           */
         virtual uci::type::RouteValidationInvalidPathType::InvalidSegment& getInvalidSegment()
            throw(uci::base::UCIException) = 0;


         /** Sets the bounded list that is identified by the InvalidSegment.
           *
           * @param value The bounded list whose contents are to be used to set the value of the bounded list accessed by this
           *      accessor
           */
         virtual void setInvalidSegment(const uci::type::RouteValidationInvalidPathType::InvalidSegment& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this RouteValidationInvalidPathType to the contents of the
           * RouteValidationInvalidPathType on the right hand side (rhs) of the assignment operator.RouteValidationInvalidPathType
           * [only available to derived classes]
           *
           * @param rhs The RouteValidationInvalidPathType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::RouteValidationInvalidPathType
           * @return A constant reference to this RouteValidationInvalidPathType.
           */
         const RouteValidationInvalidPathType& operator=(const RouteValidationInvalidPathType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__RouteValidationInvalidPathType_h
