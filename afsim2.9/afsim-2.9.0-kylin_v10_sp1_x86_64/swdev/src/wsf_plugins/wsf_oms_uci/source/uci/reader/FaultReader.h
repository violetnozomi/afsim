...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__FaultReader_h
#define Uci__Reader__FaultReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The FaultListener provides the support to listen and handle incoming messages of the type uci::type::Fault */
      class FaultListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::Fault& message)
      ...
      class FaultReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(FaultListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(FaultListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, FaultListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, FaultListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The FaultReader to copy from
           */
         FaultReader(const FaultReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this FaultReader to the contents of the FaultReader on the right hand
           * side (rhs) of the assignment operator.FaultReader [only available to derived classes]
           *
           * @param rhs The FaultReader on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this FaultReader
           * @return A constant reference to this FaultReader.
           */
         const FaultReader& operator=(const FaultReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__FaultReader_h
