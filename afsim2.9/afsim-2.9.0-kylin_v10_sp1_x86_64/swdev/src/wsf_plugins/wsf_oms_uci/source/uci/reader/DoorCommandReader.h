...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__DoorCommandReader_h
#define Uci__Reader__DoorCommandReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The DoorCommandListener provides the support to listen and handle incoming messages of the type
        * uci::type::DoorCommand
        */
      class DoorCommandListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~DoorCommandListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::DoorCommand& message)
      ...
      class DoorCommandReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~DoorCommandReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(DoorCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(DoorCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, DoorCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, DoorCommandListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DoorCommandReader to copy from
           */
         DoorCommandReader(const DoorCommandReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DoorCommandReader to the contents of the DoorCommandReader on the
           * right hand side (rhs) of the assignment operator.DoorCommandReader [only available to derived classes]
           *
           * @param rhs The DoorCommandReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this DoorCommandReader
           * @return A constant reference to this DoorCommandReader.
           */
         const DoorCommandReader& operator=(const DoorCommandReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__DoorCommandReader_h
