...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__TurretCommandReader_h
#define Uci__Reader__TurretCommandReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The TurretCommandListener provides the support to listen and handle incoming messages of the type
        * uci::type::TurretCommand
        */
      class TurretCommandListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~TurretCommandListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::TurretCommand& message)
            throw(uci::base::UCIException) = 0;


      }; // TurretCommandListener


      /** The Reader provides the support to reader incoming messages. */
      class TurretCommandReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~TurretCommandReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(TurretCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(TurretCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, TurretCommandListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, TurretCommandListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The TurretCommandReader to copy from
           */
         TurretCommandReader(const TurretCommandReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this TurretCommandReader to the contents of the TurretCommandReader on
           * the right hand side (rhs) of the assignment operator.TurretCommandReader [only available to derived classes]
           *
           * @param rhs The TurretCommandReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this TurretCommandReader
           * @return A constant reference to this TurretCommandReader.
           */
         const TurretCommandReader& operator=(const TurretCommandReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__TurretCommandReader_h
