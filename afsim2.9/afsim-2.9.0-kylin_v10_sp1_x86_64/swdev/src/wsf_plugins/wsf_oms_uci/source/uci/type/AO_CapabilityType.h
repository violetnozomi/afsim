...
*    Directive 5230.25.
*/
#ifndef Uci__Type__AO_CapabilityType_h
#define Uci__Type__AO_CapabilityType_h 1
...
#if !defined(Uci__Type__AO_MessageOutputsEnum_h)
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the AO_CapabilityType sequence accessor class */
      class AO_CapabilityType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~AO_CapabilityType()
         { }

         /** Returns this accessor's type constant, i.e. AO_CapabilityType
           *
           * @return This accessor's type constant, i.e. AO_CapabilityType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::aO_CapabilityType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const AO_CapabilityType& accessor)
         ...
         /** Indicates a command and control relevant Subsystem Component associated with the Capability. Multiple Capabilities
           * can use the same Component. [Minimum occurrences: 0] [Maximum occurrences: 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the AcceptedInterface.
           ...
           */
         virtual const uci::type::AO_CapabilityType::AcceptedInterface& getAcceptedInterface() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the AcceptedInterface.
           ...
           * @return The bounded list identified by AcceptedInterface.
           */
         virtual uci::type::AO_CapabilityType::AcceptedInterface& getAcceptedInterface()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the AcceptedInterface.
           ...
           *      accessor
           */
         virtual void setAcceptedInterface(const uci::type::AO_CapabilityType::AcceptedInterface& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the CapabilityOptions.
           ...
           */
         virtual const uci::type::AO_CapabilityOptionsType& getCapabilityOptions() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the CapabilityOptions.
           ...
           * @return The acecssor that provides access to the complex content that is identified by CapabilityOptions.
           */
         virtual uci::type::AO_CapabilityOptionsType& getCapabilityOptions()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the CapabilityOptions to the contents of the complex content that is
           ...
           */
         virtual void setCapabilityOptions(const uci::type::AO_CapabilityOptionsType& value)
            throw(uci::base::UCIException) = 0;


         /** Returns the value of the SimplePrimitive data type that is identified by the EyeSafe.
           *
           * @return The value of the simple primitive data type identified by EyeSafe.
           */
         virtual xs::Boolean getEyeSafe() const
            throw(uci::base::UCIException) = 0;


         /** Sets the value of the SimplePrimitive data type that is identified by the EyeSafe.
           *
           * @param value The value to set the SimplePrimitve data type to
           */
         virtual void setEyeSafe(xs::Boolean value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the AssociatedComponentID.
           ...
           */
         virtual const uci::type::AO_CapabilityType::AssociatedComponentID& getAssociatedComponentID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the AssociatedComponentID.
           ...
           * @return The bounded list identified by AssociatedComponentID.
           */
         virtual uci::type::AO_CapabilityType::AssociatedComponentID& getAssociatedComponentID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the AssociatedComponentID.
           ...
           *      accessor
           */
         virtual void setAssociatedComponentID(const uci::type::AO_CapabilityType::AssociatedComponentID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           */
         virtual const uci::type::AO_CapabilityType::ProductOutput& getProductOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           * @return The bounded list identified by ProductOutput.
           */
         virtual uci::type::AO_CapabilityType::ProductOutput& getProductOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ProductOutput.
           ...
           *      accessor
           */
         virtual void setProductOutput(const uci::type::AO_CapabilityType::ProductOutput& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the MessageOutput.
           ...
           */
         virtual const uci::type::AO_MessageOutputsEnum& getMessageOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the MessageOutput.
           ...
           * @return The value of the enumeration identified by MessageOutput.
           */
         virtual uci::type::AO_MessageOutputsEnum& getMessageOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the MessageOutput.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setMessageOutput(const uci::type::AO_MessageOutputsEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the MessageOutput.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setMessageOutput(uci::type::AO_MessageOutputsEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the optional field such that getMessageOutput will return the optional field and not throw an exception when
           * invoked.
           *
           * @param type = uci::type::accessorType::aO_MessageOutputsEnum This Accessor's accessor type
           */
         virtual void enableMessageOutput(uci::base::accessorType::AccessorType type = uci::type::accessorType::aO_MessageOutputsEnum)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         AO_CapabilityType(const AO_CapabilityType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this AO_CapabilityType to the contents of the AO_CapabilityType on the
           * right hand side (rhs) of the assignment operator.AO_CapabilityType [only available to derived classes]
           *
           * @param rhs The AO_CapabilityType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::AO_CapabilityType
           * @return A constant reference to this AO_CapabilityType.
           */
         const AO_CapabilityType& operator=(const AO_CapabilityType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__AO_CapabilityType_h
