...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DataPlanEffectivityStateType_h
#define Uci__Type__DataPlanEffectivityStateType_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DataPlanEffectivityStateType& accessor)
            throw(uci::base::UCIException) = 0;


         /** The Configuration states owned by this DataPlan Effectivity [Minimum occurrences: 0] [Maximum occurrences:
           * 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the EffectivityConfiguration.
           ...
           */
         virtual const uci::type::DataPlanEffectivityStateType::EffectivityConfiguration& getEffectivityConfiguration() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the EffectivityConfiguration.
           ...
           * @return The bounded list identified by EffectivityConfiguration.
           */
         virtual uci::type::DataPlanEffectivityStateType::EffectivityConfiguration& getEffectivityConfiguration()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the EffectivityConfiguration.
           ...
           *      accessor
           */
         virtual void setEffectivityConfiguration(const uci::type::DataPlanEffectivityStateType::EffectivityConfiguration& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this DataPlanEffectivityStateType to the contents of the
           * DataPlanEffectivityStateType on the right hand side (rhs) of the assignment operator.DataPlanEffectivityStateType
           * [only available to derived classes]
           *
           * @param rhs The DataPlanEffectivityStateType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::DataPlanEffectivityStateType
           * @return A constant reference to this DataPlanEffectivityStateType.
           */
         const DataPlanEffectivityStateType& operator=(const DataPlanEffectivityStateType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DataPlanEffectivityStateType_h
