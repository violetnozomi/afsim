...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SMTI_SpecificDataType_h
#define Uci__Type__SMTI_SpecificDataType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SMTI_SpecificDataType sequence accessor class */
      class SMTI_SpecificDataType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~SMTI_SpecificDataType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SMTI_SpecificDataType& accessor)
         ...
         /** Enables the optional field such that getCapabilityType will return the optional field and not throw an exception when
           * invoked.
           *
           * @param type = uci::type::accessorType::sMTI_CapabilityEnum This Accessor's accessor type
           */
         virtual void enableCapabilityType(uci::base::accessorType::AccessorType type = uci::type::accessorType::sMTI_CapabilityEnum)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the optional field such that getSubCapabilityType will return the optional field and not throw an exception
           ...
           */
         virtual void enableSubCapabilityType(uci::base::accessorType::AccessorType type = uci::type::accessorType::sMTI_SubCapabilityEnum)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SMTI_SpecificDataType to the contents of the SMTI_SpecificDataType
           * on the right hand side (rhs) of the assignment operator.SMTI_SpecificDataType [only available to derived classes]
           *
           * @param rhs The SMTI_SpecificDataType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::SMTI_SpecificDataType
           * @return A constant reference to this SMTI_SpecificDataType.
           */
         const SMTI_SpecificDataType& operator=(const SMTI_SpecificDataType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SMTI_SpecificDataType_h
