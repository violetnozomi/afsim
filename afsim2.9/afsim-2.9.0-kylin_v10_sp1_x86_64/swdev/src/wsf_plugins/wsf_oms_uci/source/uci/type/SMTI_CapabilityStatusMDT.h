...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SMTI_CapabilityStatusMDT_h
#define Uci__Type__SMTI_CapabilityStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SMTI_CapabilityStatusMDT sequence accessor class */
      class SMTI_CapabilityStatusMDT : public virtual uci::type::CapabilityStatusBaseType {
      public:

         /** The destructor */
         virtual ~SMTI_CapabilityStatusMDT()
         { }

         /** Returns this accessor's type constant, i.e. SMTI_CapabilityStatusMDT
           *
           * @return This accessor's type constant, i.e. SMTI_CapabilityStatusMDT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::sMTI_CapabilityStatusMDT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SMTI_CapabilityStatusMDT& accessor)
         ...
         /** Indicates a message that is currently an output of the Capability. See enumerated type annotations for details.
         ...
         /** Returns the bounded list that is identified by the CapabilityStatus.
           ...
           */
         virtual const uci::type::SMTI_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CapabilityStatus.
           ...
           * @return The bounded list identified by CapabilityStatus.
           */
         virtual uci::type::SMTI_CapabilityStatusMDT::CapabilityStatus& getCapabilityStatus()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the CapabilityStatus.
           ...
           *      accessor
           */
         virtual void setCapabilityStatus(const uci::type::SMTI_CapabilityStatusMDT::CapabilityStatus& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the RF_Profile.
           ...
           */
         virtual const uci::type::SMTI_CapabilityStatusMDT::RF_Profile& getRF_Profile() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the RF_Profile.
           ...
           * @return The bounded list identified by RF_Profile.
           */
         virtual uci::type::SMTI_CapabilityStatusMDT::RF_Profile& getRF_Profile()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the RF_Profile.
           ...
           *      accessor
           */
         virtual void setRF_Profile(const uci::type::SMTI_CapabilityStatusMDT::RF_Profile& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the MessageOutput.
           ...
           */
         virtual const uci::type::SMTI_CapabilityStatusMDT::MessageOutput& getMessageOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the MessageOutput.
           ...
           * @return The bounded list identified by MessageOutput.
           */
         virtual uci::type::SMTI_CapabilityStatusMDT::MessageOutput& getMessageOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the MessageOutput.
           ...
           *      accessor
           */
         virtual void setMessageOutput(const uci::type::SMTI_CapabilityStatusMDT::MessageOutput& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the DefaultPackingPlan.
           ...
           */
         virtual const uci::type::STANAG_4607_PackingPlanType& getDefaultPackingPlan() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the DefaultPackingPlan.
           ...
           * @return The acecssor that provides access to the complex content that is identified by DefaultPackingPlan.
           */
         virtual uci::type::STANAG_4607_PackingPlanType& getDefaultPackingPlan()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the DefaultPackingPlan to the contents of the complex content that is
           ...
           */
         virtual void setDefaultPackingPlan(const uci::type::STANAG_4607_PackingPlanType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by DefaultPackingPlan
           ...
           */
         virtual void enableDefaultPackingPlan(uci::base::accessorType::AccessorType type = uci::type::accessorType::sTANAG_4607_PackingPlanType)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ElectronicProtectionOptionsEnabled.
           ...
           */
         virtual const uci::type::SMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& getElectronicProtectionOptionsEnabled() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ElectronicProtectionOptionsEnabled.
           ...
           * @return The bounded list identified by ElectronicProtectionOptionsEnabled.
           */
         virtual uci::type::SMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& getElectronicProtectionOptionsEnabled()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ElectronicProtectionOptionsEnabled.
           ...
           *      accessor
           */
         virtual void setElectronicProtectionOptionsEnabled(const uci::type::SMTI_CapabilityStatusMDT::ElectronicProtectionOptionsEnabled& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         SMTI_CapabilityStatusMDT(const SMTI_CapabilityStatusMDT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SMTI_CapabilityStatusMDT to the contents of the
           * SMTI_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator.SMTI_CapabilityStatusMDT [only
           * available to derived classes]
           *
           * @param rhs The SMTI_CapabilityStatusMDT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::SMTI_CapabilityStatusMDT
           * @return A constant reference to this SMTI_CapabilityStatusMDT.
           */
         const SMTI_CapabilityStatusMDT& operator=(const SMTI_CapabilityStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SMTI_CapabilityStatusMDT_h
