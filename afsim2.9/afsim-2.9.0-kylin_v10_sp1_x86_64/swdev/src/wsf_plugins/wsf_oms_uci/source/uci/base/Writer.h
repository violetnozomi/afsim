...
*    Directive 5230.25.
*/
#ifndef Uci__Base__Writer_h
#define Uci__Base__Writer_h 1
...
namespace uci {
   ...
   namespace base {
      ...
      /** The Writer base class provides a mechanism to group writer objects into collections. */
      class Writer {
      public:
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this Writer to the contents of the Writer on the right hand side (rhs)
           * of the assignment operator.Writer [only available to derived classes]
           *
           * @param rhs The Writer on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::base::Writer
           * @return A constant reference to this Writer.
           */
