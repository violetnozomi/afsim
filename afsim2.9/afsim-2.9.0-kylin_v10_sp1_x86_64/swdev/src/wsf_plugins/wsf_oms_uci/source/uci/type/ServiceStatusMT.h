...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ServiceStatusMT_h
#define Uci__Type__ServiceStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class ServiceStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~ServiceStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. ServiceStatusMT
           *
           * @return This accessor's type constant, i.e. ServiceStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::serviceStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ServiceStatusMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::ServiceStatusMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::ServiceStatusMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::ServiceStatusMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ServiceStatusMT to the contents of the ServiceStatusMT on the
           * right hand side (rhs) of the assignment operator.ServiceStatusMT [only available to derived classes]
           *
           * @param rhs The ServiceStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::ServiceStatusMT
           * @return A constant reference to this ServiceStatusMT.
           */
         const ServiceStatusMT& operator=(const ServiceStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ServiceStatusMT_h
