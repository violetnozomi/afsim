...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__SystemStatusReader_h
#define Uci__Reader__SystemStatusReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The SystemStatusListener provides the support to listen and handle incoming messages of the type
        * uci::type::SystemStatus
        */
      class SystemStatusListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::SystemStatus& message)
      ...
      class SystemStatusReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~SystemStatusReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(SystemStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(SystemStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, SystemStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, SystemStatusListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The SystemStatusReader to copy from
           */
         SystemStatusReader(const SystemStatusReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SystemStatusReader to the contents of the SystemStatusReader on
           * the right hand side (rhs) of the assignment operator.SystemStatusReader [only available to derived classes]
           *
           * @param rhs The SystemStatusReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this SystemStatusReader
           * @return A constant reference to this SystemStatusReader.
           */
         const SystemStatusReader& operator=(const SystemStatusReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__SystemStatusReader_h
