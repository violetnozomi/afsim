...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__TurretReportReader_h
#define Uci__Reader__TurretReportReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The TurretReportListener provides the support to listen and handle incoming messages of the type
        * uci::type::TurretReport
        */
      class TurretReportListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~TurretReportListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::TurretReport& message)
            throw(uci::base::UCIException) = 0;


      }; // TurretReportListener


      /** The Reader provides the support to reader incoming messages. */
      class TurretReportReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~TurretReportReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(TurretReportListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(TurretReportListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, TurretReportListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, TurretReportListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The TurretReportReader to copy from
           */
         TurretReportReader(const TurretReportReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this TurretReportReader to the contents of the TurretReportReader on
           * the right hand side (rhs) of the assignment operator.TurretReportReader [only available to derived classes]
           *
           * @param rhs The TurretReportReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this TurretReportReader
           * @return A constant reference to this TurretReportReader.
           */
         const TurretReportReader& operator=(const TurretReportReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__TurretReportReader_h
