...
*    Directive 5230.25.
*/
#ifndef Uci__Type__FileLocationMT_h
#define Uci__Type__FileLocationMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class FileLocationMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~FileLocationMT()
         { }

         /** Returns this accessor's type constant, i.e. FileLocationMT
           *
           * @return This accessor's type constant, i.e. FileLocationMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::fileLocationMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const FileLocationMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::FileLocationMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::FileLocationMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::FileLocationMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The FileLocationMT to copy from
           */
         FileLocationMT(const FileLocationMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this FileLocationMT to the contents of the FileLocationMT on the right
           * hand side (rhs) of the assignment operator.FileLocationMT [only available to derived classes]
           *
           * @param rhs The FileLocationMT on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::FileLocationMT
           * @return A constant reference to this FileLocationMT.
           */
         const FileLocationMT& operator=(const FileLocationMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__FileLocationMT_h
