...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PulseDataSourceType_h
#define Uci__Type__PulseDataSourceType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PulseDataSourceType sequence accessor class */
      class PulseDataSourceType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~PulseDataSourceType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PulseDataSourceType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Indicates an Activity that collected the PulseData. [Minimum occurrences: 0] [Maximum occurrences:
           * 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the ActivityID.
           ...
           */
         virtual const uci::type::PulseDataSourceType::ActivityID& getActivityID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ActivityID.
           ...
           * @return The bounded list identified by ActivityID.
           */
         virtual uci::type::PulseDataSourceType::ActivityID& getActivityID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ActivityID.
           ...
           *      accessor
           */
         virtual void setActivityID(const uci::type::PulseDataSourceType::ActivityID& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this PulseDataSourceType to the contents of the PulseDataSourceType on
           * the right hand side (rhs) of the assignment operator.PulseDataSourceType [only available to derived classes]
           *
           * @param rhs The PulseDataSourceType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::PulseDataSourceType
           * @return A constant reference to this PulseDataSourceType.
           */
         const PulseDataSourceType& operator=(const PulseDataSourceType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PulseDataSourceType_h
