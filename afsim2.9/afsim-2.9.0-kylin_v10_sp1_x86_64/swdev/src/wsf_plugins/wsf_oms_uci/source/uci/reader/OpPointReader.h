...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__OpPointReader_h
#define Uci__Reader__OpPointReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The OpPointListener provides the support to listen and handle incoming messages of the type uci::type::OpPoint */
      class OpPointListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~OpPointListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::OpPoint& message)
      ...
      class OpPointReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~OpPointReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(OpPointListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(OpPointListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, OpPointListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, OpPointListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpPointReader to copy from
           */
         OpPointReader(const OpPointReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpPointReader to the contents of the OpPointReader on the right
           * hand side (rhs) of the assignment operator.OpPointReader [only available to derived classes]
           *
           * @param rhs The OpPointReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this OpPointReader
           * @return A constant reference to this OpPointReader.
           */
         const OpPointReader& operator=(const OpPointReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__OpPointReader_h
