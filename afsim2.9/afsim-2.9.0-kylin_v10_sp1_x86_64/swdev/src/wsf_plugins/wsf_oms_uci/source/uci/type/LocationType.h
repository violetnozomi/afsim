...
*    Directive 5230.25.
*/
#ifndef Uci__Type__LocationType_h
#define Uci__Type__LocationType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the LocationType choice accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const LocationType& accessor)
         ...
         /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           */
         virtual LocationTypeChoice getLocationTypeChoiceOrdinal() const
            throw(uci::base::UCIException) = 0;
         ...
         /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           *      base type.
           */
         virtual void setLocationTypeChoiceOrdinal(LocationTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this LocationType to the contents of the LocationType on the right hand
           * side (rhs) of the assignment operator.LocationType [only available to derived classes]
           *
           * @param rhs The LocationType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::LocationType
           * @return A constant reference to this LocationType.
           */
         const LocationType& operator=(const LocationType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__LocationType_h
