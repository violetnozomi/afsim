...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_ComponentLensAssemblyType_h
#define Uci__Type__PO_ComponentLensAssemblyType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_ComponentLensAssemblyType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_ComponentLensAssemblyType& accessor)
         ...
         /** Returns the bounded list that is identified by the FPA_ID.
           ...
           */
         virtual const uci::type::PO_ComponentLensAssemblyType::FPA_ID& getFPA_ID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the FPA_ID.
           ...
           * @return The bounded list identified by FPA_ID.
           */
         virtual uci::type::PO_ComponentLensAssemblyType::FPA_ID& getFPA_ID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the FPA_ID.
           ...
           *      accessor
           */
         virtual void setFPA_ID(const uci::type::PO_ComponentLensAssemblyType::FPA_ID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the FOV.
           ...
           */
         virtual const uci::type::PO_ComponentLensAssemblyFieldOfViewType& getFOV() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the FOV.
           ...
           * @return The acecssor that provides access to the complex content that is identified by FOV.
           */
         virtual uci::type::PO_ComponentLensAssemblyFieldOfViewType& getFOV()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the FOV to the contents of the complex content that is accessed by the
           ...
           */
         virtual void setFOV(const uci::type::PO_ComponentLensAssemblyFieldOfViewType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Focus.
           ...
           */
         virtual const uci::type::PO_ComponentLensAssemblyFocusType& getFocus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Focus.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Focus.
           */
         virtual uci::type::PO_ComponentLensAssemblyFocusType& getFocus()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Focus to the contents of the complex content that is accessed by
           ...
           */
         virtual void setFocus(const uci::type::PO_ComponentLensAssemblyFocusType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by Focus
           *
           * @param type = uci::type::accessorType::pO_ComponentLensAssemblyFocusType This Accessor's accessor type
           */
         virtual void enableFocus(uci::base::accessorType::AccessorType type = uci::type::accessorType::pO_ComponentLensAssemblyFocusType)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this PO_ComponentLensAssemblyType to the contents of the
           * PO_ComponentLensAssemblyType on the right hand side (rhs) of the assignment operator.PO_ComponentLensAssemblyType
           * [only available to derived classes]
           *
           * @param rhs The PO_ComponentLensAssemblyType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::PO_ComponentLensAssemblyType
           * @return A constant reference to this PO_ComponentLensAssemblyType.
           */
         const PO_ComponentLensAssemblyType& operator=(const PO_ComponentLensAssemblyType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_ComponentLensAssemblyType_h
