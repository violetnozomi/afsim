...
*    Directive 5230.25.
*/
#ifndef Uci__Type__Point4D_Type_h
#define Uci__Type__Point4D_Type_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** Positional data relative to WGS-84 ellipsoid with latitude, longitude, altitude and time as mandatory entries. */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const Point4D_Type& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this Point4D_Type to the contents of the Point4D_Type on the right hand
           * side (rhs) of the assignment operator.Point4D_Type [only available to derived classes]
           *
           * @param rhs The Point4D_Type on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::Point4D_Type
           * @return A constant reference to this Point4D_Type.
           */
         const Point4D_Type& operator=(const Point4D_Type& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__Point4D_Type_h
