...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__EEIReader_h
#define Uci__Reader__EEIReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The EEIListener provides the support to listen and handle incoming messages of the type uci::type::EEI */
      class EEIListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::EEI& message)
      ...
      class EEIReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(EEIListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(EEIListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, EEIListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, EEIListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The EEIReader to copy from
           */
         EEIReader(const EEIReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this EEIReader to the contents of the EEIReader on the right hand side
           * (rhs) of the assignment operator.EEIReader [only available to derived classes]
           *
           * @param rhs The EEIReader on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this EEIReader
           * @return A constant reference to this EEIReader.
           */
         const EEIReader& operator=(const EEIReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__EEIReader_h
