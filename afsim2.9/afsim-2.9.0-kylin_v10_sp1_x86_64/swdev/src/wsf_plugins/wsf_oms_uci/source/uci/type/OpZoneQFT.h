...
*    Directive 5230.25.
*/
#ifndef Uci__Type__OpZoneQFT_h
#define Uci__Type__OpZoneQFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the OpZoneQFT sequence accessor class */
      class OpZoneQFT : public virtual uci::type::QueryFilterPET {
      public:
         ...
         /** Returns this accessor's type constant, i.e. OpZoneQFT
           *
           * @return This accessor's type constant, i.e. OpZoneQFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::opZoneQFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const OpZoneQFT& accessor)
            throw(uci::base::UCIException) = 0;


         /** Filter on the OpZone ID [Minimum occurrences: 0] [Maximum occurrences: 9223372036854775807] */
         ...
         /** Filter on the category of zone [Minimum occurrences: 0] [Maximum occurrences: 22] */
         ...
         /** Returns the bounded list that is identified by the OpZoneID.
           ...
           */
         virtual const uci::type::OpZoneQFT::OpZoneID& getOpZoneID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the OpZoneID.
           ...
           * @return The bounded list identified by OpZoneID.
           */
         virtual uci::type::OpZoneQFT::OpZoneID& getOpZoneID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the OpZoneID.
           ...
           *      accessor
           */
         virtual void setOpZoneID(const uci::type::OpZoneQFT::OpZoneID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the SystemID.
           ...
           */
         virtual const uci::type::OpZoneQFT::SystemID& getSystemID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the SystemID.
           ...
           * @return The bounded list identified by SystemID.
           */
         virtual uci::type::OpZoneQFT::SystemID& getSystemID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the SystemID.
           ...
           *      accessor
           */
         virtual void setSystemID(const uci::type::OpZoneQFT::SystemID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Category.
           ...
           */
         virtual const uci::type::OpZoneQFT::Category& getCategory() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Category.
           ...
           * @return The bounded list identified by Category.
           */
         virtual uci::type::OpZoneQFT::Category& getCategory()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Category.
           ...
           *      accessor
           */
         virtual void setCategory(const uci::type::OpZoneQFT::Category& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpZoneQFT to copy from
           */
         OpZoneQFT(const OpZoneQFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpZoneQFT to the contents of the OpZoneQFT on the right hand side
           * (rhs) of the assignment operator.OpZoneQFT [only available to derived classes]
           *
           * @param rhs The OpZoneQFT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::OpZoneQFT
           * @return A constant reference to this OpZoneQFT.
           */
         const OpZoneQFT& operator=(const OpZoneQFT& rhs)
         {
            (void)rhs;
