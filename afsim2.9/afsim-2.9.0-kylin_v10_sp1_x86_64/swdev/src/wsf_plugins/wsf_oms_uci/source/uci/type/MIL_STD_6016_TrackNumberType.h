...
*    Directive 5230.25.
*/
#ifndef Uci__Type__MIL_STD_6016_TrackNumberType_h
#define Uci__Type__MIL_STD_6016_TrackNumberType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** Link 16 19 bit Track Number ; [Pattern: "[A-HJ-NP-Z0-7]{2}[0-7]{3}"] */
      typedef xs::String MIL_STD_6016_TrackNumberType;

   } // Namespace: type
} // Namespace: uci

#endif // Uci__Type__MIL_STD_6016_TrackNumberType_h
