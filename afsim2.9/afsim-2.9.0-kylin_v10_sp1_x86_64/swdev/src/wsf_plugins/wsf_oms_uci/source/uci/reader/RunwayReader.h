...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__RunwayReader_h
#define Uci__Reader__RunwayReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The RunwayListener provides the support to listen and handle incoming messages of the type uci::type::Runway */
      class RunwayListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~RunwayListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::Runway& message)
      ...
      class RunwayReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~RunwayReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(RunwayListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(RunwayListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, RunwayListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, RunwayListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The RunwayReader to copy from
           */
         RunwayReader(const RunwayReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this RunwayReader to the contents of the RunwayReader on the right hand
           * side (rhs) of the assignment operator.RunwayReader [only available to derived classes]
           *
           * @param rhs The RunwayReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this RunwayReader
           * @return A constant reference to this RunwayReader.
           */
         const RunwayReader& operator=(const RunwayReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__RunwayReader_h
