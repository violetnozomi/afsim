...
*    Directive 5230.25.
*/
#ifndef Uci__Type__POST_ComponentStatusProcessingStageProcessingSettingsType_h
#define Uci__Type__POST_ComponentStatusProcessingStageProcessingSettingsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the POST_ComponentStatusProcessingStageProcessingSettingsType sequence accessor class */
      class POST_ComponentStatusProcessingStageProcessingSettingsType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~POST_ComponentStatusProcessingStageProcessingSettingsType()
         { }

         /** Returns this accessor's type constant, i.e. POST_ComponentStatusProcessingStageProcessingSettingsType
           *
           * @return This accessor's type constant, i.e. POST_ComponentStatusProcessingStageProcessingSettingsType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pOST_ComponentStatusProcessingStageProcessingSettingsType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const POST_ComponentStatusProcessingStageProcessingSettingsType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the HSB_ColorControlStatus.
           *
           * @return The acecssor that provides access to the complex content that is identified by HSB_ColorControlStatus.
           */
         virtual const uci::type::HSB_ColorControlType& getHSB_ColorControlStatus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the HSB_ColorControlStatus.
           ...
           * @return The acecssor that provides access to the complex content that is identified by HSB_ColorControlStatus.
           */
         virtual uci::type::HSB_ColorControlType& getHSB_ColorControlStatus()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the HSB_ColorControlStatus to the contents of the complex content that
           * is accessed by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by HSB_ColorControlStatus
           */
         virtual void setHSB_ColorControlStatus(const uci::type::HSB_ColorControlType& value)
            throw(uci::base::UCIException) = 0;


         /** Returns whether the Element that is identified by HSB_ColorControlStatus exists (is enabled) or not.
           *
           * @return A boolean indicating whether the Element identified by HSB_ColorControlStatus is emabled or not
           */
         virtual bool hasHSB_ColorControlStatus() const
            throw(uci::base::UCIException) = 0;


         /** Enables the Element that is identified by HSB_ColorControlStatus
           *
           * @param type = uci::type::accessorType::hSB_ColorControlType This Accessor's accessor type
           */
         virtual void enableHSB_ColorControlStatus(uci::base::accessorType::AccessorType type = uci::type::accessorType::hSB_ColorControlType)
            throw(uci::base::UCIException) = 0;


         /** Clears (disabled) the Element that is identified by HSB_ColorControlStatus */
         virtual void clearHSB_ColorControlStatus()
            throw(uci::base::UCIException) = 0;


         /** Returns the accessor that provides access to the complex content that is identified by the RGB_ColorControlStatus.
           *
           * @return The acecssor that provides access to the complex content that is identified by RGB_ColorControlStatus.
           */
         virtual const uci::type::RGB_ColorControlType& getRGB_ColorControlStatus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the RGB_ColorControlStatus.
           ...
           * @return The acecssor that provides access to the complex content that is identified by RGB_ColorControlStatus.
           */
         virtual uci::type::RGB_ColorControlType& getRGB_ColorControlStatus()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the RGB_ColorControlStatus to the contents of the complex content that
           * is accessed by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by RGB_ColorControlStatus
           */
         virtual void setRGB_ColorControlStatus(const uci::type::RGB_ColorControlType& value)
            throw(uci::base::UCIException) = 0;


         /** Returns whether the Element that is identified by RGB_ColorControlStatus exists (is enabled) or not.
           *
           * @return A boolean indicating whether the Element identified by RGB_ColorControlStatus is emabled or not
           */
         virtual bool hasRGB_ColorControlStatus() const
            throw(uci::base::UCIException) = 0;


         /** Enables the Element that is identified by RGB_ColorControlStatus
           *
           * @param type = uci::type::accessorType::rGB_ColorControlType This Accessor's accessor type
           */
         virtual void enableRGB_ColorControlStatus(uci::base::accessorType::AccessorType type = uci::type::accessorType::rGB_ColorControlType)
            throw(uci::base::UCIException) = 0;


         /** Clears (disabled) the Element that is identified by RGB_ColorControlStatus */
         virtual void clearRGB_ColorControlStatus()
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         POST_ComponentStatusProcessingStageProcessingSettingsType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The POST_ComponentStatusProcessingStageProcessingSettingsType to copy from
           */
         POST_ComponentStatusProcessingStageProcessingSettingsType(const POST_ComponentStatusProcessingStageProcessingSettingsType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this POST_ComponentStatusProcessingStageProcessingSettingsType to the
           * contents of the POST_ComponentStatusProcessingStageProcessingSettingsType on the right hand side (rhs) of the
           * assignment operator.POST_ComponentStatusProcessingStageProcessingSettingsType [only available to derived classes]
           *
           * @param rhs The POST_ComponentStatusProcessingStageProcessingSettingsType on the right hand side (rhs) of the
           *      assignment operator whose contents are used to set the contents of this
           *      uci::type::POST_ComponentStatusProcessingStageProcessingSettingsType
           * @return A constant reference to this POST_ComponentStatusProcessingStageProcessingSettingsType.
           */
         const POST_ComponentStatusProcessingStageProcessingSettingsType& operator=(const POST_ComponentStatusProcessingStageProcessingSettingsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__POST_ComponentStatusProcessingStageProcessingSettingsType_h
