...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ID_Type_h
#define Uci__Type__ID_Type_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ID_Type& accessor)
         ...
         /** Returns the UUID
           ...
           * @return The UUID
           */
         virtual const uci::base::UUID& getUUID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the UUID
           ...
           * @return The UUID
           */
         virtual uci::base::UUID& getUUID()
            throw(uci::base::UCIException) = 0;


         /** Sets the UUID
           *
           * @param value The UUID accessor.
           */
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ID_Type to the contents of the ID_Type on the right hand side
           * (rhs) of the assignment operator.ID_Type [only available to derived classes]
           *
           * @param rhs The ID_Type on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::ID_Type
           * @return A constant reference to this ID_Type.
           */
         const ID_Type& operator=(const ID_Type& rhs)
         {
            (void)rhs;
