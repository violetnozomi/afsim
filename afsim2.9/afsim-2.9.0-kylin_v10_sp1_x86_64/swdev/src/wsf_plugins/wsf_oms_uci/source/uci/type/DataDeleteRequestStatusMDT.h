...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DataDeleteRequestStatusMDT_h
#define Uci__Type__DataDeleteRequestStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the DataDeleteRequestStatusMDT sequence accessor class */
      class DataDeleteRequestStatusMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~DataDeleteRequestStatusMDT()
         { }

         /** Returns this accessor's type constant, i.e. DataDeleteRequestStatusMDT
           *
           * @return This accessor's type constant, i.e. DataDeleteRequestStatusMDT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::dataDeleteRequestStatusMDT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DataDeleteRequestStatusMDT& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DataDeleteRequestStatusMDT to copy from
           */
         DataDeleteRequestStatusMDT(const DataDeleteRequestStatusMDT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DataDeleteRequestStatusMDT to the contents of the
           * DataDeleteRequestStatusMDT on the right hand side (rhs) of the assignment operator.DataDeleteRequestStatusMDT [only
           * available to derived classes]
           *
           * @param rhs The DataDeleteRequestStatusMDT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::DataDeleteRequestStatusMDT
           * @return A constant reference to this DataDeleteRequestStatusMDT.
           */
         const DataDeleteRequestStatusMDT& operator=(const DataDeleteRequestStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DataDeleteRequestStatusMDT_h
