...
*    Directive 5230.25.
*/
#ifndef Uci__Type__OpZoneMT_h
#define Uci__Type__OpZoneMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class OpZoneMT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. OpZoneMT
           *
           * @return This accessor's type constant, i.e. OpZoneMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::opZoneMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const OpZoneMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::OpZoneMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::OpZoneMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::OpZoneMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpZoneMT to copy from
           */
         OpZoneMT(const OpZoneMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpZoneMT to the contents of the OpZoneMT on the right hand side
           * (rhs) of the assignment operator.OpZoneMT [only available to derived classes]
           *
           * @param rhs The OpZoneMT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::OpZoneMT
           * @return A constant reference to this OpZoneMT.
           */
         const OpZoneMT& operator=(const OpZoneMT& rhs)
         {
            (void)rhs;
