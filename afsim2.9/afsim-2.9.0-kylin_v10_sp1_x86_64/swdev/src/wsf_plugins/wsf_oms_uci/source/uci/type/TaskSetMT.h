...
*    Directive 5230.25.
*/
#ifndef Uci__Type__TaskSetMT_h
#define Uci__Type__TaskSetMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class TaskSetMT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. TaskSetMT
           *
           * @return This accessor's type constant, i.e. TaskSetMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::taskSetMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const TaskSetMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::TaskSetMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::TaskSetMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::TaskSetMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The TaskSetMT to copy from
           */
         TaskSetMT(const TaskSetMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this TaskSetMT to the contents of the TaskSetMT on the right hand side
           * (rhs) of the assignment operator.TaskSetMT [only available to derived classes]
           *
           * @param rhs The TaskSetMT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::TaskSetMT
           * @return A constant reference to this TaskSetMT.
           */
         const TaskSetMT& operator=(const TaskSetMT& rhs)
         {
            (void)rhs;
