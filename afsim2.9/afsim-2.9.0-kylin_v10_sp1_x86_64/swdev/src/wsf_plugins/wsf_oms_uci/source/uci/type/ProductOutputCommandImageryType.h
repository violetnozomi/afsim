...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductOutputCommandImageryType_h
#define Uci__Type__ProductOutputCommandImageryType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductOutputCommandImageryType sequence accessor class */
      class ProductOutputCommandImageryType : public virtual uci::type::ProductOutputCommandBasicType {
      public:

         /** The destructor */
         virtual ~ProductOutputCommandImageryType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductOutputCommandImageryType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ProductOutputCommandImageryType to the contents of the
           * ProductOutputCommandImageryType on the right hand side (rhs) of the assignment
           * operator.ProductOutputCommandImageryType [only available to derived classes]
           *
           * @param rhs The ProductOutputCommandImageryType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::ProductOutputCommandImageryType
           * @return A constant reference to this ProductOutputCommandImageryType.
           */
         const ProductOutputCommandImageryType& operator=(const ProductOutputCommandImageryType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductOutputCommandImageryType_h
