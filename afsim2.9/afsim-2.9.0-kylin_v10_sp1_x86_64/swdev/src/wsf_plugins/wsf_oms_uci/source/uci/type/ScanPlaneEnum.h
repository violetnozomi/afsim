...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ScanPlaneEnum_h
#define Uci__Type__ScanPlaneEnum_h 1
   ...
   namespace type {
      ...
      public:
         ...
         /** The assignment operator. Sets the contents of this ScanPlaneEnum to the contents of the ScanPlaneEnum on the right
           * hand side (rhs) of the assignment operator.ScanPlaneEnum
           *
           ...
           * @return A constant reference to this ScanPlaneEnum.
           */
         const ScanPlaneEnum& operator=(const ScanPlaneEnum& rhs)
         {
         ...
         /** The assignment operator. Sets the value of this ScanPlaneEnum enumeration to the EnumerationItem on the right hand
           * side of the assignment operator.
           *
           * @param rhs The EnumerationItemwhose value is to be assigned to this ScanPlaneEnum enumeration
           * @return A reference to this ScanPlaneEnum enumeration
           */
         const ScanPlaneEnum& operator=(EnumerationItem rhs)
         {
            setValue(rhs);
            return *this;
         }
         ...
         /** Sets the value of this ScanPlaneEnum enumeration to the value of the specified enumeration item.
           *
           * @param item The EnumerationItemwhose value is to be used to set the value of this ScanPlaneEnum enumeration
           */
         ...
         /** Tests whether the value of this ScanPlaneEnum enumeration is less than the value of the specified EnumerationItem.
           *
           * @param rhs The EnumerationItem whose value is to be compared against the value of this ScanPlaneEnum enumeration.
           * @return True if the value of the EnumerationItem(rhs) is less than the value of this ScanPlaneEnum enumeration, false
           *      otherwise
           */
         bool operator<(EnumerationItem rhs) const
            throw(uci::base::UCIException)
...
#endif // Uci__Type__ScanPlaneEnum_h
