...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SystemStatusMT_h
#define Uci__Type__SystemStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class SystemStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~SystemStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. SystemStatusMT
           *
           * @return This accessor's type constant, i.e. SystemStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::systemStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SystemStatusMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::SystemStatusMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::SystemStatusMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::SystemStatusMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The SystemStatusMT to copy from
           */
         SystemStatusMT(const SystemStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SystemStatusMT to the contents of the SystemStatusMT on the right
           * hand side (rhs) of the assignment operator.SystemStatusMT [only available to derived classes]
           *
           * @param rhs The SystemStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::SystemStatusMT
           * @return A constant reference to this SystemStatusMT.
           */
         const SystemStatusMT& operator=(const SystemStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SystemStatusMT_h
