...
*    Directive 5230.25.
*/
#ifndef Uci__Type__TailNumberType_h
#define Uci__Type__TailNumberType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** Indicates the vehicle's tail number. Typically used for aircraft vehicles. DoD aircraft are identified by a
        ...
        * aircraft was ordered, and the remaining digits are the last three digits of the airframe's serial number. Civil
        * aircraft are identified by a two to six character alphanumeric registration number assigned by the ICAO or FAA.;
        * [Minimum length: 2] [Maximum length: 6] [Pattern: "[A-Za-z0-9\-]{2,6}"]
        */
...
#endif // Uci__Type__TailNumberType_h
