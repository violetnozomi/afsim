...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CapabilitySettingsCommandBaseType_h
#define Uci__Type__CapabilitySettingsCommandBaseType_h 1
...
#if !defined(Uci__Type__CapabilityPrecedenceType_h)
# include "uci/type/CapabilityPrecedenceType.h"
#endif

#if !defined(Uci__Type__CapabilityStateType_h)
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the CapabilitySettingsCommandBaseType sequence accessor class */
      class CapabilitySettingsCommandBaseType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~CapabilitySettingsCommandBaseType()
         { }

         /** Returns this accessor's type constant, i.e. CapabilitySettingsCommandBaseType
           *
           * @return This accessor's type constant, i.e. CapabilitySettingsCommandBaseType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::capabilitySettingsCommandBaseType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CapabilitySettingsCommandBaseType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Indicates a command to set relative precedence of the Capabilities. [Minimum occurrences: 0] [Maximum occurrences:
           * 9223372036854775807]
           */
         ...
         /** Indicates a command to change the state of the Capability [Minimum occurrences: 0] [Maximum occurrences:
           * 9223372036854775807]
           */
         ...
         /** Returns the bounded list that is identified by the CapabilityPrecedence.
           *
           * @return The bounded list identified by CapabilityPrecedence.
           */
         virtual const uci::type::CapabilitySettingsCommandBaseType::CapabilityPrecedence& getCapabilityPrecedence() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CapabilityPrecedence.
           ...
           * @return The bounded list identified by CapabilityPrecedence.
           */
         virtual uci::type::CapabilitySettingsCommandBaseType::CapabilityPrecedence& getCapabilityPrecedence()
            throw(uci::base::UCIException) = 0;


         /** Sets the bounded list that is identified by the CapabilityPrecedence.
           *
           * @param value The bounded list whose contents are to be used to set the value of the bounded list accessed by this
           *      accessor
           */
         virtual void setCapabilityPrecedence(const uci::type::CapabilitySettingsCommandBaseType::CapabilityPrecedence& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CapabilityState.
           ...
           */
         virtual const uci::type::CapabilitySettingsCommandBaseType::CapabilityState& getCapabilityState() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CapabilityState.
           ...
           * @return The bounded list identified by CapabilityState.
           */
         virtual uci::type::CapabilitySettingsCommandBaseType::CapabilityState& getCapabilityState()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the CapabilityState.
           ...
           *      accessor
           */
         virtual void setCapabilityState(const uci::type::CapabilitySettingsCommandBaseType::CapabilityState& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         CapabilitySettingsCommandBaseType(const CapabilitySettingsCommandBaseType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CapabilitySettingsCommandBaseType to the contents of the
           * CapabilitySettingsCommandBaseType on the right hand side (rhs) of the assignment
           * operator.CapabilitySettingsCommandBaseType [only available to derived classes]
           *
           * @param rhs The CapabilitySettingsCommandBaseType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::CapabilitySettingsCommandBaseType
           * @return A constant reference to this CapabilitySettingsCommandBaseType.
           */
         const CapabilitySettingsCommandBaseType& operator=(const CapabilitySettingsCommandBaseType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CapabilitySettingsCommandBaseType_h
