...
*    Directive 5230.25.
*/
#ifndef Uci__Type__MissionPlanActivationCommandStatusMDT_h
#define Uci__Type__MissionPlanActivationCommandStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the MissionPlanActivationCommandStatusMDT sequence accessor class */
      class MissionPlanActivationCommandStatusMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~MissionPlanActivationCommandStatusMDT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const MissionPlanActivationCommandStatusMDT& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the CommandStatus.
           ...
           */
         virtual const uci::type::MissionPlanActivationCommandStateEnum& getCommandStatus() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the CommandStatus.
           ...
           * @return The value of the enumeration identified by CommandStatus.
           */
         virtual uci::type::MissionPlanActivationCommandStateEnum& getCommandStatus()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the CommandStatus.
           ...
           */
         virtual void setCommandStatus(const uci::type::MissionPlanActivationCommandStateEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the CommandStatus.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setCommandStatus(uci::type::MissionPlanActivationCommandStateEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this MissionPlanActivationCommandStatusMDT to the contents of the
           * MissionPlanActivationCommandStatusMDT on the right hand side (rhs) of the assignment
           * operator.MissionPlanActivationCommandStatusMDT [only available to derived classes]
           *
           * @param rhs The MissionPlanActivationCommandStatusMDT on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::MissionPlanActivationCommandStatusMDT
           * @return A constant reference to this MissionPlanActivationCommandStatusMDT.
           */
         const MissionPlanActivationCommandStatusMDT& operator=(const MissionPlanActivationCommandStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__MissionPlanActivationCommandStatusMDT_h
