...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ESM_TaskBaseType_h
#define Uci__Type__ESM_TaskBaseType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ESM_TaskBaseType sequence accessor class */
      class ESM_TaskBaseType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ESM_TaskBaseType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ESM_TaskBaseType& accessor)
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           */
         virtual const uci::type::ESM_TaskBaseType::Output& getOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           * @return The bounded list identified by Output.
           */
         virtual uci::type::ESM_TaskBaseType::Output& getOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Output.
           ...
           *      accessor
           */
         virtual void setOutput(const uci::type::ESM_TaskBaseType::Output& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ESM_TaskBaseType to the contents of the ESM_TaskBaseType on the
           * right hand side (rhs) of the assignment operator.ESM_TaskBaseType [only available to derived classes]
           *
           * @param rhs The ESM_TaskBaseType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::ESM_TaskBaseType
           * @return A constant reference to this ESM_TaskBaseType.
           */
         const ESM_TaskBaseType& operator=(const ESM_TaskBaseType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ESM_TaskBaseType_h
