...
*    Directive 5230.25.
*/
#ifndef Uci__Type__AirSampleActivityType_h
#define Uci__Type__AirSampleActivityType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the AirSampleActivityType sequence accessor class */
      class AirSampleActivityType : public virtual uci::type::ActivityBaseType {
      public:

         /** The destructor */
         virtual ~AirSampleActivityType()
         { }

         /** Returns this accessor's type constant, i.e. AirSampleActivityType
           *
           * @return This accessor's type constant, i.e. AirSampleActivityType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::airSampleActivityType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const AirSampleActivityType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The AirSampleActivityType to copy from
           */
         AirSampleActivityType(const AirSampleActivityType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this AirSampleActivityType to the contents of the AirSampleActivityType
           * on the right hand side (rhs) of the assignment operator.AirSampleActivityType [only available to derived classes]
           *
           * @param rhs The AirSampleActivityType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::AirSampleActivityType
           * @return A constant reference to this AirSampleActivityType.
           */
         const AirSampleActivityType& operator=(const AirSampleActivityType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__AirSampleActivityType_h
