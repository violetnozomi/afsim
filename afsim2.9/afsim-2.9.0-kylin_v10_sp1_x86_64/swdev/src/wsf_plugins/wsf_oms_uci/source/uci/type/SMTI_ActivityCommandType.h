...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SMTI_ActivityCommandType_h
#define Uci__Type__SMTI_ActivityCommandType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SMTI_ActivityCommandType sequence accessor class */
      class SMTI_ActivityCommandType : public virtual uci::type::ActivityCommandBaseType {
      public:

         /** The destructor */
         virtual ~SMTI_ActivityCommandType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SMTI_ActivityCommandType& accessor)
            throw(uci::base::UCIException) = 0;


         /** Atmospheric propagation information to be used when determining CNR or range/power levels. [Minimum occurrences: 0]
         ...
         /** Returns whether the Element that is identified by RadarPointingTarget exists (is enabled) or not.
           *
           * @return A boolean indicating whether the Element identified by RadarPointingTarget is emabled or not
           */
         virtual bool hasRadarPointingTarget() const
            throw(uci::base::UCIException) = 0;


         /** Enables the Element that is identified by RadarPointingTarget
           *
           * @param type = uci::type::accessorType::radarPointingTargetType This Accessor's accessor type
           */
         virtual void enableRadarPointingTarget(uci::base::accessorType::AccessorType type = uci::type::accessorType::radarPointingTargetType)
            throw(uci::base::UCIException) = 0;


         /** Clears (disabled) the Element that is identified by RadarPointingTarget */
         virtual void clearRadarPointingTarget()
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the AtmosphericPropagation.
           ...
           */
         virtual const uci::type::SMTI_ActivityCommandType::AtmosphericPropagation& getAtmosphericPropagation() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the AtmosphericPropagation.
           ...
           * @return The bounded list identified by AtmosphericPropagation.
           */
         virtual uci::type::SMTI_ActivityCommandType::AtmosphericPropagation& getAtmosphericPropagation()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the AtmosphericPropagation.
           ...
           *      accessor
           */
         virtual void setAtmosphericPropagation(const uci::type::SMTI_ActivityCommandType::AtmosphericPropagation& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           */
         virtual const uci::type::SMTI_ActivityCommandType::ProductOutput& getProductOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductOutput.
           ...
           * @return The bounded list identified by ProductOutput.
           */
         virtual uci::type::SMTI_ActivityCommandType::ProductOutput& getProductOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ProductOutput.
           ...
           *      accessor
           */
         virtual void setProductOutput(const uci::type::SMTI_ActivityCommandType::ProductOutput& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SMTI_ActivityCommandType to the contents of the
           * SMTI_ActivityCommandType on the right hand side (rhs) of the assignment operator.SMTI_ActivityCommandType [only
           * available to derived classes]
           *
           * @param rhs The SMTI_ActivityCommandType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::SMTI_ActivityCommandType
           * @return A constant reference to this SMTI_ActivityCommandType.
           */
         const SMTI_ActivityCommandType& operator=(const SMTI_ActivityCommandType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SMTI_ActivityCommandType_h
