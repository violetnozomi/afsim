...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProcessingTypeEnum_h
#define Uci__Type__ProcessingTypeEnum_h 1
   ...
   namespace type {
      ...
      public:
         ...
         enum EnumerationItem {
            ...
            enumNotSet,
            //  UCI_WCMD's ordinal value */
            UCI_WCMD,

            //  UCI_WCID's ordinal value */
            UCI_WCID,

            //  UCI_WBID's ordinal value */
            UCI_WBID,

            //  UCI_INVERSE_SAR's ordinal value */
            UCI_INVERSE_SAR,

            //  UCI_COHERENT_CHANGE_DETECTION's ordinal value */
            UCI_COHERENT_CHANGE_DETECTION,

            //  UCI_TWO_COLOR_MULTI_VIEW's ordinal value */
            UCI_TWO_COLOR_MULTI_VIEW,

            //  UCI_DYNAMIC_IMAGE's ordinal value */
            UCI_DYNAMIC_IMAGE,

            //  UCI_AUTOMATIC_TARGET_DETECTION's ordinal value */
            UCI_AUTOMATIC_TARGET_DETECTION,

            //  UCI_AUTOMATIC_TARGET_RECOGNITION's ordinal value */
            ...
            //  UCI_MULTISPECTRAL's ordinal value */
            UCI_MULTISPECTRAL,

            //  UCI_HYPERSPECTRAL's ordinal value */
            UCI_HYPERSPECTRAL,
            ...
            //  UCI_IMAGE_GEOREGISTRATION's ordinal value */
            UCI_IMAGE_GEOREGISTRATION,

            //  UCI_IMAGE_PIXEL_GEOLOCATION's ordinal value */
            UCI_IMAGE_PIXEL_GEOLOCATION,

            //  UCI_MAN_MADE_OBJECT_DETECTION's ordinal value */
            UCI_MAN_MADE_OBJECT_DETECTION,

            //  UCI_MAN_MADE_OBJECT_DETECTION_3's ordinal value */
            UCI_MAN_MADE_OBJECT_DETECTION_3,

            //  UCI_AMPLITUDE_CHANGE_DETECTION's ordinal value */
            UCI_AMPLITUDE_CHANGE_DETECTION,

            //  UCI_ENHANCED_CHANGE_DETECTION's ordinal value */
            UCI_ENHANCED_CHANGE_DETECTION,

            //  UCI_MTI_ON_SAR's ordinal value */
            UCI_MTI_ON_SAR,

            //  UCI_SAR_ON_SAR's ordinal value */
            UCI_SAR_ON_SAR,

            //  UCI_MTI_TRACKS's ordinal value */
            UCI_MTI_TRACKS,

            //  UCI_ROAD_DETECTION's ordinal value */
            UCI_ROAD_DETECTION,

            //  UCI_OCEAN_SHIP_DETECTION's ordinal value */
            UCI_OCEAN_SHIP_DETECTION,

            //  UCI_THERMAL_DETECTION's ordinal value */
            UCI_THERMAL_DETECTION,

            //  UCI_CLOUD_DETECTION's ordinal value */
            UCI_CLOUD_DETECTION,

            //  UCI_ANNOTATED's ordinal value */
            UCI_ANNOTATED,

            //  UCI_AUGMENTATION's ordinal value */
            UCI_AUGMENTATION,

            //  UCI_WEATHER_AUGMENTATION's ordinal value */
         ...
         /** The assignment operator. Sets the contents of this ProcessingTypeEnum to the contents of the ProcessingTypeEnum on
           * the right hand side (rhs) of the assignment operator.ProcessingTypeEnum
           *
           ...
           * @return A constant reference to this ProcessingTypeEnum.
           */
         const ProcessingTypeEnum& operator=(const ProcessingTypeEnum& rhs)
         {
         ...
         /** The assignment operator. Sets the value of this ProcessingTypeEnum enumeration to the EnumerationItem on the right
           * hand side of the assignment operator.
           *
           * @param rhs The EnumerationItemwhose value is to be assigned to this ProcessingTypeEnum enumeration
           * @return A reference to this ProcessingTypeEnum enumeration
           */
         const ProcessingTypeEnum& operator=(EnumerationItem rhs)
         {
            setValue(rhs);
            return *this;
         }
         ...
         /** Sets the value of this ProcessingTypeEnum enumeration to the value of the specified enumeration item.
           *
           * @param item The EnumerationItemwhose value is to be used to set the value of this ProcessingTypeEnum enumeration
           */
         ...
         /** Tests whether the value of the specified EnumerationItem is not equal to the value of the specified
           ...
           * @param rhs The ProcessingTypeEnum enumeration whose value is to be compared against the value of the specified
           *      EnumerationItem
           * @return True if the value of the EnumerationItem(lhs) is not equal to the value of the ProcessingTypeEnum enumeration
           *      (rhs), false otherwise
           */
         friend bool operator!=(EnumerationItem lhs, const ProcessingTypeEnum& rhs)
         {
         ...
         /** Tests whether the value of the specified EnumerationItem is greater than the value of the specified
           ...
           * @param rhs The ProcessingTypeEnum enumeration whose value is to be compared against the value of the specified
           *      EnumerationItem
           * @return True if the value of the EnumerationItem(lhs) is greater than the value of the ProcessingTypeEnum enumeration
           *      (rhs), false otherwise
           */
         friend bool operator>(EnumerationItem lhs, const ProcessingTypeEnum& rhs)
         {
         ...
         /** Tests whether the value of the specified EnumerationItem is greater than or equal to the value of the specified
           ...
           * @param rhs The ProcessingTypeEnum enumeration whose value is to be compared against the value of the specified
           *      EnumerationItem
           * @return True if the value of the EnumerationItem(lhs) is greater than or equal to the value of the ProcessingTypeEnum
           *      enumeration (rhs), false otherwise
           */
         friend bool operator>=(EnumerationItem lhs, const ProcessingTypeEnum& rhs)
         {
...
#endif // Uci__Type__ProcessingTypeEnum_h
