...
*    Directive 5230.25.
*/
#ifndef Uci__Type__TaskStatusMT_h
#define Uci__Type__TaskStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class TaskStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~TaskStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. TaskStatusMT
           *
           * @return This accessor's type constant, i.e. TaskStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::taskStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const TaskStatusMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::TaskStatusMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::TaskStatusMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::TaskStatusMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The TaskStatusMT to copy from
           */
         TaskStatusMT(const TaskStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this TaskStatusMT to the contents of the TaskStatusMT on the right hand
           * side (rhs) of the assignment operator.TaskStatusMT [only available to derived classes]
           *
           * @param rhs The TaskStatusMT on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::TaskStatusMT
           * @return A constant reference to this TaskStatusMT.
           */
         const TaskStatusMT& operator=(const TaskStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__TaskStatusMT_h
