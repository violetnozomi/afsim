...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__AO_ActivityReader_h
#define Uci__Reader__AO_ActivityReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The AO_ActivityListener provides the support to listen and handle incoming messages of the type
        * uci::type::AO_Activity
        */
      class AO_ActivityListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~AO_ActivityListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::AO_Activity& message)
      ...
      class AO_ActivityReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~AO_ActivityReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(AO_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(AO_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, AO_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, AO_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The AO_ActivityReader to copy from
           */
         AO_ActivityReader(const AO_ActivityReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this AO_ActivityReader to the contents of the AO_ActivityReader on the
           * right hand side (rhs) of the assignment operator.AO_ActivityReader [only available to derived classes]
           *
           * @param rhs The AO_ActivityReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this AO_ActivityReader
           * @return A constant reference to this AO_ActivityReader.
           */
         const AO_ActivityReader& operator=(const AO_ActivityReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__AO_ActivityReader_h
