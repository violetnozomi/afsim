...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CommandActivityTraceabilityType_h
#define Uci__Type__CommandActivityTraceabilityType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the CommandActivityTraceabilityType sequence accessor class */
      class CommandActivityTraceabilityType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~CommandActivityTraceabilityType()
         { }

         /** Returns this accessor's type constant, i.e. CommandActivityTraceabilityType
           *
           * @return This accessor's type constant, i.e. CommandActivityTraceabilityType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::commandActivityTraceabilityType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CommandActivityTraceabilityType& accessor)
      ...
      protected:
         ...
         CommandActivityTraceabilityType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CommandActivityTraceabilityType to copy from
           */
         CommandActivityTraceabilityType(const CommandActivityTraceabilityType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CommandActivityTraceabilityType to the contents of the
           * CommandActivityTraceabilityType on the right hand side (rhs) of the assignment
           * operator.CommandActivityTraceabilityType [only available to derived classes]
           *
           * @param rhs The CommandActivityTraceabilityType on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::CommandActivityTraceabilityType
           * @return A constant reference to this CommandActivityTraceabilityType.
           */
         const CommandActivityTraceabilityType& operator=(const CommandActivityTraceabilityType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CommandActivityTraceabilityType_h
