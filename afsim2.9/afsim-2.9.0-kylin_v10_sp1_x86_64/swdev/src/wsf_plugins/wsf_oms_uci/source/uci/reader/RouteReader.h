...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__RouteReader_h
#define Uci__Reader__RouteReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The RouteListener provides the support to listen and handle incoming messages of the type uci::type::Route */
      class RouteListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::Route& message)
      ...
      class RouteReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(RouteListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(RouteListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, RouteListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, RouteListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The RouteReader to copy from
           */
         RouteReader(const RouteReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this RouteReader to the contents of the RouteReader on the right hand
           * side (rhs) of the assignment operator.RouteReader [only available to derived classes]
           *
           * @param rhs The RouteReader on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this RouteReader
           * @return A constant reference to this RouteReader.
           */
         const RouteReader& operator=(const RouteReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__RouteReader_h
