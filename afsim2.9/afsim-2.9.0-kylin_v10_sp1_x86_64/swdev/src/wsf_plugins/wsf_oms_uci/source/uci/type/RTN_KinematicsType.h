...
*    Directive 5230.25.
*/
#ifndef Uci__Type__RTN_KinematicsType_h
#define Uci__Type__RTN_KinematicsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** Indicates kinematic vectors in the Radial-Transverse-Normal Reference System. */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const RTN_KinematicsType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Position.
           ...
           */
         virtual const uci::type::RTN_PositionType& getPosition() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Position.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Position.
           */
         virtual uci::type::RTN_PositionType& getPosition()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Position to the contents of the complex content that is accessed
           ...
           */
         virtual void setPosition(const uci::type::RTN_PositionType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Velocity.
           ...
           */
         virtual const uci::type::RTN_VelocityType& getVelocity() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Velocity.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Velocity.
           */
         virtual uci::type::RTN_VelocityType& getVelocity()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Velocity to the contents of the complex content that is accessed
           ...
           */
         virtual void setVelocity(const uci::type::RTN_VelocityType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Acceleration.
           ...
           */
         virtual const uci::type::RTN_AccelerationType& getAcceleration() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Acceleration.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Acceleration.
           */
         virtual uci::type::RTN_AccelerationType& getAcceleration()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Acceleration to the contents of the complex content that is
           ...
           */
         virtual void setAcceleration(const uci::type::RTN_AccelerationType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by Acceleration
           *
           * @param type = uci::type::accessorType::rTN_AccelerationType This Accessor's accessor type
           */
         virtual void enableAcceleration(uci::base::accessorType::AccessorType type = uci::type::accessorType::rTN_AccelerationType)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this RTN_KinematicsType to the contents of the RTN_KinematicsType on
           * the right hand side (rhs) of the assignment operator.RTN_KinematicsType [only available to derived classes]
           *
           * @param rhs The RTN_KinematicsType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::RTN_KinematicsType
           * @return A constant reference to this RTN_KinematicsType.
           */
         const RTN_KinematicsType& operator=(const RTN_KinematicsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__RTN_KinematicsType_h
