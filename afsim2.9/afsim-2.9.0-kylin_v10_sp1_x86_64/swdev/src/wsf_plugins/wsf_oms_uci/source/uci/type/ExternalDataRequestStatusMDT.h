...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ExternalDataRequestStatusMDT_h
#define Uci__Type__ExternalDataRequestStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ExternalDataRequestStatusMDT sequence accessor class */
      class ExternalDataRequestStatusMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ExternalDataRequestStatusMDT()
         { }

         /** Returns this accessor's type constant, i.e. ExternalDataRequestStatusMDT
           *
           * @return This accessor's type constant, i.e. ExternalDataRequestStatusMDT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::externalDataRequestStatusMDT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ExternalDataRequestStatusMDT& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ExternalDataRequestStatusMDT to copy from
           */
         ExternalDataRequestStatusMDT(const ExternalDataRequestStatusMDT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ExternalDataRequestStatusMDT to the contents of the
           * ExternalDataRequestStatusMDT on the right hand side (rhs) of the assignment operator.ExternalDataRequestStatusMDT
           * [only available to derived classes]
           *
           * @param rhs The ExternalDataRequestStatusMDT on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::ExternalDataRequestStatusMDT
           * @return A constant reference to this ExternalDataRequestStatusMDT.
           */
         const ExternalDataRequestStatusMDT& operator=(const ExternalDataRequestStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ExternalDataRequestStatusMDT_h
