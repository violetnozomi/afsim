...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SMTI_TaskBaseType_h
#define Uci__Type__SMTI_TaskBaseType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SMTI_TaskBaseType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SMTI_TaskBaseType& accessor)
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           */
         virtual const uci::type::SMTI_TaskBaseType::Output& getOutput() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Output.
           ...
           * @return The bounded list identified by Output.
           */
         virtual uci::type::SMTI_TaskBaseType::Output& getOutput()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Output.
           ...
           *      accessor
           */
         virtual void setOutput(const uci::type::SMTI_TaskBaseType::Output& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this SMTI_TaskBaseType to the contents of the SMTI_TaskBaseType on the
           * right hand side (rhs) of the assignment operator.SMTI_TaskBaseType [only available to derived classes]
           *
           * @param rhs The SMTI_TaskBaseType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::SMTI_TaskBaseType
           * @return A constant reference to this SMTI_TaskBaseType.
           */
         const SMTI_TaskBaseType& operator=(const SMTI_TaskBaseType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SMTI_TaskBaseType_h
