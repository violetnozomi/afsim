...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SegmentConflictsType_h
#define Uci__Type__SegmentConflictsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the SegmentConflictsType sequence accessor class */
      class SegmentConflictsType : public virtual uci::base::Accessor {
      public:
         ...
         /** Returns this accessor's type constant, i.e. SegmentConflictsType
           *
           * @return This accessor's type constant, i.e. SegmentConflictsType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::segmentConflictsType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SegmentConflictsType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         SegmentConflictsType(const SegmentConflictsType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SegmentConflictsType to the contents of the SegmentConflictsType
           * on the right hand side (rhs) of the assignment operator.SegmentConflictsType [only available to derived classes]
           *
           * @param rhs The SegmentConflictsType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::SegmentConflictsType
           * @return A constant reference to this SegmentConflictsType.
           */
         const SegmentConflictsType& operator=(const SegmentConflictsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SegmentConflictsType_h
