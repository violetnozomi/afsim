...
*    Directive 5230.25.
*/
#ifndef Uci__Type__RuleType_h
#define Uci__Type__RuleType_h 1
...
#if !defined(Uci__Type__RuleTriggerType_h)
# include "uci/type/RuleTriggerType.h"
#endif
...
#if !defined(Uci__Type__RuleResponseType_h)
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the RuleType sequence accessor class */
      class RuleType : public virtual uci::base::Accessor {
      public:
         ...
         /** Returns this accessor's type constant, i.e. RuleType
           *
           * @return This accessor's type constant, i.e. RuleType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::ruleType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const RuleType& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the Objective.
           *
           * @return The value of the enumeration identified by Objective.
           */
         virtual const uci::type::MetaTaskTypeEnum& getObjective() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the Objective.
           ...
           * @return The value of the enumeration identified by Objective.
           */
         virtual uci::type::MetaTaskTypeEnum& getObjective()
            throw(uci::base::UCIException) = 0;


         /** Sets the value of the enumeration that is identified by the Objective.
           *
           * @param value The value to set the enumeration to
           */
         virtual void setObjective(const uci::type::MetaTaskTypeEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Objective.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setObjective(uci::type::MetaTaskTypeEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;


         /** Returns whether this optionalfield Objectiveis available
           *
         ...
         /** Enables the optional field such that getObjective will return the optional field and not throw an exception when
           ...
           */
         virtual void enableObjective(uci::base::accessorType::AccessorType type = uci::type::accessorType::metaTaskTypeEnum)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Trigger.
           ...
           */
         virtual const uci::type::RuleTriggerType& getTrigger() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Trigger.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Trigger.
           */
         virtual uci::type::RuleTriggerType& getTrigger()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Trigger to the contents of the complex content that is accessed by
           ...
           */
         virtual void setTrigger(const uci::type::RuleTriggerType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Response.
           *
           * @return The acecssor that provides access to the complex content that is identified by Response.
           */
         virtual const uci::type::RuleResponseType& getResponse() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Response.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Response.
           */
         virtual uci::type::RuleResponseType& getResponse()
            throw(uci::base::UCIException) = 0;


         /** Sets the complex content that is identified by the Response to the contents of the complex content that is accessed
           * by the specified accessor.
           *
           * @param value The accessor that provides access to the sequence whose contents are to be used to set the contents of
           *      the sequence identified by Response
           */
         virtual void setResponse(const uci::type::RuleResponseType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The RuleType to copy from
           */
         RuleType(const RuleType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this RuleType to the contents of the RuleType on the right hand side
           * (rhs) of the assignment operator.RuleType [only available to derived classes]
           *
           * @param rhs The RuleType on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::RuleType
           * @return A constant reference to this RuleType.
           */
         const RuleType& operator=(const RuleType& rhs)
         {
            (void)rhs;
