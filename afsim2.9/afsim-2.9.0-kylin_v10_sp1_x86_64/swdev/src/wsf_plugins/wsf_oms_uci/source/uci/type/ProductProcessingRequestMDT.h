...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductProcessingRequestMDT_h
#define Uci__Type__ProductProcessingRequestMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductProcessingRequestMDT sequence accessor class */
      class ProductProcessingRequestMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ProductProcessingRequestMDT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductProcessingRequestMDT& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this ProductProcessingRequestMDT to the contents of the
           * ProductProcessingRequestMDT on the right hand side (rhs) of the assignment operator.ProductProcessingRequestMDT [only
           * available to derived classes]
           *
           * @param rhs The ProductProcessingRequestMDT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::ProductProcessingRequestMDT
           * @return A constant reference to this ProductProcessingRequestMDT.
           */
         const ProductProcessingRequestMDT& operator=(const ProductProcessingRequestMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductProcessingRequestMDT_h
