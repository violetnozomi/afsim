...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ControlSourcesCommandStatusMDT_h
#define Uci__Type__ControlSourcesCommandStatusMDT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ControlSourcesCommandStatusMDT sequence accessor class */
      class ControlSourcesCommandStatusMDT : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ControlSourcesCommandStatusMDT()
         { }

         /** Returns this accessor's type constant, i.e. ControlSourcesCommandStatusMDT
           *
           * @return This accessor's type constant, i.e. ControlSourcesCommandStatusMDT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::controlSourcesCommandStatusMDT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ControlSourcesCommandStatusMDT& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ControlSourcesCommandStatusMDT to copy from
           */
         ControlSourcesCommandStatusMDT(const ControlSourcesCommandStatusMDT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ControlSourcesCommandStatusMDT to the contents of the
           * ControlSourcesCommandStatusMDT on the right hand side (rhs) of the assignment operator.ControlSourcesCommandStatusMDT
           * [only available to derived classes]
           *
           * @param rhs The ControlSourcesCommandStatusMDT on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::ControlSourcesCommandStatusMDT
           * @return A constant reference to this ControlSourcesCommandStatusMDT.
           */
         const ControlSourcesCommandStatusMDT& operator=(const ControlSourcesCommandStatusMDT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ControlSourcesCommandStatusMDT_h
