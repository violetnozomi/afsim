...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__PO_ActivityReader_h
#define Uci__Reader__PO_ActivityReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The PO_ActivityListener provides the support to listen and handle incoming messages of the type
        * uci::type::PO_Activity
        */
      class PO_ActivityListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~PO_ActivityListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::PO_Activity& message)
      ...
      class PO_ActivityReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~PO_ActivityReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(PO_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(PO_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, PO_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, PO_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The PO_ActivityReader to copy from
           */
         PO_ActivityReader(const PO_ActivityReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this PO_ActivityReader to the contents of the PO_ActivityReader on the
           * right hand side (rhs) of the assignment operator.PO_ActivityReader [only available to derived classes]
           *
           * @param rhs The PO_ActivityReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this PO_ActivityReader
           * @return A constant reference to this PO_ActivityReader.
           */
         const PO_ActivityReader& operator=(const PO_ActivityReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__PO_ActivityReader_h
