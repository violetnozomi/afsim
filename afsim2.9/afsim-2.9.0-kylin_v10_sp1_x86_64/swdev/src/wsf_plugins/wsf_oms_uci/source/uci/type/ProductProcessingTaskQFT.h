...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductProcessingTaskQFT_h
#define Uci__Type__ProductProcessingTaskQFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductProcessingTaskQFT sequence accessor class */
      class ProductProcessingTaskQFT : public virtual uci::type::QueryFilterPET {
      public:

         /** The destructor */
         virtual ~ProductProcessingTaskQFT()
         { }

         /** Returns this accessor's type constant, i.e. ProductProcessingTaskQFT
           *
           * @return This accessor's type constant, i.e. ProductProcessingTaskQFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::productProcessingTaskQFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductProcessingTaskQFT& accessor)
         ...
         /** Filter on the Processing Type [Minimum occurrences: 0] [Maximum occurrences: 32] */
         ...
         /** Returns the bounded list that is identified by the SystemID.
           ...
           */
         virtual const uci::type::ProductProcessingTaskQFT::SystemID& getSystemID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the SystemID.
           ...
           * @return The bounded list identified by SystemID.
           */
         virtual uci::type::ProductProcessingTaskQFT::SystemID& getSystemID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the SystemID.
           ...
           *      accessor
           */
         virtual void setSystemID(const uci::type::ProductProcessingTaskQFT::SystemID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TaskID.
           ...
           */
         virtual const uci::type::ProductProcessingTaskQFT::TaskID& getTaskID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TaskID.
           ...
           * @return The bounded list identified by TaskID.
           */
         virtual uci::type::ProductProcessingTaskQFT::TaskID& getTaskID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the TaskID.
           ...
           *      accessor
           */
         virtual void setTaskID(const uci::type::ProductProcessingTaskQFT::TaskID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProcessingType.
           ...
           */
         virtual const uci::type::ProductProcessingTaskQFT::ProcessingType& getProcessingType() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProcessingType.
           ...
           * @return The bounded list identified by ProcessingType.
           */
         virtual uci::type::ProductProcessingTaskQFT::ProcessingType& getProcessingType()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ProcessingType.
           ...
           *      accessor
           */
         virtual void setProcessingType(const uci::type::ProductProcessingTaskQFT::ProcessingType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ParentTaskID.
           ...
           */
         virtual const uci::type::ProductProcessingTaskQFT::ParentTaskID& getParentTaskID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ParentTaskID.
           ...
           * @return The bounded list identified by ParentTaskID.
           */
         virtual uci::type::ProductProcessingTaskQFT::ParentTaskID& getParentTaskID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ParentTaskID.
           ...
           *      accessor
           */
         virtual void setParentTaskID(const uci::type::ProductProcessingTaskQFT::ParentTaskID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DependentTaskID.
           ...
           */
         virtual const uci::type::ProductProcessingTaskQFT::DependentTaskID& getDependentTaskID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DependentTaskID.
           ...
           * @return The bounded list identified by DependentTaskID.
           */
         virtual uci::type::ProductProcessingTaskQFT::DependentTaskID& getDependentTaskID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the DependentTaskID.
           ...
           *      accessor
           */
         virtual void setDependentTaskID(const uci::type::ProductProcessingTaskQFT::DependentTaskID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TaskState.
           ...
           */
         virtual const uci::type::ProductProcessingTaskQFT::TaskState& getTaskState() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TaskState.
           ...
           * @return The bounded list identified by TaskState.
           */
         virtual uci::type::ProductProcessingTaskQFT::TaskState& getTaskState()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the TaskState.
           ...
           *      accessor
           */
         virtual void setTaskState(const uci::type::ProductProcessingTaskQFT::TaskState& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Product.
           ...
           */
         virtual const uci::type::ProductProcessingTaskQFT::Product& getProduct() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Product.
           ...
           * @return The bounded list identified by Product.
           */
         virtual uci::type::ProductProcessingTaskQFT::Product& getProduct()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Product.
           ...
           *      accessor
           */
         virtual void setProduct(const uci::type::ProductProcessingTaskQFT::Product& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductType.
           ...
           */
         virtual const uci::type::ProductProcessingTaskQFT::ProductType& getProductType() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductType.
           ...
           * @return The bounded list identified by ProductType.
           */
         virtual uci::type::ProductProcessingTaskQFT::ProductType& getProductType()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ProductType.
           ...
           *      accessor
           */
         virtual void setProductType(const uci::type::ProductProcessingTaskQFT::ProductType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         ProductProcessingTaskQFT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ProductProcessingTaskQFT to copy from
           */
         ProductProcessingTaskQFT(const ProductProcessingTaskQFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ProductProcessingTaskQFT to the contents of the
           * ProductProcessingTaskQFT on the right hand side (rhs) of the assignment operator.ProductProcessingTaskQFT [only
           * available to derived classes]
           *
           * @param rhs The ProductProcessingTaskQFT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::ProductProcessingTaskQFT
           * @return A constant reference to this ProductProcessingTaskQFT.
           */
         const ProductProcessingTaskQFT& operator=(const ProductProcessingTaskQFT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductProcessingTaskQFT_h
