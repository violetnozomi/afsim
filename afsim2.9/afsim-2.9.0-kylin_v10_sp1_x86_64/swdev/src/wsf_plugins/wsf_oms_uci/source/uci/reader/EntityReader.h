...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__EntityReader_h
#define Uci__Reader__EntityReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The EntityListener provides the support to listen and handle incoming messages of the type uci::type::Entity */
      class EntityListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::Entity& message)
      ...
      class EntityReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(EntityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, EntityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, EntityListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The EntityReader to copy from
           */
         EntityReader(const EntityReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this EntityReader to the contents of the EntityReader on the right hand
           * side (rhs) of the assignment operator.EntityReader [only available to derived classes]
           *
           * @param rhs The EntityReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this EntityReader
           * @return A constant reference to this EntityReader.
           */
         const EntityReader& operator=(const EntityReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__EntityReader_h
