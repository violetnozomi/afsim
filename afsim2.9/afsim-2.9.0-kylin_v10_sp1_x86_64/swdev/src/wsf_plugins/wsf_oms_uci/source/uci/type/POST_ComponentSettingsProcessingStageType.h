...
*    Directive 5230.25.
*/
#ifndef Uci__Type__POST_ComponentSettingsProcessingStageType_h
#define Uci__Type__POST_ComponentSettingsProcessingStageType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the POST_ComponentSettingsProcessingStageType sequence accessor class */
      class POST_ComponentSettingsProcessingStageType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~POST_ComponentSettingsProcessingStageType()
         { }

         /** Returns this accessor's type constant, i.e. POST_ComponentSettingsProcessingStageType
           *
           * @return This accessor's type constant, i.e. POST_ComponentSettingsProcessingStageType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pOST_ComponentSettingsProcessingStageType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const POST_ComponentSettingsProcessingStageType& accessor)
         ...
         /** Returns the bounded list that is identified by the FPA_ID.
           ...
           */
         virtual const uci::type::POST_ComponentSettingsProcessingStageType::FPA_ID& getFPA_ID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the FPA_ID.
           ...
           * @return The bounded list identified by FPA_ID.
           */
         virtual uci::type::POST_ComponentSettingsProcessingStageType::FPA_ID& getFPA_ID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the FPA_ID.
           ...
           *      accessor
           */
         virtual void setFPA_ID(const uci::type::POST_ComponentSettingsProcessingStageType::FPA_ID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Settings.
           ...
           */
         virtual const uci::type::POST_ComponentSettingsProcessingStageSettingsType& getSettings() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Settings.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Settings.
           */
         virtual uci::type::POST_ComponentSettingsProcessingStageSettingsType& getSettings()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Settings to the contents of the complex content that is accessed
           ...
           */
         virtual void setSettings(const uci::type::POST_ComponentSettingsProcessingStageSettingsType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by Settings
           *
           * @param type = uci::type::accessorType::pOST_ComponentSettingsProcessingStageSettingsType This Accessor's accessor
           *      type
           */
         virtual void enableSettings(uci::base::accessorType::AccessorType type = uci::type::accessorType::pOST_ComponentSettingsProcessingStageSettingsType)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         POST_ComponentSettingsProcessingStageType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The POST_ComponentSettingsProcessingStageType to copy from
           */
         POST_ComponentSettingsProcessingStageType(const POST_ComponentSettingsProcessingStageType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this POST_ComponentSettingsProcessingStageType to the contents of the
           * POST_ComponentSettingsProcessingStageType on the right hand side (rhs) of the assignment
           * operator.POST_ComponentSettingsProcessingStageType [only available to derived classes]
           *
           * @param rhs The POST_ComponentSettingsProcessingStageType on the right hand side (rhs) of the assignment operator
           *      whose contents are used to set the contents of this uci::type::POST_ComponentSettingsProcessingStageType
           * @return A constant reference to this POST_ComponentSettingsProcessingStageType.
           */
         const POST_ComponentSettingsProcessingStageType& operator=(const POST_ComponentSettingsProcessingStageType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__POST_ComponentSettingsProcessingStageType_h
