...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DMPI_QFT_h
#define Uci__Type__DMPI_QFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the DMPI_QFT sequence accessor class */
      class DMPI_QFT : public virtual uci::type::QueryFilterPET {
      public:
         ...
         /** Returns this accessor's type constant, i.e. DMPI_QFT
           *
           * @return This accessor's type constant, i.e. DMPI_QFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::dMPI_QFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DMPI_QFT& accessor)
            throw(uci::base::UCIException) = 0;


         /** The ID of the DMPI to query. [Minimum occurrences: 0] [Maximum occurrences: 9223372036854775807] */
         ...
         /** Returns the bounded list that is identified by the DMPI_ID.
           ...
           */
         virtual const uci::type::DMPI_QFT::DMPI_ID& getDMPI_ID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DMPI_ID.
           ...
           * @return The bounded list identified by DMPI_ID.
           */
         virtual uci::type::DMPI_QFT::DMPI_ID& getDMPI_ID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the DMPI_ID.
           ...
           *      accessor
           */
         virtual void setDMPI_ID(const uci::type::DMPI_QFT::DMPI_ID& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DMPI_QFT to copy from
           */
         DMPI_QFT(const DMPI_QFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DMPI_QFT to the contents of the DMPI_QFT on the right hand side
           * (rhs) of the assignment operator.DMPI_QFT [only available to derived classes]
           *
           * @param rhs The DMPI_QFT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::DMPI_QFT
           * @return A constant reference to this DMPI_QFT.
           */
         const DMPI_QFT& operator=(const DMPI_QFT& rhs)
         {
            (void)rhs;
