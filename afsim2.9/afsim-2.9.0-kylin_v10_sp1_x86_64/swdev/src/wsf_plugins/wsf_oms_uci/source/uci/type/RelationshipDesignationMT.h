...
*    Directive 5230.25.
*/
#ifndef Uci__Type__RelationshipDesignationMT_h
#define Uci__Type__RelationshipDesignationMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class RelationshipDesignationMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~RelationshipDesignationMT()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const RelationshipDesignationMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::RelationshipDesignationMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::RelationshipDesignationMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::RelationshipDesignationMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this RelationshipDesignationMT to the contents of the
           * RelationshipDesignationMT on the right hand side (rhs) of the assignment operator.RelationshipDesignationMT [only
           * available to derived classes]
           *
           * @param rhs The RelationshipDesignationMT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::RelationshipDesignationMT
           * @return A constant reference to this RelationshipDesignationMT.
           */
         const RelationshipDesignationMT& operator=(const RelationshipDesignationMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__RelationshipDesignationMT_h
