...
*    Directive 5230.25.
*/
#ifndef Uci__Type__POST_TrackDetailsType_h
#define Uci__Type__POST_TrackDetailsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class POST_TrackDetailsType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~POST_TrackDetailsType()
         { }

         /** Returns this accessor's type constant, i.e. POST_TrackDetailsType
           *
           * @return This accessor's type constant, i.e. POST_TrackDetailsType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::pOST_TrackDetailsType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const POST_TrackDetailsType& accessor)
         ...
         /** Returns the bounded list that is identified by the CoastSetting.
           ...
           */
         virtual const uci::type::POST_TrackDetailsType::CoastSetting& getCoastSetting() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the CoastSetting.
           ...
           * @return The bounded list identified by CoastSetting.
           */
         virtual uci::type::POST_TrackDetailsType::CoastSetting& getCoastSetting()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the CoastSetting.
           ...
           *      accessor
           */
         virtual void setCoastSetting(const uci::type::POST_TrackDetailsType::CoastSetting& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         POST_TrackDetailsType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The POST_TrackDetailsType to copy from
           */
         POST_TrackDetailsType(const POST_TrackDetailsType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this POST_TrackDetailsType to the contents of the POST_TrackDetailsType
           * on the right hand side (rhs) of the assignment operator.POST_TrackDetailsType [only available to derived classes]
           *
           * @param rhs The POST_TrackDetailsType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::POST_TrackDetailsType
           * @return A constant reference to this POST_TrackDetailsType.
           */
         const POST_TrackDetailsType& operator=(const POST_TrackDetailsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__POST_TrackDetailsType_h
