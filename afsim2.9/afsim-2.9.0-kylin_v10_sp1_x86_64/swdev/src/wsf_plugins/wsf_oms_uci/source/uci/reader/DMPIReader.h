...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__DMPIReader_h
#define Uci__Reader__DMPIReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The DMPIListener provides the support to listen and handle incoming messages of the type uci::type::DMPI */
      class DMPIListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~DMPIListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::DMPI& message)
      ...
      class DMPIReader : public virtual uci::base::Reader {
      public:
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(DMPIListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(DMPIListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, DMPIListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, DMPIListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DMPIReader to copy from
           */
         DMPIReader(const DMPIReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DMPIReader to the contents of the DMPIReader on the right hand
           * side (rhs) of the assignment operator.DMPIReader [only available to derived classes]
           *
           * @param rhs The DMPIReader on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this DMPIReader
           * @return A constant reference to this DMPIReader.
           */
         const DMPIReader& operator=(const DMPIReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__DMPIReader_h
