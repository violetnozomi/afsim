...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__CommPointingReader_h
#define Uci__Reader__CommPointingReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The CommPointingListener provides the support to listen and handle incoming messages of the type
        * uci::type::CommPointing
        */
      class CommPointingListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~CommPointingListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::CommPointing& message)
            throw(uci::base::UCIException) = 0;


      }; // CommPointingListener


      /** The Reader provides the support to reader incoming messages. */
      class CommPointingReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~CommPointingReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(CommPointingListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(CommPointingListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, CommPointingListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, CommPointingListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The CommPointingReader to copy from
           */
         CommPointingReader(const CommPointingReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CommPointingReader to the contents of the CommPointingReader on
           * the right hand side (rhs) of the assignment operator.CommPointingReader [only available to derived classes]
           *
           * @param rhs The CommPointingReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this CommPointingReader
           * @return A constant reference to this CommPointingReader.
           */
         const CommPointingReader& operator=(const CommPointingReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__CommPointingReader_h
