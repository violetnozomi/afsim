...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__DoorStatusReader_h
#define Uci__Reader__DoorStatusReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The DoorStatusListener provides the support to listen and handle incoming messages of the type uci::type::DoorStatus */
      class DoorStatusListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~DoorStatusListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::DoorStatus& message)
      ...
      class DoorStatusReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~DoorStatusReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(DoorStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(DoorStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, DoorStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, DoorStatusListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DoorStatusReader to copy from
           */
         DoorStatusReader(const DoorStatusReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DoorStatusReader to the contents of the DoorStatusReader on the
           * right hand side (rhs) of the assignment operator.DoorStatusReader [only available to derived classes]
           *
           * @param rhs The DoorStatusReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this DoorStatusReader
           * @return A constant reference to this DoorStatusReader.
           */
         const DoorStatusReader& operator=(const DoorStatusReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__DoorStatusReader_h
