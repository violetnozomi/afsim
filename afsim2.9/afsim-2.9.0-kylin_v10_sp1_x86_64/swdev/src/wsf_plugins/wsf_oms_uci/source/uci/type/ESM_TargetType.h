...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ESM_TargetType_h
#define Uci__Type__ESM_TargetType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ESM_TargetType choice accessor class */
      class ESM_TargetType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ESM_TargetType()
         { }

         /** Returns this accessor's type constant, i.e. ESM_TargetType
           *
           * @return This accessor's type constant, i.e. ESM_TargetType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::eSM_TargetType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ESM_TargetType& accessor)
            throw(uci::base::UCIException) = 0;


         /** The following enumeration is used to identify which element of this Choice has been chosen. */
         enum ESM_TargetTypeChoice {
            ESM_TARGETTYPE_CHOICE_NONE,
            ESM_TARGETTYPE_CHOICE_ENTITYID,
            ESM_TARGETTYPE_CHOICE_EMITTERTYPE,
            ESM_TARGETTYPE_CHOICE_SPECIFICEMITTER,
            ESM_TARGETTYPE_CHOICE_SIGNALDESCRIPTION,
            ESM_TARGETTYPE_CHOICE_SIGNALID,
            ESM_TARGETTYPE_CHOICE_EMITTERPRIORITYBIN
         };
         ...
         /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           */
         virtual ESM_TargetTypeChoice getESM_TargetTypeChoiceOrdinal() const
            throw(uci::base::UCIException) = 0;
         ...
         /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           * getESM_TargetTypeChoiceOrdinal() will be the ordinal specified when this method was invoked. In addition, the access
           ...
           *      base type.
           */
         virtual void setESM_TargetTypeChoiceOrdinal(ESM_TargetTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ESM_TargetType to copy from
           */
         ESM_TargetType(const ESM_TargetType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ESM_TargetType to the contents of the ESM_TargetType on the right
           * hand side (rhs) of the assignment operator.ESM_TargetType [only available to derived classes]
           *
           * @param rhs The ESM_TargetType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::ESM_TargetType
           * @return A constant reference to this ESM_TargetType.
           */
         const ESM_TargetType& operator=(const ESM_TargetType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ESM_TargetType_h
