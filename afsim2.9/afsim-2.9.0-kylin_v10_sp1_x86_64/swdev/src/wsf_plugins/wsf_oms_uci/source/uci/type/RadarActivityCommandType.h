...
*    Directive 5230.25.
*/
#ifndef Uci__Type__RadarActivityCommandType_h
#define Uci__Type__RadarActivityCommandType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the RadarActivityCommandType sequence accessor class */
      class RadarActivityCommandType : public virtual uci::type::ActivityCommandBaseType {
      public:

         /** The destructor */
         virtual ~RadarActivityCommandType()
         { }

         /** Returns this accessor's type constant, i.e. RadarActivityCommandType
           *
           * @return This accessor's type constant, i.e. RadarActivityCommandType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::radarActivityCommandType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const RadarActivityCommandType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The RadarActivityCommandType to copy from
           */
         RadarActivityCommandType(const RadarActivityCommandType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this RadarActivityCommandType to the contents of the
           * RadarActivityCommandType on the right hand side (rhs) of the assignment operator.RadarActivityCommandType [only
           * available to derived classes]
           *
           * @param rhs The RadarActivityCommandType on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::RadarActivityCommandType
           * @return A constant reference to this RadarActivityCommandType.
           */
         const RadarActivityCommandType& operator=(const RadarActivityCommandType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__RadarActivityCommandType_h
