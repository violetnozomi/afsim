...
*    Directive 5230.25.
*/
#ifndef Uci__Type__LOS_VariableA_Type_h
#define Uci__Type__LOS_VariableA_Type_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class LOS_VariableA_Type : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~LOS_VariableA_Type()
         { }

         /** Returns this accessor's type constant, i.e. LOS_VariableA_Type
           *
           * @return This accessor's type constant, i.e. LOS_VariableA_Type
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::lOS_VariableA_Type;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const LOS_VariableA_Type& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The LOS_VariableA_Type to copy from
           */
         LOS_VariableA_Type(const LOS_VariableA_Type& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this LOS_VariableA_Type to the contents of the LOS_VariableA_Type on
           * the right hand side (rhs) of the assignment operator.LOS_VariableA_Type [only available to derived classes]
           *
           * @param rhs The LOS_VariableA_Type on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::LOS_VariableA_Type
           * @return A constant reference to this LOS_VariableA_Type.
           */
         const LOS_VariableA_Type& operator=(const LOS_VariableA_Type& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__LOS_VariableA_Type_h
