...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DisseminationByType_h
#define Uci__Type__DisseminationByType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the DisseminationByType sequence accessor class */
      class DisseminationByType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~DisseminationByType()
         { }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DisseminationByType& accessor)
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this DisseminationByType to the contents of the DisseminationByType on
           * the right hand side (rhs) of the assignment operator.DisseminationByType [only available to derived classes]
           *
           * @param rhs The DisseminationByType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::DisseminationByType
           * @return A constant reference to this DisseminationByType.
           */
         const DisseminationByType& operator=(const DisseminationByType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DisseminationByType_h
