...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ESM_ConsentRequestType_h
#define Uci__Type__ESM_ConsentRequestType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ESM_ConsentRequestType sequence accessor class */
      class ESM_ConsentRequestType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ESM_ConsentRequestType()
         { }

         /** Returns this accessor's type constant, i.e. ESM_ConsentRequestType
           *
           * @return This accessor's type constant, i.e. ESM_ConsentRequestType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::eSM_ConsentRequestType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ESM_ConsentRequestType& accessor)
      ...
      protected:
         ...
         ESM_ConsentRequestType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ESM_ConsentRequestType to copy from
           */
         ESM_ConsentRequestType(const ESM_ConsentRequestType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ESM_ConsentRequestType to the contents of the
           * ESM_ConsentRequestType on the right hand side (rhs) of the assignment operator.ESM_ConsentRequestType [only available
           * to derived classes]
           *
           * @param rhs The ESM_ConsentRequestType on the right hand side (rhs) of the assignment operator whose contents are used
           *      to set the contents of this uci::type::ESM_ConsentRequestType
           * @return A constant reference to this ESM_ConsentRequestType.
           */
         const ESM_ConsentRequestType& operator=(const ESM_ConsentRequestType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ESM_ConsentRequestType_h
