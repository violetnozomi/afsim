...
*    Directive 5230.25.
*/
#ifndef Uci__Type__AMTI_SettingsCommandStatusMT_h
#define Uci__Type__AMTI_SettingsCommandStatusMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the AMTI_SettingsCommandStatusMT sequence accessor class */
      class AMTI_SettingsCommandStatusMT : public virtual uci::type::MessageType {
      public:

         /** The destructor */
         virtual ~AMTI_SettingsCommandStatusMT()
         { }

         /** Returns this accessor's type constant, i.e. AMTI_SettingsCommandStatusMT
           *
           * @return This accessor's type constant, i.e. AMTI_SettingsCommandStatusMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::aMTI_SettingsCommandStatusMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const AMTI_SettingsCommandStatusMT& accessor)
      ...
      protected:
         ...
         AMTI_SettingsCommandStatusMT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The AMTI_SettingsCommandStatusMT to copy from
           */
         AMTI_SettingsCommandStatusMT(const AMTI_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this AMTI_SettingsCommandStatusMT to the contents of the
           * AMTI_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator.AMTI_SettingsCommandStatusMT
           * [only available to derived classes]
           *
           * @param rhs The AMTI_SettingsCommandStatusMT on the right hand side (rhs) of the assignment operator whose contents
           *      are used to set the contents of this uci::type::AMTI_SettingsCommandStatusMT
           * @return A constant reference to this AMTI_SettingsCommandStatusMT.
           */
         const AMTI_SettingsCommandStatusMT& operator=(const AMTI_SettingsCommandStatusMT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__AMTI_SettingsCommandStatusMT_h
