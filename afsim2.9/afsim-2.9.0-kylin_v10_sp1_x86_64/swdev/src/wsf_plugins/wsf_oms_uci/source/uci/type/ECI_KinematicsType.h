...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ECI_KinematicsType_h
#define Uci__Type__ECI_KinematicsType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class ECI_KinematicsType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ECI_KinematicsType()
         { }

         /** Returns this accessor's type constant, i.e. ECI_KinematicsType
           *
           * @return This accessor's type constant, i.e. ECI_KinematicsType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::eCI_KinematicsType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ECI_KinematicsType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ECI_KinematicsType to copy from
           */
         ECI_KinematicsType(const ECI_KinematicsType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ECI_KinematicsType to the contents of the ECI_KinematicsType on
           * the right hand side (rhs) of the assignment operator.ECI_KinematicsType [only available to derived classes]
           *
           * @param rhs The ECI_KinematicsType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::ECI_KinematicsType
           * @return A constant reference to this ECI_KinematicsType.
           */
         const ECI_KinematicsType& operator=(const ECI_KinematicsType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ECI_KinematicsType_h
