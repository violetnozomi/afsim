...
*    Directive 5230.25.
*/
#ifndef Uci__Type__SourceFilterType_h
#define Uci__Type__SourceFilterType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class SourceFilterType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~SourceFilterType()
         { }

         /** Returns this accessor's type constant, i.e. SourceFilterType
           *
           * @return This accessor's type constant, i.e. SourceFilterType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::sourceFilterType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const SourceFilterType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The SourceFilterType to copy from
           */
         SourceFilterType(const SourceFilterType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this SourceFilterType to the contents of the SourceFilterType on the
           * right hand side (rhs) of the assignment operator.SourceFilterType [only available to derived classes]
           *
           * @param rhs The SourceFilterType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::SourceFilterType
           * @return A constant reference to this SourceFilterType.
           */
         const SourceFilterType& operator=(const SourceFilterType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__SourceFilterType_h
