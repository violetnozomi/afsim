...
*    Directive 5230.25.
*/
#ifndef Uci__Type__CapabilityStateType_h
#define Uci__Type__CapabilityStateType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the CapabilityStateType sequence accessor class */
      class CapabilityStateType : public virtual uci::base::Accessor {
      public:
         ...
         /** Returns this accessor's type constant, i.e. CapabilityStateType
           *
           * @return This accessor's type constant, i.e. CapabilityStateType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::capabilityStateType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const CapabilityStateType& accessor)
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           ...
           */
         CapabilityStateType(const CapabilityStateType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this CapabilityStateType to the contents of the CapabilityStateType on
           * the right hand side (rhs) of the assignment operator.CapabilityStateType [only available to derived classes]
           *
           * @param rhs The CapabilityStateType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::CapabilityStateType
           * @return A constant reference to this CapabilityStateType.
           */
         const CapabilityStateType& operator=(const CapabilityStateType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__CapabilityStateType_h
