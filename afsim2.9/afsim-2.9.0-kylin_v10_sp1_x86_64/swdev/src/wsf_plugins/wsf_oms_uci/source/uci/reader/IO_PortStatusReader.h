...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__IO_PortStatusReader_h
#define Uci__Reader__IO_PortStatusReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The IO_PortStatusListener provides the support to listen and handle incoming messages of the type
        * uci::type::IO_PortStatus
        */
      class IO_PortStatusListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~IO_PortStatusListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::IO_PortStatus& message)
            throw(uci::base::UCIException) = 0;


      }; // IO_PortStatusListener


      /** The Reader provides the support to reader incoming messages. */
      class IO_PortStatusReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~IO_PortStatusReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(IO_PortStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(IO_PortStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, IO_PortStatusListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, IO_PortStatusListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The IO_PortStatusReader to copy from
           */
         IO_PortStatusReader(const IO_PortStatusReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this IO_PortStatusReader to the contents of the IO_PortStatusReader on
           * the right hand side (rhs) of the assignment operator.IO_PortStatusReader [only available to derived classes]
           *
           * @param rhs The IO_PortStatusReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this IO_PortStatusReader
           * @return A constant reference to this IO_PortStatusReader.
           */
         const IO_PortStatusReader& operator=(const IO_PortStatusReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__IO_PortStatusReader_h
