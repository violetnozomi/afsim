...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ProductDisseminationTaskQFT_h
#define Uci__Type__ProductDisseminationTaskQFT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ProductDisseminationTaskQFT sequence accessor class */
      class ProductDisseminationTaskQFT : public virtual uci::type::QueryFilterPET {
      public:

         /** The destructor */
         virtual ~ProductDisseminationTaskQFT()
         { }

         /** Returns this accessor's type constant, i.e. ProductDisseminationTaskQFT
           *
           * @return This accessor's type constant, i.e. ProductDisseminationTaskQFT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::productDisseminationTaskQFT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ProductDisseminationTaskQFT& accessor)
         ...
         /** Returns the bounded list that is identified by the SystemID.
           ...
           */
         virtual const uci::type::ProductDisseminationTaskQFT::SystemID& getSystemID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the SystemID.
           ...
           * @return The bounded list identified by SystemID.
           */
         virtual uci::type::ProductDisseminationTaskQFT::SystemID& getSystemID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the SystemID.
           ...
           *      accessor
           */
         virtual void setSystemID(const uci::type::ProductDisseminationTaskQFT::SystemID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TaskID.
           ...
           */
         virtual const uci::type::ProductDisseminationTaskQFT::TaskID& getTaskID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TaskID.
           ...
           * @return The bounded list identified by TaskID.
           */
         virtual uci::type::ProductDisseminationTaskQFT::TaskID& getTaskID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the TaskID.
           ...
           *      accessor
           */
         virtual void setTaskID(const uci::type::ProductDisseminationTaskQFT::TaskID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DestinationID.
           ...
           */
         virtual const uci::type::ProductDisseminationTaskQFT::DestinationID& getDestinationID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DestinationID.
           ...
           * @return The bounded list identified by DestinationID.
           */
         virtual uci::type::ProductDisseminationTaskQFT::DestinationID& getDestinationID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the DestinationID.
           ...
           *      accessor
           */
         virtual void setDestinationID(const uci::type::ProductDisseminationTaskQFT::DestinationID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ParentTaskID.
           ...
           */
         virtual const uci::type::ProductDisseminationTaskQFT::ParentTaskID& getParentTaskID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ParentTaskID.
           ...
           * @return The bounded list identified by ParentTaskID.
           */
         virtual uci::type::ProductDisseminationTaskQFT::ParentTaskID& getParentTaskID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ParentTaskID.
           ...
           *      accessor
           */
         virtual void setParentTaskID(const uci::type::ProductDisseminationTaskQFT::ParentTaskID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DependentTaskID.
           ...
           */
         virtual const uci::type::ProductDisseminationTaskQFT::DependentTaskID& getDependentTaskID() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the DependentTaskID.
           ...
           * @return The bounded list identified by DependentTaskID.
           */
         virtual uci::type::ProductDisseminationTaskQFT::DependentTaskID& getDependentTaskID()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the DependentTaskID.
           ...
           *      accessor
           */
         virtual void setDependentTaskID(const uci::type::ProductDisseminationTaskQFT::DependentTaskID& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TaskState.
           ...
           */
         virtual const uci::type::ProductDisseminationTaskQFT::TaskState& getTaskState() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the TaskState.
           ...
           * @return The bounded list identified by TaskState.
           */
         virtual uci::type::ProductDisseminationTaskQFT::TaskState& getTaskState()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the TaskState.
           ...
           *      accessor
           */
         virtual void setTaskState(const uci::type::ProductDisseminationTaskQFT::TaskState& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Product.
           ...
           */
         virtual const uci::type::ProductDisseminationTaskQFT::Product& getProduct() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the Product.
           ...
           * @return The bounded list identified by Product.
           */
         virtual uci::type::ProductDisseminationTaskQFT::Product& getProduct()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the Product.
           ...
           *      accessor
           */
         virtual void setProduct(const uci::type::ProductDisseminationTaskQFT::Product& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductType.
           ...
           */
         virtual const uci::type::ProductDisseminationTaskQFT::ProductType& getProductType() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the bounded list that is identified by the ProductType.
           ...
           * @return The bounded list identified by ProductType.
           */
         virtual uci::type::ProductDisseminationTaskQFT::ProductType& getProductType()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the bounded list that is identified by the ProductType.
           ...
           *      accessor
           */
         virtual void setProductType(const uci::type::ProductDisseminationTaskQFT::ProductType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         ProductDisseminationTaskQFT()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ProductDisseminationTaskQFT to copy from
           */
         ProductDisseminationTaskQFT(const ProductDisseminationTaskQFT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ProductDisseminationTaskQFT to the contents of the
           * ProductDisseminationTaskQFT on the right hand side (rhs) of the assignment operator.ProductDisseminationTaskQFT [only
           * available to derived classes]
           *
           * @param rhs The ProductDisseminationTaskQFT on the right hand side (rhs) of the assignment operator whose contents are
           *      used to set the contents of this uci::type::ProductDisseminationTaskQFT
           * @return A constant reference to this ProductDisseminationTaskQFT.
           */
         const ProductDisseminationTaskQFT& operator=(const ProductDisseminationTaskQFT& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ProductDisseminationTaskQFT_h
