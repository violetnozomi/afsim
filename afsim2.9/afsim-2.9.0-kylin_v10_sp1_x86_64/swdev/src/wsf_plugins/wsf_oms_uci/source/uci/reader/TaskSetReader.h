...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__TaskSetReader_h
#define Uci__Reader__TaskSetReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The TaskSetListener provides the support to listen and handle incoming messages of the type uci::type::TaskSet */
      class TaskSetListener : public virtual uci::base::Listener {
      public:
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::TaskSet& message)
      ...
      class TaskSetReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~TaskSetReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(TaskSetListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(TaskSetListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, TaskSetListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, TaskSetListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The TaskSetReader to copy from
           */
         TaskSetReader(const TaskSetReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this TaskSetReader to the contents of the TaskSetReader on the right
           * hand side (rhs) of the assignment operator.TaskSetReader [only available to derived classes]
           *
           * @param rhs The TaskSetReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this TaskSetReader
           * @return A constant reference to this TaskSetReader.
           */
         const TaskSetReader& operator=(const TaskSetReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__TaskSetReader_h
