...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__OpZoneReader_h
#define Uci__Reader__OpZoneReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The OpZoneListener provides the support to listen and handle incoming messages of the type uci::type::OpZone */
      class OpZoneListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~OpZoneListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::OpZone& message)
      ...
      class OpZoneReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~OpZoneReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(OpZoneListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(OpZoneListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, OpZoneListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, OpZoneListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpZoneReader to copy from
           */
         OpZoneReader(const OpZoneReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpZoneReader to the contents of the OpZoneReader on the right hand
           * side (rhs) of the assignment operator.OpZoneReader [only available to derived classes]
           *
           * @param rhs The OpZoneReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this OpZoneReader
           * @return A constant reference to this OpZoneReader.
           */
         const OpZoneReader& operator=(const OpZoneReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__OpZoneReader_h
