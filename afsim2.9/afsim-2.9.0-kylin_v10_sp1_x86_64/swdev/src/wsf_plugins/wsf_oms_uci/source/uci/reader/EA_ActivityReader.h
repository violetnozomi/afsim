...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__EA_ActivityReader_h
#define Uci__Reader__EA_ActivityReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The EA_ActivityListener provides the support to listen and handle incoming messages of the type
        * uci::type::EA_Activity
        */
      class EA_ActivityListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~EA_ActivityListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::EA_Activity& message)
      ...
      class EA_ActivityReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~EA_ActivityReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(EA_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(EA_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, EA_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, EA_ActivityListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The EA_ActivityReader to copy from
           */
         EA_ActivityReader(const EA_ActivityReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this EA_ActivityReader to the contents of the EA_ActivityReader on the
           * right hand side (rhs) of the assignment operator.EA_ActivityReader [only available to derived classes]
           *
           * @param rhs The EA_ActivityReader on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this EA_ActivityReader
           * @return A constant reference to this EA_ActivityReader.
           */
         const EA_ActivityReader& operator=(const EA_ActivityReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__EA_ActivityReader_h
