...
*    Directive 5230.25.
*/
#ifndef Uci__Reader__PulseDataReader_h
#define Uci__Reader__PulseDataReader_h 1
...
namespace uci {
   ...
   namespace reader {
      ...
      /** The PulseDataListener provides the support to listen and handle incoming messages of the type uci::type::PulseData */
      class PulseDataListener : public virtual uci::base::Listener {
      public:

         /** The destructor */
         virtual ~PulseDataListener()
         { }
         ...
         /** The method is used to handle incoming messages.
           ...
           */
         virtual void handleMessage(const uci::type::PulseData& message)
      ...
      class PulseDataReader : public virtual uci::base::Reader {
      public:

         /** The destructor */
         virtual ~PulseDataReader()
         { }
         ...
         /** Adds a listener to this reader to handle incoming messages.
           ...
           */
         virtual void addListener(PulseDataListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Removes the specified listener from this reader.
           ...
           */
         virtual void removeListener(PulseDataListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message if available. Does not wait for a message to be received.
           ...
           */
         virtual unsigned long readNoWait(unsigned long maxNumberOfMessages, PulseDataListener& listener)
            throw(uci::base::UCIException) = 0;
         ...
         /** Reads the next incoming message.
           ...
           * @return The number of messages that were handled
           */
         virtual unsigned long read(unsigned long timeout, unsigned long maxNumberOfMessages, PulseDataListener& listener)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The PulseDataReader to copy from
           */
         PulseDataReader(const PulseDataReader& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this PulseDataReader to the contents of the PulseDataReader on the
           * right hand side (rhs) of the assignment operator.PulseDataReader [only available to derived classes]
           *
           * @param rhs The PulseDataReader on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this PulseDataReader
           * @return A constant reference to this PulseDataReader.
           */
         const PulseDataReader& operator=(const PulseDataReader& rhs)
         {
            (void)rhs;
...
#endif // Uci__Reader__PulseDataReader_h
