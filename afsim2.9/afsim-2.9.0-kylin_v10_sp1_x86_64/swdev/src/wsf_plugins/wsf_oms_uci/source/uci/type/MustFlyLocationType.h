...
*    Directive 5230.25.
*/
#ifndef Uci__Type__MustFlyLocationType_h
#define Uci__Type__MustFlyLocationType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the MustFlyLocationType choice accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const MustFlyLocationType& accessor)
         ...
         /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           */
         virtual MustFlyLocationTypeChoice getMustFlyLocationTypeChoiceOrdinal() const
            throw(uci::base::UCIException) = 0;
         ...
         /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           *      base type.
           */
         virtual void setMustFlyLocationTypeChoiceOrdinal(MustFlyLocationTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Point.
           ...
           */
         virtual const uci::type::Point3D_Type& getPoint() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Point.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Point.
           */
         virtual uci::type::Point3D_Type& getPoint()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Point to the contents of the complex content that is accessed by
           ...
           */
         virtual void setPoint(const uci::type::Point3D_Type& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this MustFlyLocationType to the contents of the MustFlyLocationType on
           * the right hand side (rhs) of the assignment operator.MustFlyLocationType [only available to derived classes]
           *
           * @param rhs The MustFlyLocationType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::MustFlyLocationType
           * @return A constant reference to this MustFlyLocationType.
           */
         const MustFlyLocationType& operator=(const MustFlyLocationType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__MustFlyLocationType_h
