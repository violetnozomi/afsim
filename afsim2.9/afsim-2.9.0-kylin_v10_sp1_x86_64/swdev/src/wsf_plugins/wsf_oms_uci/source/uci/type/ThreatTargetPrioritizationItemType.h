...
*    Directive 5230.25.
*/
#ifndef Uci__Type__ThreatTargetPrioritizationItemType_h
#define Uci__Type__ThreatTargetPrioritizationItemType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the ThreatTargetPrioritizationItemType choice accessor class */
      class ThreatTargetPrioritizationItemType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~ThreatTargetPrioritizationItemType()
         { }

         /** Returns this accessor's type constant, i.e. ThreatTargetPrioritizationItemType
           *
           * @return This accessor's type constant, i.e. ThreatTargetPrioritizationItemType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::threatTargetPrioritizationItemType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const ThreatTargetPrioritizationItemType& accessor)
            throw(uci::base::UCIException) = 0;


         /** The following enumeration is used to identify which element of this Choice has been chosen. */
         enum ThreatTargetPrioritizationItemTypeChoice {
            THREATTARGETPRIORITIZATIONITEMTYPE_CHOICE_NONE,
            THREATTARGETPRIORITIZATIONITEMTYPE_CHOICE_IDENTITY,
            THREATTARGETPRIORITIZATIONITEMTYPE_CHOICE_ENTITYID,
            THREATTARGETPRIORITIZATIONITEMTYPE_CHOICE_OPPOINTID,
            THREATTARGETPRIORITIZATIONITEMTYPE_CHOICE_OPERATORLOCATIONOFINTERESTID,
            THREATTARGETPRIORITIZATIONITEMTYPE_CHOICE_SIGNALID
         };
         ...
         /** This method returns this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           */
         virtual ThreatTargetPrioritizationItemTypeChoice getThreatTargetPrioritizationItemTypeChoiceOrdinal() const
            throw(uci::base::UCIException) = 0;
         ...
         /** This method is used to set this choice's "selection ordinal." A choice's "selection ordinal" is used to specify which
           ...
           * getThreatTargetPrioritizationItemTypeChoiceOrdinal() will be the ordinal specified when this method was invoked. In
           ...
           *      base type.
           */
         virtual void setThreatTargetPrioritizationItemTypeChoiceOrdinal(ThreatTargetPrioritizationItemTypeChoice chosenElementOrdinal, uci::base::accessorType::AccessorType type = uci::base::accessorType::null)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         ThreatTargetPrioritizationItemType()
         { }

         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The ThreatTargetPrioritizationItemType to copy from
           */
         ThreatTargetPrioritizationItemType(const ThreatTargetPrioritizationItemType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this ThreatTargetPrioritizationItemType to the contents of the
           * ThreatTargetPrioritizationItemType on the right hand side (rhs) of the assignment
           * operator.ThreatTargetPrioritizationItemType [only available to derived classes]
           *
           * @param rhs The ThreatTargetPrioritizationItemType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::ThreatTargetPrioritizationItemType
           * @return A constant reference to this ThreatTargetPrioritizationItemType.
           */
         const ThreatTargetPrioritizationItemType& operator=(const ThreatTargetPrioritizationItemType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__ThreatTargetPrioritizationItemType_h
