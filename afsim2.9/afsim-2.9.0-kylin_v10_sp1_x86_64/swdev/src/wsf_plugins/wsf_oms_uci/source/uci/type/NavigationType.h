...
*    Directive 5230.25.
*/
#ifndef Uci__Type__NavigationType_h
#define Uci__Type__NavigationType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the NavigationType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const NavigationType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Source.
           ...
           */
         virtual const uci::type::NavigationSourceType& getSource() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Source.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Source.
           */
         virtual uci::type::NavigationSourceType& getSource()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Source to the contents of the complex content that is accessed by
           ...
           */
         virtual void setSource(const uci::type::NavigationSourceType& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this NavigationType to the contents of the NavigationType on the right
           * hand side (rhs) of the assignment operator.NavigationType [only available to derived classes]
           *
           * @param rhs The NavigationType on the right hand side (rhs) of the assignment operator whose contents are used to set
           *      the contents of this uci::type::NavigationType
           * @return A constant reference to this NavigationType.
           */
         const NavigationType& operator=(const NavigationType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__NavigationType_h
