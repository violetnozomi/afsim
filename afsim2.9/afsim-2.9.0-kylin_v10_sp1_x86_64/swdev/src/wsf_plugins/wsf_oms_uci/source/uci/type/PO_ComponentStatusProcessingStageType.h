...
*    Directive 5230.25.
*/
#ifndef Uci__Type__PO_ComponentStatusProcessingStageType_h
#define Uci__Type__PO_ComponentStatusProcessingStageType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the PO_ComponentStatusProcessingStageType sequence accessor class */
      ...
      public:
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const PO_ComponentStatusProcessingStageType& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Settings.
           ...
           */
         virtual const uci::type::PO_ComponentStatusProcessingStageSettingsType& getSettings() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the Settings.
           ...
           * @return The acecssor that provides access to the complex content that is identified by Settings.
           */
         virtual uci::type::PO_ComponentStatusProcessingStageSettingsType& getSettings()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the Settings to the contents of the complex content that is accessed
           ...
           */
         virtual void setSettings(const uci::type::PO_ComponentStatusProcessingStageSettingsType& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Enables the Element that is identified by Settings
           *
           * @param type = uci::type::accessorType::pO_ComponentStatusProcessingStageSettingsType This Accessor's accessor type
           */
         virtual void enableSettings(uci::base::accessorType::AccessorType type = uci::type::accessorType::pO_ComponentStatusProcessingStageSettingsType)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The assignment operator. Sets the contents of this PO_ComponentStatusProcessingStageType to the contents of the
           * PO_ComponentStatusProcessingStageType on the right hand side (rhs) of the assignment
           * operator.PO_ComponentStatusProcessingStageType [only available to derived classes]
           *
           * @param rhs The PO_ComponentStatusProcessingStageType on the right hand side (rhs) of the assignment operator whose
           *      contents are used to set the contents of this uci::type::PO_ComponentStatusProcessingStageType
           * @return A constant reference to this PO_ComponentStatusProcessingStageType.
           */
         const PO_ComponentStatusProcessingStageType& operator=(const PO_ComponentStatusProcessingStageType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__PO_ComponentStatusProcessingStageType_h
