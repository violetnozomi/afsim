...
*    Directive 5230.25.
*/
#ifndef Uci__Type__DamagedFunctionType_h
#define Uci__Type__DamagedFunctionType_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      /** This is the DamagedFunctionType sequence accessor class */
      class DamagedFunctionType : public virtual uci::base::Accessor {
      public:

         /** The destructor */
         virtual ~DamagedFunctionType()
         { }

         /** Returns this accessor's type constant, i.e. DamagedFunctionType
           *
           * @return This accessor's type constant, i.e. DamagedFunctionType
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::damagedFunctionType;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const DamagedFunctionType& accessor)
         ...
         /** Returns the value of the enumeration that is identified by the Function.
           ...
           */
         virtual const uci::type::DamagedFunctionEnum& getFunction() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the Function.
           ...
           * @return The value of the enumeration identified by Function.
           */
         virtual uci::type::DamagedFunctionEnum& getFunction()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Function.
           ...
           */
         virtual void setFunction(const uci::type::DamagedFunctionEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Function.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setFunction(uci::type::DamagedFunctionEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;


         /** Returns whether this optionalfield Functionis available
           *
         ...
         /** Enables the optional field such that getFunction will return the optional field and not throw an exception when
           * invoked.
           *
           * @param type = uci::type::accessorType::damagedFunctionEnum This Accessor's accessor type
           */
         virtual void enableFunction(uci::base::accessorType::AccessorType type = uci::type::accessorType::damagedFunctionEnum)
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the Level.
           *
           * @return The value of the enumeration identified by Level.
           */
         virtual const uci::type::DamageLevelEnum& getLevel() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the value of the enumeration that is identified by the Level.
           ...
           * @return The value of the enumeration identified by Level.
           */
         virtual uci::type::DamageLevelEnum& getLevel()
            throw(uci::base::UCIException) = 0;


         /** Sets the value of the enumeration that is identified by the Level.
           *
           * @param value The value to set the enumeration to
           */
         virtual void setLevel(const uci::type::DamageLevelEnum& value)
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the value of the enumeration that is identified by the Level.
           ...
           * @param value The value to set the enumeration to
           */
         virtual void setLevel(uci::type::DamageLevelEnum::EnumerationItem value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The DamagedFunctionType to copy from
           */
         DamagedFunctionType(const DamagedFunctionType& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this DamagedFunctionType to the contents of the DamagedFunctionType on
           * the right hand side (rhs) of the assignment operator.DamagedFunctionType [only available to derived classes]
           *
           * @param rhs The DamagedFunctionType on the right hand side (rhs) of the assignment operator whose contents are used to
           *      set the contents of this uci::type::DamagedFunctionType
           * @return A constant reference to this DamagedFunctionType.
           */
         const DamagedFunctionType& operator=(const DamagedFunctionType& rhs)
         {
            (void)rhs;
...
#endif // Uci__Type__DamagedFunctionType_h
