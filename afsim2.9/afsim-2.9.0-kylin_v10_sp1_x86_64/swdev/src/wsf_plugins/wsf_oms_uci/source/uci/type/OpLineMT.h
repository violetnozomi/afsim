...
*    Directive 5230.25.
*/
#ifndef Uci__Type__OpLineMT_h
#define Uci__Type__OpLineMT_h 1
...
namespace uci {
   ...
   namespace type {
      ...
      class OpLineMT : public virtual uci::type::MessageType {
      public:
         ...
         /** Returns this accessor's type constant, i.e. OpLineMT
           *
           * @return This accessor's type constant, i.e. OpLineMT
           */
         virtual uci::base::accessorType::AccessorType getAccessorType() const
            throw()
         {
            return uci::type::accessorType::opLineMT;
         }
         ...
         /** Initializes the contents of this accessor by copying the contents of the specified accessor
           ...
           */
         virtual void copy(const OpLineMT& accessor)
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           */
         virtual const uci::type::OpLineMDT& getMessageData() const
            throw(uci::base::UCIException) = 0;
         ...
         /** Returns the accessor that provides access to the complex content that is identified by the MessageData.
           ...
           * @return The acecssor that provides access to the complex content that is identified by MessageData.
           */
         virtual uci::type::OpLineMDT& getMessageData()
            throw(uci::base::UCIException) = 0;
         ...
         /** Sets the complex content that is identified by the MessageData to the contents of the complex content that is
           ...
           */
         virtual void setMessageData(const uci::type::OpLineMDT& value)
            throw(uci::base::UCIException) = 0;
      ...
      protected:
         ...
         /** The copy constructor [only available to derived classes]
           *
           * @param rhs The OpLineMT to copy from
           */
         OpLineMT(const OpLineMT& rhs)
         {
            (void)rhs;
         }

         /** The assignment operator. Sets the contents of this OpLineMT to the contents of the OpLineMT on the right hand side
           * (rhs) of the assignment operator.OpLineMT [only available to derived classes]
           *
           * @param rhs The OpLineMT on the right hand side (rhs) of the assignment operator whose contents are used to set the
           *      contents of this uci::type::OpLineMT
           * @return A constant reference to this OpLineMT.
           */
         const OpLineMT& operator=(const OpLineMT& rhs)
         {
            (void)rhs;
