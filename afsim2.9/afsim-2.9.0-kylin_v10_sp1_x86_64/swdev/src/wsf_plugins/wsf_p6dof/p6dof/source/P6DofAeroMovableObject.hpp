...
#ifndef P6DOFAEROMOVABLEOBJECT_H
#define P6DOFAEROMOVABLEOBJECT_H
...
// The P6DofAeroMovableObject provides supplemental aerodynamics for an object,
// beyond the 'core' aerodynamics of P6DofAeroCoreObject. It is used for
...
protected:
   ...
   double CLFactor_AngleMach(double aMach, double aAngle_deg) const; //! @deprecated
   ...
   // Rolling moments
   double Cl_AngleMach(double aMach, double aAngle_deg) const; //! @deprecated
   ...
   UtCloneablePtr<UtTable::Table> mCLFactor_AngleMachTablePtr{nullptr}; //! @deprecated
   ...
   // Rolling moments
   UtCloneablePtr<UtTable::Table> mCl_AngleMachTablePtr{nullptr}; //! @deprecated
