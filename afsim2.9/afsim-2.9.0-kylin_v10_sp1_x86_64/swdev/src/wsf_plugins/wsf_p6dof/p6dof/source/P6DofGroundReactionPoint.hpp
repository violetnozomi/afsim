...
#ifndef P6DOFGROUNDREACTIONPOINT_H
#define P6DOFGROUNDREACTIONPOINT_H
...
public:
   ...
   // force and moment produced by the friction force of the P6DofGroundReactionPoint
   ...
   // by the P6DofGroundReactionPoint. The friction multiplier (optional) can be used to
...
protected:
   ...
   // produced by the friction force of the P6DofGroundReactionPoint. It is
   ...
   bool     mIsValid; // Flag is false when gear are not down and locked
   bool     mNotMoving;
