...
ManeuverTurnCircle::ManeuverTurnCircle(const UtVec3d& aLocationWCS, const UtVec3d& aVelocityWCS, const UtVec3d& aAccelerationWCS)
   : mCenter{0.0, 0.0, 0.0}
   , mX_Hat{0.0, 0.0, 0.0}
   , mY_Hat{0.0, 0.0, 0.0}
...
UtVec3d ManeuverTurnCircle::GetLocationOnCircle(double aPhase) const
{
   UtVec3d retval{};
   if (IsValid())
   {
...
//! \return        - The WCS location of the requested point if this object is valid; a default vector otherwise.
UtVec3d ManeuverTurnCircle::GetLocationAfterTime(double aDeltaT) const
{
...
UtVec3d ManeuverTurnCircle::GetAngularVelocity() const
{
   UtVec3d zHat{};
...
UtVec3d ManeuverTurnCircle::GetVelocityOnCircle(double aPhase) const
{
   UtVec3d retval{};
   if (IsValid())
   {
...
//! small.
bool ManeuverTurnCircle::IsValid() const
{
