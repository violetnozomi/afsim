...
TEST(WsfRIC_OffsetTargetPoint, ClassicalOrbitTest)
{
   ...
   UtVec3d frameX{1.0, 0.0, 0.0};
   UtVec3d frameY{0.0, 1.0, 0.0};
   UtVec3d frameZ{0.0, 0.0, 1.0};
   ...
   wsf::space::RIC_OffsetTargetPoint offsetTarget{std::move(propTargetPtr)};
...
TEST(WsfRIC_OffsetTargetPoint, ThrowWhenConstructFromNull)
{
   EXPECT_THROW({ wsf::space::RIC_OffsetTargetPoint offsetTarget{nullptr}; }, std::runtime_error);
}
