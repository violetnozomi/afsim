...
rem ****************************************************************************
setlocal
rem start run.bat xio-gos.txt realtime.txt
rem start run.bat xio-panel.txt realtime.txt
start run.bat xio-app1.txt realtime.txt
start run.bat xio-app2.txt realtime.txt
endlocal
