...
usage() {
  printf '%s\n' \
    ...
    "" \
    "Approved scenarios: framework_smoke, four_network_overview, link_failure, congestion, quality_degradation, capability_service_smoke, cross_domain_gateway_smoke, operational_strike_demo, pdr_diversity, environment_weather, navigation_errors."
}
...
scenario_file() {
  case "$1" in
    ...
    pdr_diversity) printf '%s\n' operational_strike_demo/pdr_validation.txt ;;
