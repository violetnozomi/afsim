...
- 甲方接口基线：Draft 2020-12统一JSON Schema覆盖提供方握手、四网资源、导航、环境、
  评估请求/响应、ACK和错误；详见[`甲方接口对齐规范与JSON Schema`](docs/甲方接口对齐规范与JSON-Schema.md)。
...
- 一键内部预验收：`scripts/run_preacceptance.sh`自动执行18项测试、八个批准场景和Warlock
