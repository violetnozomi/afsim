...
- [x] **Step 1: Add failing runtime assertions**
...
- [x] **Step 3: Add minimal AFSIM navigation blocks**
...
- [x] **Step 4: Verify configuration and runtime GREEN**
...
- [x] **Step 1: Add the failing UI text test**
...
- [x] **Step 3: Implement the helper and empty row**
...
- [x] **Step 4: Run focused and full test suites**
...
- [x] **Step 1: Rebuild and restart the integrated scenario**
...
- [x] **Step 2: Verify live snapshot evidence**
